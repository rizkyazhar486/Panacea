...
// Licensing boundary: the implementation is intentionally original and must
// not embed third-party source prompt/video identifiers from the inspiration repo.
