...
for (const organ of ['esophagus','stomach','duodenum','ascending colon','transverse colon','descending colon','rectum','appendix','pancreas','spleen']) assert.ok(names.includes(organ), `gastrointestinal atlas must expose ${organ}`)
