...
console.log('Z-Anatomy source-node resolver preserves specific-first lookup, while resolveAll covers every reviewed composite component conservatively without duplicates.')
