...
const candidates: BodyAssetCandidate[] = [
  {
    assetId: 'visceral-selected',
    estimatedTransferMb: 3,
    intent: 'required-now',
    selected: true,
    adjacentToSelection: false,
    alreadyResident: false,
  },
  {
    assetId: 'cardiovascular-adjacent',
    estimatedTransferMb: 2,
    intent: 'likely-next',
    selected: false,
    adjacentToSelection: true,
    alreadyResident: false,
  },
  {
    assetId: 'skeletal-likely',
    estimatedTransferMb: 4,
    intent: 'likely-next',
    selected: false,
    adjacentToSelection: false,
    alreadyResident: false,
  ...
  {
    assetId: 'muscular-idle',
    estimatedTransferMb: 5,
    intent: 'idle-opportunistic',
    selected: false,
    adjacentToSelection: false,
    alreadyResident: false,
  },
  {
    assetId: 'resident-surface',
    estimatedTransferMb: 6,
    intent: 'required-now',
    selected: false,
    adjacentToSelection: false,
...
const mobile = planBodyProgressivePrefetch(candidates, {
  network: 'normal',
  memory: 'standard',
  viewportWidth: 390,
});
...
const saveData = planBodyProgressivePrefetch(candidates, {
  network: 'save-data',
  memory: 'standard',
  viewportWidth: 390,
});
...
const offline = planBodyProgressivePrefetch(candidates, {
  network: 'offline',
  memory: 'low',
  viewportWidth: 390,
});
...
const lowMemory = planBodyProgressivePrefetch(candidates, {
  network: 'normal',
  memory: 'low',
  viewportWidth: 1024,
});
...
const deterministicA = planBodyProgressivePrefetch(candidates, {
  network: 'normal',
  memory: 'high',
  viewportWidth: 1440,
});
const deterministicB = planBodyProgressivePrefetch([...candidates].reverse(), {
  network: 'normal',
  memory: 'high',
  viewportWidth: 1440,
});
...
const invalidTransfer = planBodyProgressivePrefetch([
  ...
  {
    assetId: 'unknown-size',
    estimatedTransferMb: Number.NaN,
    intent: 'likely-next',
    selected: false,
    adjacentToSelection: true,
    alreadyResident: false,
