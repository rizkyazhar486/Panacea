...
assert.ok(
  ...
  'Timeline feeding the snapshot/trend surface must remain bounded.',
)
...
console.log('Feature Factory nutrition snapshot: latest recorded-day aggregation is empty-safe, bounded, local-first, unit-preserving and explicitly non-clinical.')
