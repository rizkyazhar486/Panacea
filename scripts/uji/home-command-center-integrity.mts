...
console.log('Home command center integrity: routes resolve, live signals retain provenance/freshness boundaries, heavy sections stay deferred, and 3D remains opt-in.')
