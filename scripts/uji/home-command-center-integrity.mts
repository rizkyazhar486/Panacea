...
console.log('Home command center integrity: routes resolve, cross-tab daily state is narrow/fail-closed, provenance is honest, mobile stability is active, heavy sections stay deferred, and 3D remains opt-in.')
