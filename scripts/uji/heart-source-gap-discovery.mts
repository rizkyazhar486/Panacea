...
import { discoverHeartGapCandidates, summarizeHeartGapDiscovery } from '../../src/lib/anatomy/heartSourceGapDiscovery.ts';
...
assert.deepEqual(report.candidateFoundIds.sort(), ['chordae','endocardium','epicardium','interatrial-septum','interventricular-septum','pericardium'].sort());
...
const fuzzyOnly = discoverHeartGapCandidates(['possible chordae tendineae fragment','interventricular septum candidate mesh','pericardial tissue']);
