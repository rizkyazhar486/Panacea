...
assert.match(byTrack('accommodation')[0]?.state ?? '', /relaxed/)
assert.match(byTrack('accommodation')[1]?.state ?? '', /tension/)
assert.match(byTrack('accommodation')[2]?.state ?? '', /flatter/)
assert.match(byTrack('accommodation')[3]?.state ?? '', /contraction/)
assert.match(byTrack('accommodation')[4]?.state ?? '', /reduced zonular tension/)
assert.match(byTrack('accommodation')[5]?.state ?? '', /curvature increases/)
