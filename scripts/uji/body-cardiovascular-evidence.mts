...
const path = new URL('../../data/body-knowledge/cardiovascular-heart-evidence.json', import.meta.url)
...
assert.equal(seed.system, 'cardiovascular')
assert.equal(seed.organ, 'heart')
...
console.log('Cardiovascular evidence seed verified: PubMed-backed AV-node, coronary-flow and Frank-Starling relationships remain bounded by explicit provenance and patient-specific inference guards.')
