...
assert.match(index, /MAINTENANCE_VERSION = '20260918-v49'/)

console.log('mobile-visual-first-repair: compact header, unclipped notification count, one-line context, and live Training visuals are locked')
