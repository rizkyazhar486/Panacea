...
console.log('body system deep-dive workspace: heart and neurovascular labs are isolated by selected atlas context and composed between physiology orientation and intelligence layers')
