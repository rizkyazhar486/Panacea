...
try {
  ...
  console.log('Home mobile 390x844 smoke: empty state is honest, touch compositor guard is active, 3D remains opt-in, recorded provenance renders, and no horizontal overflow was detected.')
} finally {
  await browser.close()
}
