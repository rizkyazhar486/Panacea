...
await edit('src/lib/surgerySimulatorAppendectomy.ts', (source) => {
  if (!source.includes('10.1093/database/bap012')) throw new Error('Unexpected BodyParts3D DOI draft state')
  return source.replace('10.1093/database/bap012', '10.1093/nar/gkn613')
})
