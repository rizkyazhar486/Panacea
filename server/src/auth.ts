...
// Development login is an identity bypass by definition. It must be explicitly
// enabled and is never available when NODE_ENV=production.
...
// Local-development-only login. Disabled by default and always disabled in production.
