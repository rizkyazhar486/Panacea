...
/**
 * Payment status is account-scoped metadata. Return the same not-found result
 * for a missing order and a foreign order so the endpoint cannot be used to
 * enumerate another account's payment activity.
 */
