...
assert.deepEqual(ikatTelepon('phone-b@example.test', '+6281234567890'), { ok: false, galat: 'telepon_sudah_dipakai' })
...
assert.deepEqual(Object.keys(publicProfile!).sort(), ['email', 'nama', 'umur', 'pekerjaan', 'pendidikan', 'kota', 'terverifikasi', 'kredit'].sort())
