...
/* ═════════════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════════ */
const FD: Food[] = [
  { name: 'Nasi putih', k: 130, c: 28, p: 2.7, f: 0.3, fb: 0.4, cat: 'Karbo', emoji: '\u{1F35A}' },
  { name: 'Nasi merah', k: 111, c: 23, p: 2.6, f: 0.9, fb: 1.8, cat: 'Karbo', emoji: '\u{1F35A}' },
  { name: 'Nasi goreng', k: 163, c: 21, p: 4, f: 6, fb: 0.8, cat: 'Karbo', emoji: '\u{1F373}' },
  { name: 'Lontong', k: 122, c: 27, p: 2, f: 0.2, fb: 0.5, cat: 'Karbo', emoji: '\u{1F7E2}' },
  { name: 'Roti tawar', k: 265, c: 49, p: 9, f: 3.2, fb: 2.7, cat: 'Karbo', emoji: '\u{1F35E}' },
  { name: 'Roti gandum', k: 247, c: 41, p: 13, f: 3.4, fb: 6.8, cat: 'Karbo', emoji: '\u{1F35E}' },
  { name: 'Mie goreng', k: 182, c: 24, p: 5, f: 7, fb: 1.2, cat: 'Karbo', emoji: '\u{1F35C}' },
  { name: 'Mie ayam', k: 85, c: 12, p: 4, f: 2, fb: 0.5, cat: 'Karbo', emoji: '\u{1F35C}' },
  { name: 'Oatmeal', k: 389, c: 66, p: 17, f: 7, fb: 11, cat: 'Karbo', emoji: '\u{1F963}' },
  { name: 'Kentang rebus', k: 87, c: 20, p: 1.9, f: 0.1, fb: 2.2, cat: 'Karbo', emoji: '\u{1F354}' },
  { name: 'Ubi jalar', k: 86, c: 20, p: 1.6, f: 0.1, fb: 3, cat: 'Karbo', emoji: '\u{1F360}' },
  { name: 'Bubur ayam', k: 68, c: 10, p: 3, f: 2, fb: 0.3, cat: 'Karbo', emoji: '\u{1F963}' },
  { name: 'Ayam goreng', k: 239, c: 8, p: 21, f: 14, fb: 0.3, cat: 'Protein', emoji: '\u{1F357}' },
  { name: 'Ayam bakar', k: 190, c: 1, p: 28, f: 8, fb: 0, cat: 'Protein', emoji: '\u{1F357}' },
  { name: 'Daging sapi', k: 250, c: 0, p: 26, f: 15, fb: 0, cat: 'Protein', emoji: '\u{1F969}' },
  { name: 'Ikan goreng', k: 232, c: 7, p: 19, f: 14, fb: 0.3, cat: 'Protein', emoji: '\u{1F41F}' },
  { name: 'Ikan kukus', k: 100, c: 0, p: 20, f: 2, fb: 0, cat: 'Protein', emoji: '\u{1F41F}' },
  { name: 'Salmon', k: 208, c: 0, p: 20, f: 13, fb: 0, cat: 'Protein', emoji: '\u{1F41F}' },
  { name: 'Telur ayam', k: 155, c: 1.1, p: 13, f: 11, fb: 0, cat: 'Protein', emoji: '\u{1F95A}' },
  { name: 'Udang', k: 85, c: 0.2, p: 20, f: 0.5, fb: 0, cat: 'Protein', emoji: '\u{1F990}' },
  { name: 'Sate ayam', k: 186, c: 3, p: 22, f: 10, fb: 0.2, cat: 'Protein', emoji: '\u{1F36B}' },
  { name: 'Rendang', k: 193, c: 2, p: 24, f: 10, fb: 0.5, cat: 'Protein', emoji: '\u{1F358}' },
  { name: 'Tempe goreng', k: 201, c: 8, p: 17, f: 12, fb: 3, cat: 'Protein', emoji: '\u{1F7EB}' },
  { name: 'Tempe kukus', k: 160, c: 7, p: 18, f: 8, fb: 4, cat: 'Protein', emoji: '\u{1F7EB}' },
  { name: 'Tahu goreng', k: 234, c: 4, p: 15, f: 17, fb: 0.5, cat: 'Protein', emoji: '\u{1F9C8}' },
  { name: 'Tahu kukus', k: 76, c: 1.9, p: 8, f: 4.8, fb: 0.3, cat: 'Protein', emoji: '\u{1F9C8}' },
  { name: 'Susu full cream', k: 61, c: 4.8, p: 3.2, f: 3.3, fb: 0, cat: 'Susu', emoji: '\u{1F95B}' },
  { name: 'Susu skim', k: 34, c: 5, p: 3.4, f: 0.1, fb: 0, cat: 'Susu', emoji: '\u{1F95B}' },
  { name: 'Yogurt', k: 59, c: 3.6, p: 10, f: 0.4, fb: 0, cat: 'Susu', emoji: '\u{1FAD9}' },
  { name: 'Keju', k: 402, c: 1.3, p: 25, f: 33, fb: 0, cat: 'Susu', emoji: '\u{1F9C0}' },
  { name: 'Bayam', k: 23, c: 3.6, p: 2.9, f: 0.4, fb: 2.2, cat: 'Sayur', emoji: '\u{1F96C}' },
  { name: 'Kangkung', k: 19, c: 3.1, p: 2.6, f: 0.2, fb: 2.5, cat: 'Sayur', emoji: '\u{1F96C}' },
  { name: 'Brokoli', k: 34, c: 7, p: 2.8, f: 0.4, fb: 2.6, cat: 'Sayur', emoji: '\u{1F966}' },
  { name: 'Wortel', k: 41, c: 10, p: 0.9, f: 0.2, fb: 2.8, cat: 'Sayur', emoji: '\u{1F955}' },
  { name: 'Tomat', k: 18, c: 3.9, p: 0.9, f: 0.2, fb: 1.2, cat: 'Sayur', emoji: '\u{1F345}' },
  { name: 'Sawi', k: 26, c: 4.5, p: 2.8, f: 0.3, fb: 2.8, cat: 'Sayur', emoji: '\u{1F96C}' },
  { name: 'Gado-gado', k: 122, c: 10, p: 6, f: 7, fb: 3, cat: 'Sayur', emoji: '\u{1F957}' },
  { name: 'Pisang', k: 89, c: 23, p: 1.1, f: 0.3, fb: 2.6, cat: 'Buah', emoji: '\u{1F34C}' },
  { name: 'Apel', k: 52, c: 14, p: 0.3, f: 0.2, fb: 2.4, cat: 'Buah', emoji: '\u{1F34E}' },
  { name: 'Jeruk', k: 47, c: 12, p: 0.9, f: 0.1, fb: 2.4, cat: 'Buah', emoji: '\u{1F34A}' },
  { name: 'Mangga', k: 60, c: 15, p: 0.8, f: 0.4, fb: 1.6, cat: 'Buah', emoji: '\u{1F96D}' },
  { name: 'Alpukat', k: 160, c: 9, p: 2, f: 15, fb: 7, cat: 'Buah', emoji: '\u{1F951}' },
  { name: 'Jambu biji', k: 68, c: 14, p: 2.6, f: 1, fb: 5.4, cat: 'Buah', emoji: '\u{1F34F}' },
  { name: 'Pepaya', k: 43, c: 11, p: 0.5, f: 0.3, fb: 1.7, cat: 'Buah', emoji: '\u{1F348}' },
  { name: 'Es teh manis', k: 40, c: 10, p: 0, f: 0, fb: 0, cat: 'Minuman', emoji: '\u{1F9CA}' },
  { name: 'Kopi hitam', k: 2, c: 0, p: 0.3, f: 0, fb: 0, cat: 'Minuman', emoji: '\u{2615}' },
  { name: 'Jus jeruk', k: 45, c: 10, p: 0.7, f: 0.2, fb: 0.2, cat: 'Minuman', emoji: '\u{1F9C3}' },
  { name: 'Air mineral', k: 0, c: 0, p: 0, f: 0, fb: 0, cat: 'Minuman', emoji: '\u{1F4A7}' },
  { name: 'Bakso', k: 75, c: 10, p: 5, f: 2, fb: 0.3, cat: 'Lainnya', emoji: '\u{1F35F}' },
  { name: 'Soto ayam', k: 48, c: 4, p: 4, f: 2, fb: 0.3, cat: 'Lainnya', emoji: '\u{1F372}' },
  { name: 'Nasi padang', k: 200, c: 25, p: 8, f: 8, fb: 1, cat: 'Lainnya', emoji: '\u{1F35B}' },
  { name: 'Kacang almond', k: 579, c: 22, p: 21, f: 50, fb: 12, cat: 'Lainnya', emoji: '\u{1F95C}' },
]
...
/* ═════════════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════════ */
const EX: Exer[] = [
  { name: 'Jalan santai', emoji: '\u{1F6B6}', met: 2.5, int: 'Rendah', gps: true, cat: 'Kardio' },
  { name: 'Jalan cepat', emoji: '\u{1F6B6}\u{200D}\u{2642}\u{FE0F}', met: 3.5, int: 'Sedang', gps: true, cat: 'Kardio' },
  { name: 'Jogging', emoji: '\u{1F3C3}', met: 7.0, int: 'Sedang', gps: true, cat: 'Kardio' },
  { name: 'Lari', emoji: '\u{1F3C3}\u{200D}\u{2642}\u{FE0F}', met: 9.8, int: 'Tinggi', gps: true, cat: 'Kardio' },
  { name: 'Bersepeda santai', emoji: '\u{1F6B4}', met: 6.0, int: 'Sedang', gps: true, cat: 'Kardio' },
  { name: 'Bersepeda intens', emoji: '\u{1F6B4}\u{200D}\u{2642}\u{FE0F}', met: 10.0, int: 'Tinggi', gps: true, cat: 'Kardio' },
  { name: 'Renang santai', emoji: '\u{1F3CA}', met: 5.8, int: 'Sedang', gps: false, cat: 'Kardio' },
  { name: 'Renang intens', emoji: '\u{1F3CA}\u{200D}\u{2642}\u{FE0F}', met: 9.8, int: 'Tinggi', gps: false, cat: 'Kardio' },
  { name: 'Trekking/Hiking', emoji: '\u{1F97E}', met: 6.0, int: 'Sedang', gps: true, cat: 'Outdoor' },
  { name: 'Trail running', emoji: '\u{1F3D4}\u{FE0F}', met: 10.5, int: 'Tinggi', gps: true, cat: 'Outdoor' },
  { name: 'Aerobik', emoji: '\u{1F483}', met: 6.5, int: 'Sedang', gps: false, cat: 'Kardio' },
  { name: 'Zumba', emoji: '\u{1F57A}', met: 6.5, int: 'Sedang', gps: false, cat: 'Kardio' },
  { name: 'Skip/tali', emoji: '\u{23ED}\u{FE0F}', met: 12.3, int: 'Tinggi', gps: false, cat: 'Kardio' },
  { name: 'Boxing', emoji: '\u{1F94A}', met: 7.8, int: 'Tinggi', gps: false, cat: 'Kardio' },
  { name: 'Yoga', emoji: '\u{1F9D8}', met: 2.5, int: 'Rendah', gps: false, cat: 'Fleksibilitas' },
  { name: 'Pilates', emoji: '\u{1F938}', met: 3.0, int: 'Rendah', gps: false, cat: 'Fleksibilitas' },
  { name: 'Angkat beban', emoji: '\u{1F3CB}', met: 5.0, int: 'Sedang', gps: false, cat: 'Kekuatan' },
  { name: 'Crossfit', emoji: '\u{1F4AA}', met: 8.0, int: 'Tinggi', gps: false, cat: 'Kekuatan' },
  { name: 'Futsal', emoji: '\u{26BD}', met: 10.0, int: 'Tinggi', gps: true, cat: 'Olahraga' },
  { name: 'Basket', emoji: '\u{1F3C0}', met: 6.5, int: 'Sedang', gps: true, cat: 'Olahraga' },
  { name: 'Badminton', emoji: '\u{1F3F8}', met: 5.5, int: 'Sedang', gps: false, cat: 'Olahraga' },
  { name: 'Tenis', emoji: '\u{1F3BE}', met: 7.3, int: 'Tinggi', gps: true, cat: 'Olahraga' },
]
  ...
  try {
    ...
    return rows.map((r: Record<string, unknown>) => {
      ...
      if (isJ) {
        ...
        const vs = (r as unknown as string).split(',').map((v: string) => v.trim())
...
function genRecs(b: Body, intake: number, prot: number, fiber: number, metH: number, sleep: number, water: number, sun: boolean, hr?: number, sys?: number, spo2?: number): Rec[] {
  const r: Rec[] = []
  const b_ = getBmi(b.w, b.h)
  const t_ = getTdee(getBmr(b.w, b.h, b.age, b.g), b.act)
  ...
  else if (b_ >= 30) add('\u{1F6A8}', 'Obesitas', 'BMI ' + b_.toFixed(1) + '. Konsultasi dokter untuk program penurunan berat terstruktur.', 0, C.bad)
  else add('\u2705', 'BMI ideal', 'BMI ' + b_.toFixed(1) + ' - pertahankan pola saat ini.', 3, C.ok)
  const diff = intake - t_; const pct = t_ > 0 ? diff / t_ : 0
  if (pct > 0.2) add('\u{1F37D}\uFE0F', 'Surplus tinggi', '+' + Math.round(diff) + ' kkal di atas TDEE. Risiko kenaikan berat.', 1, C.warn)
  else if (pct < -0.3) add('\u{1F4C9}', 'Defisit ekstrem', '-' + Math.round(Math.abs(diff)) + ' kkal. Metabolisme bisa melambat.', 1, C.warn)
  const pk = b.w > 0 ? prot / b.w : 0
  if (pk < 1.0) add('\u{1F969}', 'Protein rendah', prot + 'g (' + pk.toFixed(1) + 'g/kg). Target 1.2-1.6g/kg.', 1, C.pur)
  else if (pk >= 1.2) add('\u2705', 'Protein memadai', prot + 'g (' + pk.toFixed(1) + 'g/kg BB). Cukup.', 3, C.ok)
  if (fiber < 20) add('\u{1F96C}', 'Serat kurang', Math.round(fiber) + 'g - target 25g+. Tambah sayur & buah.', 2, C.warn)
  if (metH < 3.75) add('\u{1F3C3}', 'Olahraga kurang', metH.toFixed(1) + ' MET-jam/minggu. Target 7.5 (150 menit jalan cepat).', 0, C.org)
  else if (metH >= 7.5) add('\u2705', 'Olahraga memadai', metH.toFixed(1) + ' MET-jam/minggu. Memenuhi rekomendasi WHO.', 3, C.ok)
  if (sleep < 6) add('\u{1F319}', 'Tidur kurang', sleep + ' jam - risiko hipertensi & diabetes. Target 7-8 jam.', 0, C.ind)
  if (water < 1500) add('\u{1F4A7}', 'Hidrasi kurang', water + ' mL - target 2000 mL+.', 2, C.blue)
  if (!sun) add('\u2600\uFE0F', 'Tanpa matahari', '10-20 menit pagi untuk vitamin D.', 3, '#eab308')
  if (hr != null && hr > 80) add('\u{1F493}', 'HR istirahat tinggi', hr + ' bpm - optimal <75. Tingkatkan kardio zona-2.', 1, C.bad)
  if (sys != null && sys > 130) add('\u{1FEA7}', 'Tekanan darah tinggi', sys + ' mmHg - kurangi garam, tingkatkan aktivitas.', 0, C.bad)
  if (spo2 != null && spo2 < 96) add('\u{1F9E1}', 'SpO2 rendah', spo2 + '% - normal >=97%. Periksa ke faskes.', 0, C.bad)
    ...
    <Card className="!p-5">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button onClick={onShare} className="rounded-lg bg-brand/10 px-3 py-1.5 text-[11px] font-bold text-brand-dark transition hover:bg-brand/20 active:scale-95">{'\u{1F4E3}'} Share</button>
      ...
      <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
        ...
        <div className="rounded-xl border border-neutral-100 p-3 text-center">
          <div className="text-2xl font-extrabold text-brand-dark"><ANum v={Math.round(td)} /></div>
  ...
  return (
    <Card className="!p-5">
      ...
      <div className="mt-2 flex flex-wrap gap-1.5 max-h-28 overflow-y-auto rounded-xl border border-neutral-100 bg-neutral-50/50 p-2">
        {filtered.map(f => (
          <button key={f.name} onClick={() => setName(f.name)} className={'rounded-lg border px-2 py-1 text-[11px] font-medium transition active:scale-95 ' + (name === f.name ? 'border-brand bg-brand/10 text-brand-dark' : 'border-transparent text-neutral-600 hover:bg-white')}>
      ...
      <div className="mt-3 flex items-end gap-3">
        <div className="flex-1 rounded-xl bg-neutral-50 px-4 py-3">
          <div className="flex items-baseline gap-2"><span className="text-sm font-bold text-neutral-800">{fd.emoji} {name}</span><Badge tone="neutral">{fd.cat}</Badge></div>
          <div className="mt-1 flex gap-3 text-xs tabular-nums font-semibold">
            <span style={{ color: C.ok }}>{pv.k} kkal</span>
      ...
      <div className="mt-3 space-y-1">
        ...
        {todays.map(f => { const s = FD.find(x => x.name === f.name); return (
          <div key={f.id} className="flex items-center justify-between rounded-lg px-3 py-2 transition hover:bg-neutral-50">
            ...
            <div className="shrink-0 tabular-nums text-xs"><span className="font-bold text-brand-dark">{f.kcal}</span><span className="text-neutral-400 ml-1">kkal</span></div>
          </div>
        )})}
      </div>
    </Card>
...
function GPSTracker({ body, onComplete }: { body: Body; onComplete: (kcal: number, min: number, metH: number) => void }) {
  ...
  const [gpsErr, setGpsErr] = useState(''); const [shared, setShared] = useState(false)
  ...
  const { addPost, account } = useStore()
  ...
  function share() {
    addPost({ id: uid(), authorEmail: account?.email ?? '', authorName: account?.name ?? 'Saya', role: account?.role ?? 'pasien', postType: 'kebiasaan', kind: 'image', activity: exType.name, caption: exType.emoji + ' ' + exType.name + ' - ' + fmtDist(dist) + ' - ' + fmtD(dur) + ' - ' + Math.round(speed) + ' km/h - ' + kcal + ' kkal', mediaColor: exType.met >= 7 ? C.org : C.ok, calories: kcal, likes: 0, comments: 0, reposts: 0, at: new Date().toISOString() })
  ...
  return (
    <Card className="!p-0 overflow-hidden">
      <div className="flex items-center justify-between px-5 pt-5 pb-3">
        ...
        {mode === 'done' && <button onClick={share} className="rounded-lg bg-brand px-3 py-1.5 text-[11px] font-bold text-white transition hover:bg-brand/90 active:scale-95">{shared ? 'Shared!' : 'Share'}</button>}
      </div>
      ...
      <div className="mx-5 rounded-2xl overflow-hidden" style={{ background: 'linear-gradient(135deg, #0f172a 0%, #1e293b 100%)' }}>
        <svg ref={svgRef} viewBox="0 0 360 240" className="w-full cursor-crosshair" onClick={onSvgClick} style={{ minHeight: 200 }}>
          ...
          {plan.length >= 2 && <><path d={planPathD()} fill="none" stroke="rgba(139,92,246,0.5)" strokeWidth="3" strokeDasharray="8 4" strokeLinecap="round" />{plan.map((p, i) => <g key={'wp' + i}><circle cx={p.x} cy={p.y} r="5" fill="rgba(139,92,246,0.3)" stroke="#8b5cf6" strokeWidth="1.5" /></g>)}</>}
        ...
        {(mode === 'tracking' || mode === 'paused' || mode === 'done') && (
          <div className="grid grid-cols-4 gap-px bg-black/30">
            {[[fmtD(dur), 'WAKTU'], [fmtDist(dist), 'JARAK'], [Math.round(speed) + ' km/h', 'KECEPATAN'], [fmtPace(dur, dist), 'PACE']].map(([v, l]) => (
        ...
        {mode === 'done' && (
          <div className="rounded-xl bg-gradient-to-r from-brand to-emerald-600 p-4 text-white">
            ...
            <div className="mt-2 grid grid-cols-4 gap-3 text-center text-xs">
              ...
              <div><div className="font-bold">{Math.round(speed)} km/h</div><div className="text-white/50">Kecepatan</div></div>
...
function SleepWater({ body }: { body: Body }) {
  ...
  return (
    <Card className="!p-5">
      <SectionTitle icon={<span className="text-lg">{'\u{1F4A4}'}</span>} title="Tidur, Air & Mingguan" />
      <div className="mt-3 grid gap-3 sm:grid-cols-3">
        ...
        <div className="rounded-xl border border-neutral-100 p-3">
          <div className="flex items-center gap-2 mb-2"><span className="text-lg">{'\u{1F4A7}'}</span><span className="text-xs font-bold text-neutral-700">Air</span><span className="ml-auto text-sm font-extrabold text-blue-600 tabular-nums"><ANum v={wt.waterMl} /> mL</span></div>
          <Stepper value={wt.waterMl} min={0} max={5000} step={250} unit="mL" onChange={v => logWellness(today(), { waterMl: v })} />
        </div>
        <div className="rounded-xl border border-neutral-100 p-3">
          <div className="flex items-center gap-2 mb-2"><span className="text-lg">{'\u26A1'}</span><span className="text-xs font-bold text-neutral-700">MET-jam/minggu</span><span className="ml-auto text-sm font-extrabold tabular-nums" style={{ color: weekMet >= 7.5 ? C.ok : C.org }}><ANum v={weekMet} d={1} /></span></div>
          <div className="h-1.5 rounded-full bg-neutral-100 overflow-hidden mt-3"><div className="h-full rounded-full transition-all duration-700" style={{ width: Math.min(100, weekMet / 15 * 100) + '%', background: weekMet >= 7.5 ? C.ok : C.org }} /></div>
          <div className="mt-1 flex justify-between text-[9px] text-neutral-400"><span>0</span><span>WHO: 7.5</span><span>15</span></div>
        </div>
      </div>
    </Card>
  )
...
function TrendChart({ recKcal }: { recKcal: number }) {
  ...
  const W = 340; const H = 120; const base = 105; const pad = 15
  const xs = days.map((_, i) => pad + i * ((W - pad * 2) / 6))
  const nK = days.map(d => Math.min(1, d.k / (recKcal || 2000)))
  const yK = nK.map(v => base - v * (base - 15))
  const lineD = xs.length ? 'M' + xs[0] + ',' + yK[0] + xs.slice(1).map((x, i) => ' L' + x + ',' + yK[i]).join('') : ''
  const fillD = lineD + ' L' + xs[6] + ',' + base + ' L' + xs[0] + ',' + base + ' Z'
  return (
    <Card className="!p-5">
      <SectionTitle icon={<span className="text-lg">{'\u{1F4CA}'}</span>} title="Tren 7 Hari" />
      {!has ? <Empty e={'\u{1F4CA}'} t="Belum ada data" /> : (
        <div className="mt-3 overflow-x-auto rounded-xl bg-neutral-50 p-3">
          <svg viewBox={'0 0 ' + W + ' ' + H} className="w-full" style={{ minWidth: 280 }}>
            <line x1={pad} x2={W - pad} y1={base} y2={base} stroke="rgba(0,0,0,0.06)" />
            <line x1={pad} x2={W - pad} y1={(base + 15) / 2} y2={(base + 15) / 2} stroke="rgba(0,0,0,0.03)" strokeDasharray="4 4" />
            <g style={{ opacity: vis ? 1 : 0, transition: 'opacity 0.6s' }}>
              <path d={fillD} fill={C.ok} fillOpacity="0.15" />
              <path d={lineD} fill="none" stroke={C.ok} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
              {days.map((d, i) => d.k > 0 && <circle key={d.dt} cx={xs[i]} cy={yK[i]} r="3.5" fill="white" stroke={C.ok} strokeWidth="2" />)}
            </g>
            {days.map((d, i) => <text key={d.dt} x={xs[i]} y={H - 2} textAnchor="middle" fontSize="8" fill="#bbb" fontWeight="500">{new Date(d.dt).toLocaleDateString('id-ID', { weekday: 'short' })}</text>)}
          </svg>
        </div>
      )}
    </Card>
...
function ChronicMonitor() {
  ...
  const p = activePatient; const vitals = state.vitals[p.id] ?? []; const latest = vitals[vitals.length - 1]
  const [show, setShow] = useState(false); const [payMsg, setPayMsg] = useState('')
  ...
  async function buy(plan: 'monthly' | 'lifetime') {
    ...
    try {
      ...
      if (r.live && r.redirectUrl) {
        ...
        setPayMsg('Selesaikan pembayaran di tab Midtrans.')
        let n = 0
        const iv = setInterval(async () => {
          n++
          try { const s = await api.paymentStatus(r.orderId); if (s.status === 'paid') { clearInterval(iv); buyChronicSub(plan); setPayMsg('Berhasil!') } else if (s.status === 'failed') { clearInterval(iv); setPayMsg('Gagal.') } } catch { /* retry */ }
  ...
  const fields: [string, string][] = [['sys', 'Sistolik'], ['dia', 'Diastolik'], ['hr', 'Nadi'], ['rr', 'RR'], ['temp', 'Suhu'], ['spo2', 'SpO2'], ['glu', 'Gula (ops.)']]
  ...
  if (!active) return (
    <Card className="!p-5 border-2 border-brand/15">
      ...
      <div className="mt-4 rounded-2xl border-2 border-dashed border-brand/25 bg-brand/[0.03] p-6">
        <p className="text-sm text-neutral-600">Untuk pasien <b>hipertensi, diabetes, jantung</b>: catat TTV harian.</p>
        <div className="mt-4 grid gap-3 sm:grid-cols-2">
          <button onClick={() => buy('monthly')} className="rounded-xl border-2 border-neutral-200 p-4 text-left transition hover:border-brand/40 hover:shadow-sm"><div className="text-[10px] font-bold uppercase tracking-widest text-neutral-400">Bulanan</div><div className="mt-1 text-2xl font-extrabold">Rp{CHRONIC_MONTHLY.toLocaleString('id-ID')}<span className="text-sm font-medium text-neutral-400">/bln</span></div></button>
          <button onClick={() => buy('lifetime')} className="relative rounded-xl border-2 border-brand bg-brand/[0.04] p-4 text-left transition hover:shadow-sm"><span className="absolute -top-2.5 right-3 rounded-full bg-brand px-2 py-0.5 text-[9px] font-bold text-white">Terbaik</span><div className="text-[10px] font-bold uppercase tracking-widest text-brand-dark">Lifetime</div><div className="mt-1 text-2xl font-extrabold text-brand-dark">Rp{(CHRONIC_LIFETIME / 1e6).toLocaleString('id-ID')}jt</div></button>
        </div>
    ...
    <Card className="!p-5 border-2 border-brand/15">
      ...
      {status === 'alert' && (
        <div className="mt-3 flex flex-wrap items-center justify-between gap-2 rounded-xl border-2 border-red-200 bg-red-50 px-4 py-3">
          ...
          <div className="flex gap-2"><Link to="/consult"><Button variant="outline" className="h-7 text-xs rounded-xl"><IconStethoscope size={13} /> Konsultasi</Button></Link><Link to="/hospitals"><Button className="h-7 text-xs rounded-xl"><IconHospital size={13} /> SOS</Button></Link></div>
        </div>
      )}
      {status === 'warn' && (
        <div className="mt-3 flex items-center justify-between gap-2 rounded-xl border border-amber-200 bg-amber-50 px-4 py-2.5">
          <span className="text-sm font-medium text-amber-800">Sebagian nilai di luar target.</span>
          <Link to="/consult"><Button variant="outline" className="h-7 text-xs rounded-xl">Konsultasi</Button></Link>
        </div>
      )}
      <div className="mt-3 flex items-center justify-between gap-2">
        <span className="text-sm text-neutral-500">Status: <b style={{ color: STATUS_COLOR[status] }}>{latest ? STATUS_LABEL[status] : 'Belum ada data'}</b></span>
      ...
      ) : <Empty e={'\u{1FEA7}'} t="Belum ada catatan TTV" />}
    </Card>
  )
}
...
function LongevityCalc({ body, intakeKcal, proteinG, fiberG, weekMetHours }: { body: Body; intakeKcal: number; proteinG: number; fiberG: number; weekMetHours: number }) {
  ...
  const [sleepHr, setSleepHr] = useState(7); const [hydrationL, setHydrationL] = useState(2)
  const [sunDone, setSunDone] = useState(false); const [sunHr, setSunHr] = useState(0.25)
  const [iv, setIv] = useState<IV[]>([]); const [ivSum, setIvSum] = useState<ReturnType<typeof avgIV> | null>(null)
  const [iMsg, setIMsg] = useState(''); const [drag, setDrag] = useState(false)
  const [btHR, setBtHR] = useState<number | null>(null); const [btL, setBtL] = useState(false)
  ...
  const handleFile = useCallback((file: File) => {
    ...
    r.onload = (e) => {
      const p = parseF(e.target?.result as string, file.name)
      if (!p.length) { setIMsg('Tidak ada data. Pastikan ada kolom date.'); return }
      setIv(p); const s = avgIV(p); setIvSum(s); setIMsg(s.n + ' data diimpor.')
      if (btHR != null) { const ts = today(); if (!p.some(v => v.date === ts)) { const u = [...p, { date: ts, heartRate: btHR }]; setIv(u); setIvSum(avgIV(u)) } }
    }
    r.readAsText(file)
  }, [btHR])
  ...
  async function connectBT() {
    if (!navigator.bluetooth) { setIMsg('Browser tidak mendukung Web Bluetooth.'); return }
    setBtL(true); setIMsg('Mencari perangkat...')
    try {
      const dev = await navigator.bluetooth.requestDevice({ filters: [{ services: ['heart_rate'] }] })
      const srv = await dev.gatt.connect()
      const chr = await srv.getPrimaryService('heart_rate').then(s => s.getCharacteristic('heart_rate_measurement'))
      const hrVal = await new Promise<number>((res, rej) => {
        const t = setTimeout(() => { chr.stopNotifications(); rej(new Error('Timeout')) }, 15000)
        chr.addEventListener('characteristicvaluechanged', (ev) => {
          const v = (ev.target as BluetoothRemoteGATTCharacteristic).value!
          const h = v.getUint8(0) & 0x01 ? v.getUint16(1, true) : v.getUint8(1)
          clearTimeout(t); chr.stopNotifications(); res(h)
        })
        chr.startNotifications()
      })
      setBtHR(hrVal); setIMsg('HR: ' + hrVal + ' bpm')
      const ts = today()
      if (!iv.some(v => v.date === ts)) { const u = [...iv, { date: ts, heartRate: hrVal }]; setIv(u); setIvSum(avgIV(u)) }
      srv.disconnect()
    } catch (err: unknown) { setIMsg(err instanceof Error ? err.message : 'Gagal') } finally { setBtL(false) }
  }

  function compute() {
    setResult(calcLong({ sleepHr, hydrationL, sunDone, sunHr, bmiVal: bi, tdeeVal: td, intakeKcal, proteinG, weightKg: body.w, fiberG, metHoursWeek: weekMetHours, avgHR: ivSum?.avgHR, avgSpo2: ivSum?.avgSpo2, avgSteps: ivSum?.avgSteps, avgHrv: ivSum?.avgHrv, vo2Max: ivSum?.vo2Max, avgSys: ivSum?.avgSys }))
  }

  function shareFeed() {
    if (!result) return
    addPost({ id: uid(), authorEmail: account?.email ?? '', authorName: account?.name ?? 'Saya', role: account?.role ?? 'pasien', postType: 'kebiasaan', kind: 'image', activity: 'Longevity', caption: 'Skor Longevity: ' + result.score + '/100' + (result.hasV ? ' (+vital)' : '') + ' #PerjalananSehat', mediaColor: '#00BF63', waterMl: Math.round(hydrationL * 1000), veggieServ: 0, sleepHr, sugaryDrinks: 0, likes: 0, comments: 0, reposts: 0, at: new Date().toISOString() })
    setShared(true); setTimeout(() => setShared(false), 3000)
  }
  ...
  return (
    <Card className="!p-5">
      <div className="flex flex-wrap items-start justify-between gap-2">
        <SectionTitle icon={<IconSparkle size={20} />} title="Longevity & Rekomendasi" />
        <div className="flex gap-2">{subActive ? <Badge tone="brand">{daysLeft} hari</Badge> : <Badge tone="high">Langganan</Badge>}</div>
      </div>
      <div className="mt-4 grid gap-4 lg:grid-cols-2">
        <div className="space-y-3">
          {/* Import */}
          <div className="rounded-xl border border-neutral-100 p-4">
            <div className="flex items-center gap-2 mb-2"><span className="text-base">{'\u{1F493}'}</span><div><div className="text-sm font-bold">Import Tanda Vital</div><div className="text-[10px] text-neutral-400">Apple Health, Google Fit, CSV/JSON</div></div></div>
            <div className={'flex cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed p-4 transition-all ' + (drag ? 'border-brand bg-brand/[0.06]' : 'border-neutral-200 hover:border-neutral-300')} onDrop={onDrop} onDragOver={onDragOver} onDragLeave={() => setDrag(false)} onClick={() => fRef.current?.click()}>
              <span className="text-xl">{'\u{1F4C1}'}</span><p className="text-[11px] text-neutral-500 mt-1">Seret CSV/JSON atau klik</p>
              <input ref={fRef} type="file" accept=".csv,.json" className="hidden" onChange={e => { const f = e.target.files?.[0]; if (f) handleFile(f) }} />
            </div>
            <button onClick={connectBT} disabled={btL} className="mt-2 flex items-center gap-1.5 rounded-lg border border-blue-200 bg-blue-50 px-3 py-2 text-[11px] font-medium text-blue-700 transition hover:bg-blue-100 disabled:opacity-50 w-full justify-center">
              <span className={'h-2 w-2 rounded-full ' + (btL ? 'animate-pulse bg-blue-400' : btHR != null ? 'bg-green-500' : 'bg-blue-400')} />
              {btL ? 'Menghubungkan...' : btHR != null ? 'HR ' + btHR + ' bpm' : 'Baca Heart Rate Bluetooth'}
            </button>
            {iMsg && <div className={'mt-2 rounded-lg px-3 py-2 text-[11px] font-medium ' + (iMsg.startsWith('0') || iMsg.startsWith('H') ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700')}>{iMsg}</div>}
            {ivSum && ivSum.n > 0 && (
              <div className="mt-2 flex flex-wrap items-center gap-1.5">
                {ivSum.avgHR != null && <span className="rounded-md bg-red-50 px-2 py-0.5 text-[10px] font-bold text-red-600">HR {ivSum.avgHR}</span>}
                {ivSum.avgSpo2 != null && <span className="rounded-md bg-blue-50 px-2 py-0.5 text-[10px] font-bold text-blue-600">SpO2 {ivSum.avgSpo2}%</span>}
                {ivSum.avgSteps != null && <span className="rounded-md bg-green-50 px-2 py-0.5 text-[10px] font-bold text-green-600">{Math.round(ivSum.avgSteps).toLocaleString('id-ID')} steps</span>}
                {ivSum.avgHrv != null && <span className="rounded-md bg-purple-50 px-2 py-0.5 text-[10px] font-bold text-purple-600">HRV {ivSum.avgHrv}</span>}
                {ivSum.avgSys != null && <span className="rounded-md bg-rose-50 px-2 py-0.5 text-[10px] font-bold text-rose-600">Sistolik {ivSum.avgSys}</span>}
                <button onClick={() => { setIv([]); setIvSum(null); setIMsg(''); setBtHR(null) }} className="ml-auto text-[10px] text-neutral-400 hover:text-red-500">X</button>
              </div>
            )}
            <details className="mt-2"><summary className="cursor-pointer text-[10px] font-semibold text-neutral-400 hover:text-neutral-600">Format file</summary><div className="mt-1 rounded-lg bg-neutral-50 p-2 text-[10px] text-neutral-500 font-mono leading-relaxed">CSV: date,heart_rate,steps,spo2,systolic{'\n'}JSON: [{"date":"...","heartRate":72}]</div></details>
          </div>
          {/* Inputs */}
          <div className="rounded-xl border border-neutral-100 p-4 space-y-2">
            <Stepper label={'\u{1F319} Tidur'} value={sleepHr} min={0} max={12} step={0.5} unit="jam" onChange={setSleepHr} />
            <Stepper label={'\u{1F4A7} Air'} value={hydrationL} min={0} max={6} step={0.25} unit="L" onChange={setHydrationL} />
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 text-sm"><input type="checkbox" checked={sunDone} onChange={e => setSunDone(e.target.checked)} className="h-4 w-4 accent-brand rounded" />{'\u2600\uFE0F Berjemur?'}</label>
              {sunDone && <Stepper value={sunHr} min={0} max={3} step={0.25} unit="jam" onChange={setSunHr} />}
            </div>
          </div>
        ...
        <div className="space-y-4">
          {!subActive ? (
            <div className="flex h-full flex-col items-center justify-center rounded-xl border-2 border-dashed border-brand/30 bg-brand/[0.03] p-8 text-center">
              ...
              <p className="mt-1 text-sm text-neutral-500">30 hari <b>Rp{PRICE_LONGEVITY.toLocaleString('id-ID')}</b></p>
              <Button className="mt-4" onClick={() => buyLongevitySub()}><IconSparkle size={15} /> Langgani</Button>
            </div>
          ) : result ? (
            <div className="rounded-xl bg-gradient-to-br from-brand to-brand-dark p-5 text-white shadow-lg">
              <div className="flex items-center gap-4">
                <Ring value={result.score} max={100} color="#fff" size={80} sw={6}><span className="text-2xl font-extrabold">{result.score}</span></Ring>
                <div><div className="text-[10px] font-bold uppercase tracking-widest text-white/60">Skor Longevity</div><div className="mt-1 text-sm text-white/80">{result.score >= 80 ? 'Sangat baik' : result.score >= 60 ? 'Cukup baik' : 'Perlu perbaikan'}</div></div>
              </div>
              <div className="mt-4 space-y-2">
                {result.hasB && <Pillar label="BMI & Tubuh" v={result.body} />}
                <Pillar label="Nutrisi" v={result.nut} />
                <Pillar label="Olahraga (MET)" v={result.exer} />
                <Pillar label="Tidur" v={result.sleep} />
                {result.hasB && <Pillar label="Keseimbangan Kalori" v={result.cal} />}
                <Pillar label="Hidrasi" v={result.hydr} />
                <Pillar label="Matahari" v={result.sun} />
                {result.hasV && <Pillar label="Tanda Vital" v={result.vit} hl />}
              </div>
              <button onClick={shareFeed} className="mt-4 w-full rounded-xl bg-white py-2.5 text-sm font-bold text-brand-dark transition hover:bg-white/90">{shared ? 'Dibagikan!' : 'Bagikan ke Feed'}</button>
            </div>
          ) : (
            <div className="flex h-full min-h-[200px] items-center justify-center rounded-xl bg-neutral-50 text-center text-sm text-neutral-400">Isi data lalu tekan <b>"Hitung Longevity"</b></div>
          )}
          {/* Recommendations */}
          {recs.length > 0 && (
            <div>
              <div className="text-sm font-bold text-neutral-800 mb-2">Rekomendasi untuk Anda</div>
              <div className="space-y-2">
                {recs.map((r, i) => (
                  <div key={i} className="flex items-start gap-2.5 rounded-xl border border-neutral-100 p-3 transition hover:shadow-sm">
                    <span className="text-lg shrink-0">{r.e}</span>
                    <div><div className="text-xs font-bold" style={{ color: r.c }}>{r.t}</div><p className="mt-0.5 text-[11px] leading-relaxed text-neutral-500">{r.d}</p></div>
                  </div>
                ))}
              </div>
            </div>
