          ...
          <div className="min-w-[240px] flex-1">
            <Field label="Instructions / Treatment">
              <input
                ...
                placeholder="e.g. Furosemide 40 mg IV — check the dose against the formulary"
              />
            </Field>
          </div>
      ...
      {open && (
        <div className="space-y-2.5">
          ...
          <p className="text-[11px] leading-relaxed text-neutral-500">
            V/L/S and the weighted score are explanatory heuristics, not validated clinical probabilities. Verification
            uses explicit local blocker rules for direct documented-allergy matches, listed major DDIs, and missing
            explicit doses on locally recognized high-alert medications. No local hit is not comprehensive medication
            clearance; clinician review and a governed medication knowledge source remain required.
          </p>
        </div>
      )}
    </Card>
