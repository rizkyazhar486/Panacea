...
type HomeView = 'home' | 'social' | 'clubs' | 'finance' | 'markets' | 'scores' | 'learn'
...
const VIEWS: View[] = [
  ...
  { key: 'social', label: 'Social', short: 'Social', component: Feed, description: 'Healthy-living posts, activity, learning and community sharing.' },
  ...
  { key: 'learn', label: 'Read & Learn', short: 'Read', component: MedStudyHub, description: 'A compact reading and learning room inside the social home.' },
]
  ...
  return (
    <div className="mx-auto w-full max-w-[1450px] space-y-4 pb-10">
      ...
      <section className="rounded-[30px] border border-white/10 bg-black/20 p-4 shadow-2xl backdrop-blur-xl sm:p-5">
        ...
        <p className="mt-2 max-w-3xl text-sm leading-relaxed text-neutral-500 dark:text-neutral-300">Logs and stats sit beside friends, clubs, finance, markets, scores and reading instead of being scattered across the application.</p>
