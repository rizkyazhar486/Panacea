...
export function HomeSocialWorkspace() {
  ...
  return (
    <div className="mx-auto w-full max-w-[1450px] space-y-3 pb-10 sm:space-y-4">
      ...
      <div className="sticky top-2 z-30 -mx-1 rounded-[18px] border border-white/10 bg-[#020509]/95 p-1.5 shadow-[0_18px_46px_rgba(0,0,0,.28)] backdrop-blur-2xl">
        ...
        <nav className="no-scrollbar flex gap-1 overflow-x-auto" aria-label="Home rooms" role="tablist">
          {VIEWS.map((view) => (
            <button
              key={view.key}
              type="button"
