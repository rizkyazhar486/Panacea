...
function VtLtCard() {
  ...
  return (
    <div className="rounded-2xl border border-neutral-100 p-4">
      ...
      <div className="mt-2 grid grid-cols-2 gap-2">
        <div className="rounded-xl bg-neutral-50 p-2.5"><div className="text-[10px] font-bold uppercase text-neutral-500">VT1/LT1</div><div className="text-base font-extrabold text-brand-dark">{(vo2 * 0.6).toFixed(1)}</div></div>
        <div className="rounded-xl bg-neutral-50 p-2.5"><div className="text-[10px] font-bold uppercase text-neutral-500">VT2/LT2</div><div className="text-base font-extrabold text-brand-dark">{(vo2 * 0.85).toFixed(1)}</div></div>
      </div>
...
function VentilationCard() {
  ...
  return (
    <div className="rounded-2xl border border-neutral-100 p-4 sm:col-span-2">
      ...
      <div className="mt-2 grid grid-cols-3 gap-2">
        <div className="rounded-xl bg-neutral-50 p-2.5"><div className="text-[10px] font-bold uppercase text-neutral-500">VE/VO₂</div><div className="text-base font-extrabold text-brand-dark">{veVo2.toFixed(1)}</div></div>
        <div className="rounded-xl bg-neutral-50 p-2.5"><div className="text-[10px] font-bold uppercase text-neutral-500">VE/VCO₂</div><div className="text-base font-extrabold text-brand-dark">{veVco2.toFixed(1)}</div></div>
        <div className="rounded-xl bg-neutral-50 p-2.5"><div className="text-[10px] font-bold uppercase text-neutral-500">RER</div><div className="text-base font-extrabold text-brand-dark">{rer.toFixed(2)}</div></div>
      </div>
