...
export function InitialAssessment() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-5 pb-24">
      ...
      {step === 0 && (
        <Card className="!p-5">
          <SectionTitle icon={<IconActivity size={20} />} title="Movement Pattern Screen" subtitle="Score it yourself (use a mirror or record a video) — 0 unable, 1 with compensation, 2 clean" />
      ...
      {step === 1 && (
        <Card className="!p-5">
          <SectionTitle icon={<IconHeart size={20} />} title="Pain & Injury History" subtitle="Mark any area that hurts or has been injured" />
          <div className="mt-3 flex flex-wrap gap-1.5">
            {PAIN_REGIONS.map((r) => (
      ...
      {step === 2 && (
        <Card className="!p-5">
          <SectionTitle icon={<IconActivity size={20} />} title="Baseline Strength" subtitle="Simple tests — a baseline to track your progress against" />
      ...
      {step === 4 && (
        <Card className="!p-5">
          <SectionTitle icon={<IconHeart size={20} />} title="Quality of Life Screening" subtitle="Choose a reference instrument (a short adaptation, not the licensed official version)" />
      ...
      {step === 5 && (
        <Card className="!p-5">
          <SectionTitle icon={<IconCheck size={20} />} title="Summary & Save" subtitle="Check this over before saving the assessment" />
