  ...
  return (
    <div className="mx-auto max-w-2xl space-y-5 pb-24">
      <Card className="!p-5">
        ...
        <Prosa kelas="mt-2 text-[13px] leading-relaxed text-neutral-500">Regular group activity is one of the strongest predictors of sticking with exercise. Join a club, show up to meetups, and your training no longer depends on willpower alone. Anyone can start a club or host a meetup — there's no gatekeeper.</Prosa>
  ...
  return createPortal(
    <div className="fixed inset-0 z-[80] flex items-end justify-center bg-black/60 sm:items-center sm:p-4" role="dialog" aria-label="Start a club" onClick={onClose}>
      <div className="max-h-[88vh] w-full max-w-lg overflow-y-auto rounded-t-3xl bg-white p-5 dark:bg-neutral-900 sm:rounded-3xl" onClick={(e) => e.stopPropagation()}>
        ...
        <Prosa kelas="mt-1 text-[12px] leading-relaxed text-neutral-500">This creates a real, public club visible to every Panaceamed user — you become its first member. Once it exists, host meetups under it from the Meetups tab.</Prosa>
        <div className="mt-4 space-y-3">
