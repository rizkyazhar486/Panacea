  ...
  return (
    <div className="mx-auto w-full max-w-7xl space-y-5 px-4 py-5 sm:px-6">
      <section className="rounded-3xl border border-neutral-200 bg-gradient-to-br from-white via-white to-brand/[0.06] p-5 dark:border-white/10 dark:from-neutral-950 dark:via-neutral-950 dark:to-brand/[0.08]">
        ...
        <h1 className="mt-1 text-2xl font-black tracking-tight text-ink dark:text-white">From health app → programmable care infrastructure</h1>
        <p className="mt-2 max-w-4xl text-sm leading-relaxed text-neutral-500">
          Production scaffolds for the next layer of Panacea: causal decision support, clinical-trial matching, patient-controlled credentials,
          federated learning, multimodal ambient documentation, spatial pathology, hospital-at-home orchestration and privacy-preserving research.
          These cards are execution contracts, not claims that external clinical integrations are already deployed.
        </p>
      </section>
