  ...
  return (
    <div className="mx-auto max-w-2xl space-y-5 pb-24">
      <Card className="!p-5">
        ...
        <Prosa kelas="mt-2 text-[13px] leading-relaxed text-neutral-500">Dihitung sebelum endoskopi, hanya dari data klinis dan laboratorium. Skor 0 menandai pasien yang cukup rendah risikonya sehingga sebagian pedoman mendukung penanganan rawat jalan tanpa perawatan inap maupun endoskopi segera.</Prosa>
