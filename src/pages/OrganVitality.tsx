    ...
    <div className="rounded-xl border border-neutral-100 p-3">
      <div className="flex items-baseline justify-between gap-2">
        ...
        <span className="text-sm font-extrabold" style={{ color: BAND_COLOR[band] }}>
          {v || '—'}<span className="ml-0.5 text-[10px] font-medium text-neutral-500">{m.unit}</span>
        </span>
      </div>
...
export function OrganVitality() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-5 pb-24">
      <Card className="!p-5">
        <SectionTitle icon={<IconHeart size={20} />} title="Anti-Aging & Organ Function" subtitle="The numbers, safe ranges and quality control behind healthy ageing — not general fitness" />
