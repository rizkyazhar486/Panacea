...
export default function MultisystemScaleNavigator() {
  ...
  return (
    <section data-body-multisystem-scale-navigator="v1" data-selected-scale={selected.scale} className="rounded-2xl border border-neutral-200 bg-white/80 p-3 dark:border-white/10 dark:bg-white/5">
      ...
      <div className="mt-3">
        <Suspense fallback={<div role="status" className="flex min-h-32 items-center justify-center rounded-2xl border border-neutral-200 text-xs font-bold text-neutral-500 dark:border-white/10">Loading all-system 3D explorer…</div>}>
          <BodyAllSystems3D />
        </Suspense>
      </div>
