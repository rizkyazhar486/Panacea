    ...
    <div className="space-y-4">
      ...
      <div className="border-t border-neutral-200 pt-3 dark:border-white/10">
        ...
        <p className="mt-1 text-[11px] leading-snug text-neutral-500">
          Layer-by-layer educational anatomy. Shared 3D depth is an approximate system-layer correspondence, not an operative plane, instrument path, or patient-specific reconstruction.
        </p>
      </div>
