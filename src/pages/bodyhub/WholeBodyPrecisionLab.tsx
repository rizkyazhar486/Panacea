...
type Mode = 'holistic' | 'z-anatomy' | 'unfolded' | 'specialty' | 'movement'
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-1 rounded-xl bg-neutral-100 p-1 dark:bg-white/5 md:grid-cols-5">
        {([['holistic', 'Holistic healthcare'], ['z-anatomy', 'Z-Anatomy atlas'], ['unfolded', 'Unfolded body'], ['specialty', 'Specialty atlas'], ['movement', 'Movement biomechanics']] as const).map(([key, label]) => (
      ...
      {mode === 'holistic' && (
        <HolisticHealthcareAtlas onHighlight={onHighlight} onFocusRegion={onFocusRegion} onEnableLayer={onEnableLayer} />
      )}
