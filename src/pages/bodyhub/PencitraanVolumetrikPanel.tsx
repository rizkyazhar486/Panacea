  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-2xl border border-[var(--pelatih-garis,rgba(15,23,42,0.10))] p-3">
        ...
        <Geser label="Lower threshold" nilai={bawah} min={-1000} maks={2900} langkah={10} onUbah={setBawah} />
        <Geser label="Upper threshold" nilai={atas} min={-990} maks={3000} langkah={10} onUbah={setAtas} />
