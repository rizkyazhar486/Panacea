...
function ActHero() {
  return (
    <div className="flex h-full w-full flex-col items-center justify-center gap-4 text-center" style={{ background: 'linear-gradient(180deg, #052E1C 0%, #0B4A2E 60%, #0B7A4B 100%)' }}>
      ...
      <p className="relative max-w-md px-6 text-sm font-semibold text-white/75 sm:text-base">Menuju Hidup yang Lebih Panjang dan Lebih Sehat</p>
    </div>
  )
}
...
function ActVitality() {
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-start gap-6 pt-20 text-center" style={{ background: 'linear-gradient(180deg, #0B4A2E 0%, #0B7A4B 55%, #00BF63 100%)' }}>
      ...
      <p className="relative max-w-md px-6 text-sm font-semibold text-white/80">Bergerak tiap hari, hidup lebih panjang</p>
      <StretchSilhouette />
...
function ActScience() {
  const chips = ['VO₂max', 'Titik Ukur Biomarker', 'Telaah Klinis AI']
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-start gap-4 pt-20 text-center" style={{ background: 'linear-gradient(180deg, #00BF63 0%, #0B7A4B 55%, #0B4A2E 100%)' }}>
      ...
      <DnaHelix />
      <h2 className="relative text-2xl font-black tracking-tight text-white sm:text-4xl">ILMU UMUR PANJANG</h2>
...
function ActLongevity() {
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-center gap-4 text-center" style={{ background: 'linear-gradient(180deg, #0B4A2E 0%, #0B7A4B 45%, #052E1C 100%)' }}>
      ...
      <Particles seed={29} />
      <h2 className="relative max-w-lg px-6 text-2xl font-black tracking-tight text-white sm:text-4xl">UMUR PANJANG DIMULAI HARI INI</h2>
      <p className="relative text-base font-bold" style={{ color: '#7CF5B8' }}>Mulai Perjalanan Umur Panjang Anda →</p>
    </div>
  )
}
