...
const idleClass = 'border-transparent bg-transparent text-white/60 hover:border-white/[.09] hover:bg-white/[.045] hover:text-white'
...
export function PanaceaZoneNav() {
  ...
  return (
    <nav className="relative flex min-h-[58px] items-center gap-2 rounded-[20px] border border-white/[.085] bg-[#01040a]/88 px-2 py-1.5 shadow-[0_16px_46px_rgba(0,0,0,.25)] backdrop-blur-2xl sm:min-h-[64px] sm:gap-3 sm:rounded-[22px] sm:px-3" aria-label="Panacea super pages">
      <NavLink to="/" end className="flex h-11 shrink-0 items-center gap-2 rounded-[15px] px-1.5 text-white transition hover:bg-white/[.04] sm:px-2" aria-label="Panacea Home">
        <LogoMark size={30} />
