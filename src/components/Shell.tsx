...
export function Shell({ children }: { children: ReactNode }) {
  ...
  // Command bar may step out of the way while reading. Assistive Touch stays
  // mounted independently, so global actions never disappear with the chrome.
  const keadaanBilah = useCommandBar(bilahAtas)

  // Route changes close only the compact command dropdown; there is no sidebar.
