...
const nav: Nav[] = [
  ...
  { to: '/first-aid', label: 'First Aid Quick Guide', icon: IconShield, roles: ['pasien', 'dokter', 'owner'], group: 'Health' },
  { to: '/vaccine-tracker', label: 'Vaccine / Immunization Tracker', icon: IconShield, roles: ['pasien', 'dokter', 'owner'], group: 'Health' },
  { to: '/blood-donation', label: 'Blood Donation Eligibility', icon: IconHeart, roles: ['pasien', 'dokter', 'owner'], group: 'Health' },
  { to: '/visit-prep', label: 'Doctor-Visit Prep Checklist', icon: IconStethoscope, roles: ['pasien', 'dokter', 'owner'], group: 'Health' },
  { to: '/posture-breaks', label: 'Posture & Desk-Break Reminder', icon: IconActivity, roles: ['pasien', 'dokter', 'owner'], group: 'Health' },
  { to: '/pain-diary', label: 'Pain / Symptom Diary', icon: IconActivity, roles: ['pasien', 'dokter', 'owner'], group: 'Health' },
  { to: '/organ-donor', label: 'Organ Donor Pledge', icon: IconHeart, roles: ['pasien', 'dokter', 'owner'], group: 'Health' },
  ...
  { to: '/findrisc', label: 'Diabetes Risk (FINDRISC)', icon: IconActivity, roles: ['pasien', 'dokter', 'owner'], group: 'Calculators & Labs' },
  ...
  { to: '/padua-score', label: 'Padua Score (VTE)', icon: IconActivity, roles: ['pasien', 'dokter', 'owner'], group: 'Calculators & Labs' },
  { to: '/rockall-score', label: 'Rockall Score', icon: IconActivity, roles: ['pasien', 'dokter', 'owner'], group: 'Calculators & Labs' },
  { to: '/charlson-index', label: 'Charlson Index', icon: IconActivity, roles: ['pasien', 'dokter', 'owner'], group: 'Calculators & Labs' },
