  ...
  return (
    <div className="space-y-2">
      <Panel
        ...
        awal={PUSHUP_ATAS}
        akhir={PUSHUP_BAWAH}
        labelAwal="Atas — badan satu garis"
        labelAkhir="Bawah — dada dekat lantai"
        garisBantu={{ a: [14, 106], b: [126, 82], teks: 'telinga → tumit satu garis' }}
        kunci="Siku sekitar 45° dari badan, bukan mengembang 90°. Siku yang mengembang membebani sendi bahu, bukan dada — dan itu sebab tersering nyeri bahu pada push-up."
      />
      <Panel
        judul="Sit-up"
        awal={SITUP_BAWAH}
        akhir={SITUP_ATAS}
        labelAwal="Bawah — punggung menempel"
        labelAkhir="Atas — bahu terangkat"
        garisBantu={{ a: [62, 58], b: [92, 100], teks: 'leher rileks, dagu tidak ditarik' }}
        kunci="Angkat sampai tulang belikat lepas dari lantai, dan biarkan leher rileks. Menarik kepala dengan tangan memindahkan kerja dari perut ke leher."
      />
      <Panel
        judul="Pull-up"
        awal={PULLUP_BAWAH}
        akhir={PULLUP_ATAS}
        labelAwal="Bawah — gantung aktif"
        labelAkhir="Atas — dagu melewati palang"
        garisBantu={{ a: [40, 26], b: [120, 26], teks: 'palang' }}
        kunci="Bahu ditarik turun menjauhi telinga SEBELUM menarik. Menggantung pasif lalu menyentak adalah cara paling cepat mencederai siku."
      />
      <Panel
        judul="Burpee"
        awal={BURPEE_JONGKOK}
        akhir={BURPEE_PAPAN}
        labelAwal="Jongkok — tangan di lantai"
        labelAkhir="Papan — pinggul tidak melorot"
        garisBantu={{ a: [14, 108], b: [126, 58], teks: 'pinggul sejajar bahu' }}
        kunci="Pinggul tidak melorot saat kaki dilempar ke belakang. Punggung yang melengkung di posisi papan adalah tempat cedera punggung bawah pada burpee terjadi."
      />
      <Panel
        judul="Jumping jack"
        awal={JJ_TUTUP}
        akhir={JJ_BUKA}
        labelAwal="Tutup — kaki rapat"
        labelAkhir="Buka — tangan dan kaki keluar"
        kunci="Mendarat dengan lutut sedikit menekuk dan kaki depan lebih dahulu. Mendarat dengan lutut terkunci meneruskan seluruh benturan ke lutut dan punggung."
      />
      <p className="px-1 text-[10.5px] leading-relaxed text-neutral-500">
        Semua gambar di atas digambar sendiri sebagai SVG di dalam aplikasi ini — tidak diunduh, tidak disalin, dan
        tidak dibangkitkan mesin gambar. Pada halaman yang mengajarkan teknik, gambar yang posisi sendinya keliru
        mengajarkan gerakan yang salah kepada orang yang datang untuk belajar.
      </p>
    </div>
  )
