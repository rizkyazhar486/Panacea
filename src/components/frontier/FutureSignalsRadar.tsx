...
const SIGNALS: FutureSignal[] = [
  ...
  },
  {
    ...
    maturity: 66,
    healthRelevance: 81,
    summary: 'FDA maintains a public inventory of completed consultations for foods made with cultured animal cells, showing that cell-cultured food has moved beyond a purely speculative concept.',
