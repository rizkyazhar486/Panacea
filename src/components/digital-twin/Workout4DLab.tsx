  ...
  if (!workouts.length) {
    return (
      <section className="rounded-[30px] border border-white/10 bg-[#030914] p-6 text-white">
        ...
        <div className="mt-5 flex items-center gap-3 rounded-2xl border border-emerald-300/12 bg-emerald-300/[.05] p-4 text-xs text-white/55"><IconRun size={18} className="text-emerald-300" /> Health Auto Export workouts already supported by Panacea can drive this experience automatically.</div>
      </section>
    )
  }
