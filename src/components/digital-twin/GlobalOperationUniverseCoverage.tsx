    ...
    <section className="border-t border-white/8 bg-[#040a12] p-5 sm:p-6" aria-label="Global operation universe coverage">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div className="max-w-3xl">
          ...
          <Prosa kelas="mt-1 text-[10px] leading-relaxed text-white/38">The universe is organized by procedure families so Panacea can keep expanding without pretending every operation already has validated detailed anatomy. Each detailed procedure still uses the same simulation kernel.</Prosa>
        </div>
