...
const BAR: Record<Achievement['tone'], string> = { red: '#e5342f', green: '#2fae4e', gold: '#caa33d', black: '#9a9a9a' }
const LABEL: Record<Achievement['tone'], string> = { red: 'Blood & Oxygen', green: 'Nature', gold: 'Wealth', black: 'Out of the Dark' }
    ...
    <div className="metal-forge pointer-events-auto relative w-full max-w-sm overflow-hidden rounded-2xl px-4 py-3 shadow-2xl">
      ...
      <div className="relative pl-3">
        <div className="flex items-center gap-2">
          <span className="metal-tag metal-gold">Unlocked</span>
          <span className="text-[10px] font-bold uppercase tracking-wide text-white/40">{LABEL[a.tone]}</span>
        </div>
        <div className="mt-1 text-sm font-black text-white">{a.title}</div>
