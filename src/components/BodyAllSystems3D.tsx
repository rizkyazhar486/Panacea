...
export default function BodyAllSystems3D() {
  ...
  return (
    <section className="relative left-1/2 w-[calc(100vw-1.5rem)] -translate-x-1/2 rounded-2xl border border-emerald-200 bg-emerald-50/50 p-3 dark:border-emerald-300/20 dark:bg-emerald-300/[.04] md:static md:w-auto md:translate-x-0" aria-label="All body systems source-backed 3D">
