      ...
      <div className="grid grid-cols-4 gap-2" aria-label="Quick actions">
        {ACTIONS.map((action) => (
          <Link
            key={action.to}
            to={action.to}
            className="dark group flex min-h-[58px] flex-col items-center justify-center gap-1 rounded-[16px] border border-brand bg-black px-2 text-center text-white transition hover:bg-brand hover:text-black active:scale-[.97] active:bg-brand active:text-black focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand"
          >
