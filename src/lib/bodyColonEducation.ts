...
export const COLON_EDUCATION_NODES: readonly ColonEducationNode[] = [
  ...
  { id: 'colon-function-context', label: 'Colon physiology context', kind: 'physiology', evidenceState: 'educational-only', boundary: 'Educational physiology placeholder only; no motility, transit time, absorption rate, secretion, microbiome state, intraluminal pressure, measured reserve, or person-level bowel function is inferred.' },
  { id: 'colon-disorder-context', label: 'Colon pathophysiology context', kind: 'pathophysiology', evidenceState: 'educational-only', boundary: 'Mechanism placeholder only; does not diagnose inflammatory bowel disease, diverticular disease, obstruction, ischemia, infection, polyps, malignancy, bleeding, dysmotility, or any other colonic condition.' },
  { id: 'colon-drug-context', label: 'Colon pharmacology context', kind: 'pharmacology', evidenceState: 'educational-only', boundary: 'Pharmacology placeholder only; no drug selection, bowel regimen, anti-inflammatory therapy, antimicrobial therapy, oncology regimen, dose, duration, contraindication, interaction, monitoring plan, or treatment recommendation is provided.' },
  { id: 'colon-imaging-context', label: 'Colon imaging context', kind: 'imaging', evidenceState: 'educational-only', boundary: 'Imaging placeholder only; no CT, MRI, radiograph, ultrasound, endoscopy, PET, segmentation, wall thickness, enhancement, mass, obstruction, bleeding source, procedure target, or patient-specific interpretation is represented.' },
] as const
export const COLON_EDUCATION_EDGES: readonly ColonEducationEdge[] = [
  { from: 'colon-anatomy-context', to: 'colon-function-context', relationship: 'educational-context', note: 'General colonic orientation may anchor physiology education without implying source-backed wall microanatomy, transit measurements, motility patterns, absorption, secretion, microbiome composition, or measured function.' },
  { from: 'colon-function-context', to: 'colon-disorder-context', relationship: 'supports', note: 'General physiology concepts can contextualize mechanism education, but this relationship carries no diagnosis, disease probability, inflammatory state, obstruction severity, prognosis, or patient-level inference.' },
  { from: 'colon-disorder-context', to: 'colon-imaging-context', relationship: 'educational-context', note: 'Pathophysiology and imaging may be studied together only as bounded education; no wall thickening, mass, obstruction, inflammation, bleeding source, staging conclusion, lesion location, or procedural target is generated.' },
  { from: 'colon-disorder-context', to: 'colon-drug-context', relationship: 'educational-context', note: 'Disease-mechanism education may link to pharmacology education without selecting bowel medication, anti-inflammatory therapy, antimicrobial therapy, oncology treatment, dose, monitoring, or patient-specific action.' },
] as const
