 ...
 * They are not geometry licenses, patient data, validation certificates, or human review.
 */
export const ORGAN_EDUCATION_REFERENCES: readonly OrganEvidenceReference[] = [
  {
    id: 'ncbi-renal-physiology-2023',
  ...
  {
    id: 'ncbi-lung-physiology-2023',
    title: 'Physiology, Lung',
    url: 'https://www.ncbi.nlm.nih.gov/books/NBK545177/',
    publisher: 'NCBI Bookshelf / StatPearls',
    checkedOn: '2026-09-20',
  },
  {
    id: 'ncbi-liver-physiology-2023',
    title: 'Physiology, Liver',
    url: 'https://www.ncbi.nlm.nih.gov/books/NBK535438/',
    publisher: 'NCBI Bookshelf / StatPearls',
    checkedOn: '2026-09-20',
  },
] as const
...
export const ORGAN_EDUCATION_RELATIONSHIPS: readonly OrganEducationRelationship[] = [
  {
    id: 'kidney-glomerulus-filtration',
    domainId: 'renal-urinary',
    organ: 'kidney',
    from: 'glomerular capillary tuft',
    to: 'Bowman space',
    scale: 'tissue',
    projections: ['anatomy', 'physiology'],
    teachingRelationship: 'The glomerular filtration barrier links capillary blood to Bowman space; hydrostatic and oncotic forces contribute to filtration across this interface.',
    evidenceIds: ['ncbi-renal-physiology-2023'],
    evidenceState: 'source-checked',
    boundary,
  },
  {
    id: 'lung-alveolus-capillary-gas-exchange',
    ...
    scale: 'tissue',
    projections: ['anatomy', 'physiology'],
    teachingRelationship: 'The alveolar-capillary interface is the principal lung site for oxygen and carbon-dioxide exchange between inspired gas and pulmonary blood.',
    evidenceIds: ['ncbi-lung-physiology-2023'],
    evidenceState: 'source-checked',
    boundary,
  },
  {
    id: 'liver-dual-inflow-sinusoid',
    domainId: 'digestive-hepatobiliary',
    organ: 'liver',
    from: 'portal vein and hepatic artery branches',
    to: 'hepatic sinusoids',
    scale: 'tissue',
    projections: ['anatomy', 'physiology'],
    teachingRelationship: 'Portal venous and hepatic arterial inflow converge within the hepatic microcirculation, supporting a dual-inflow teaching model without implying patient-specific perfusion.',
    evidenceIds: ['ncbi-liver-physiology-2023'],
    evidenceState: 'source-checked',
    boundary,
  },
] as const
