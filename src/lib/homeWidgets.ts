...
export const WIDGETS: WidgetDef[] = [
  { id: 'pelatih', label: 'Training Coach', ringkas: 'Next session, a summary of the last one, and your freshness status', ke: '/riwayat-latihan', emoji: '🏃', bawaan: true },
  ...
  { id: 'latihanTerpandu', label: 'Guided Workout', ringkas: 'Guided sessions with movement-form video', ke: '/workout', emoji: '🏋️' },
