...
//
// BAWAANNYA SENGAJA SEDIKIT, dan pernah tidak demikian. Pada satu titik 73 dari
// 244 kartu menyala secara bawaan, sehingga beranda seorang pemakai baru adalah
// dinding sepanjang belasan layar — dan dinding tidak dibaca, ia digulir
// melewati. Sekarang 18 yang menyala, dipilih dengan satu aturan: kartu yang
// menjawab pertanyaannya lewat ANGKA ATAU BENTUK, bukan lewat paragraf.
//
// Yang dimatikan TIDAK dihapus. Seluruh 244 tetap ada di pemilih widget dan
// tinggal dinyalakan; yang berubah hanya apa yang dilihat orang sebelum ia
// memilih apa pun. Dan pemakai yang sudah pernah menyusun berandanya sendiri
// tidak terpengaruh sama sekali — susunannya tersimpan, dan bawaan hanya
// dipakai ketika belum ada yang tersimpan.
//
...
export const WIDGETS: WidgetDef[] = [
  ...
  { id: 'pelatih', label: 'Training Coach', ringkas: 'Your next session and current form', ke: '/riwayat-latihan', emoji: '🏃', kategori: 'Training' },
  ...
  { id: 'tubuh', label: 'Body Hub', ringkas: 'Body numbers and their reference ranges', ke: '/tubuh', emoji: '🫁', kategori: 'Body & Data' },
  ...
  { id: 'amsler', label: 'Amsler Grid', ringkas: 'Central-vision self-monitoring', ke: '/tubuh', emoji: '👁️', kategori: 'Clinical & Learning' },
  { id: 'layar', label: 'Focus Sessions Logged', ringkas: 'Focused minutes today and this week', ke: '/harian', emoji: '🖥️', kategori: 'Body & Data' },
  { id: 'tekananSebar', label: 'Blood Pressure Spread', ringkas: 'Mean and range across readings', ke: '/tubuh', emoji: '📉', kategori: 'Body & Data' },
  { id: 'rangkaian', label: 'Habit Streaks', ringkas: 'Days in a row, with no punishment', ke: '/harian', emoji: '🔗', kategori: 'Body & Data' },
  { id: 'jetlag', label: 'Jet Lag', ringkas: 'Shift your sleep before you fly', ke: '/harian', emoji: '✈️', kategori: 'Sleep & Recovery' },
  ...
  { id: 'rekomposisi', label: 'Recomposition Programme', ringkas: 'Build, cut, maintain — with the numbers for each', ke: '/recomposition', emoji: '🎯', kategori: 'Training' },
  ...
  { id: 'saturasi', label: 'Oxygen Saturation', ringkas: 'Overnight SpO₂', ke: '/tubuh', emoji: '🩸', kategori: 'Body & Data' },
  ...
  { id: 'napas', label: '2-Minute Breathing', ringkas: 'A guided breathing pattern', ke: '/harian', emoji: '🌬️', kategori: 'Body & Data' },
  ...
  { id: 'motivasi', label: 'This Week', ringkas: 'Days in a row and training minutes', ke: '/harian', emoji: '🔥', kategori: 'Body & Data' },
  ...
  { id: 'nutrisi', label: 'Nutrition', ringkas: 'Today\'s intake', ke: '/nutrition', emoji: '🥗', kategori: 'Nutrition' },
...
export const WIDGET_HIDUP = [
  // ── Ringkasan hari ini ──────────────────────────────────────────────────
  'ringHarian', 'pantauan', 'kebugaran', 'salat', 'konsistensi', 'motivasi',
  // ── Tidur & pemulihan ───────────────────────────────────────────────────
