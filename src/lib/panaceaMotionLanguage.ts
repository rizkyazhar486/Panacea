...
/**
 * Original Panacea motion language.
 *
 * These are implementation tokens, not copied presets/prompts/assets from an
 * external motion library. The vocabulary is intentionally generic: reveal,
 * glass-like focus, kinetic type, exploded assembly, and quiet/soft motion.
 */
export const PANACEA_MOTION: Record<PanaceaMotionVariant, PanaceaMotionPreset> = {
  rise: {
    durationMs: 620,
    easing: 'cubic-bezier(0.16, 1, 0.3, 1)',
    hiddenTransform: 'translate3d(0, 22px, 0) scale(0.985)',
  ...
  glass: {
    durationMs: 760,
    easing: 'cubic-bezier(0.16, 1, 0.3, 1)',
    hiddenTransform: 'translate3d(0, 14px, 0) scale(0.97)',
    hiddenFilter: 'blur(10px) saturate(0.82)',
    hiddenOpacity: 0,
  },
  kinetic: {
    durationMs: 540,
    easing: 'cubic-bezier(0.2, 0.85, 0.25, 1)',
    hiddenTransform: 'translate3d(-18px, 0, 0) skewX(-2deg)',
    hiddenFilter: 'blur(1px)',
    hiddenOpacity: 0,
  },
  explode: {
    durationMs: 820,
    easing: 'cubic-bezier(0.22, 1, 0.36, 1)',
    hiddenTransform: 'translate3d(0, 28px, 0) scale(0.92)',
    hiddenFilter: 'blur(4px)',
    hiddenOpacity: 0,
  },
  soft: {
    durationMs: 420,
    easing: 'ease-out',
    hiddenTransform: 'translate3d(0, 8px, 0)',
    hiddenFilter: 'none',
    hiddenOpacity: 0,
  },
}
