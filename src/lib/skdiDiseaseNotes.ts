...
export const SKDI_DISEASE_NOTES: Record<string, SkdiDiseaseNote> = {
  ...
  'Influenza': {
    definisi:
      'Penyakit infeksi akut saluran napas yang disebabkan oleh virus influenza A atau B, ditandai awitan demam yang MENDADAK disertai gejala sistemik yang menonjol berupa mialgia, nyeri kepala, dan rasa lemas hebat, bersamaan dengan gejala saluran napas berupa batuk kering dan nyeri tenggorokan. Umumnya sembuh sendiri dalam 5-7 hari, namun dapat menimbulkan komplikasi berat bahkan kematian pada kelompok risiko tinggi.',
    anamnesis: {
      keluhanUtama:
        'Demam tinggi yang timbul mendadak sejak dua hari lalu disertai nyeri seluruh badan, nyeri kepala, dan batuk kering.',
      riwayatPenyakitSekarang:
        'Telusuri dengan SOCRATES. Site: gejala sistemik menyeluruh — nyeri otot terutama pada punggung dan tungkai, nyeri kepala di daerah frontal dan retro-orbital, disertai gejala lokal pada tenggorokan dan dada. Onset: MENDADAK dan dapat ditunjuk waktunya oleh pasien ("tadi siang saya masih sehat, sore langsung menggigil") — awitan abrupt ini merupakan ciri pembeda paling berguna terhadap selesma biasa yang gejalanya muncul bertahap selama beberapa hari. Character: demam tinggi disertai menggigil, badan terasa remuk, batuk KERING dan tidak produktif, nyeri tenggorokan, hidung tersumbat atau berair yang biasanya ringan. Radiation: nyeri otot menyebar ke seluruh tubuh. Associations: rasa lemas yang sangat menonjol hingga pasien hanya ingin berbaring, nafsu makan hilang, mata terasa perih dan silau; pada anak dapat disertai mual, muntah, dan diare. WAJIB tanyakan TANDA BAHAYA: sesak napas, napas cepat, nyeri dada, batuk berdahak kental atau berdarah, kebiruan pada bibir, penurunan kesadaran atau kebingungan, kejang, tidak mampu minum, serta demam yang membaik lalu MEMBURUK KEMBALI yang merupakan petunjuk klasik infeksi bakteri sekunder. Time course: demam berlangsung 3-5 hari dan gejala umumnya membaik dalam 5-7 hari, sedangkan batuk dan rasa lemas dapat bertahan hingga 2 minggu. Exacerbating dan relieving: tidak khas. Severity: nilai kemampuan makan-minum, produksi urin, dan apakah pasien mampu menjalankan aktivitas sehari-hari. Tanyakan pula KONTAK dengan orang serumah atau rekan kerja yang bergejala serupa, riwayat perjalanan, dan kontak dengan unggas sakit atau mati mendadak yang mengarahkan pada kecurigaan flu burung.',
      riwayatPenyakitDahulu:
        'Penyakit penyerta yang menentukan risiko komplikasi: ASMA dan penyakit paru obstruktif kronik, penyakit jantung, diabetes melitus, penyakit ginjal kronik, penyakit hati kronik, obesitas, gangguan neurologis yang mengganggu pembersihan jalan napas, keganasan, HIV, serta kondisi imunokompromais lain termasuk penggunaan kortikosteroid jangka panjang. Tanyakan pula riwayat rawat inap karena infeksi paru sebelumnya.',
      riwayatPenyakitKeluarga:
    ...
    pemeriksaanFisik: [
      'Tanda vital LENGKAP: suhu (umumnya 38-40 derajat Celsius), frekuensi napas, frekuensi nadi, tekanan darah, dan SATURASI OKSIGEN — saturasi merupakan penanda paling praktis untuk memisahkan influenza tanpa komplikasi dari pneumonia',
      'Keadaan umum dan tingkat kesadaran; pasien tampak lemah namun pada kasus tanpa komplikasi tetap kompos mentis',
      'Status hidrasi: turgor kulit, kelembapan mukosa, waktu pengisian kapiler, dan produksi urin',
      'Wajah tampak kemerahan (flushed), mata merah dan berair dengan konjungtiva hiperemis ringan',
      'Faring hiperemis TANPA eksudat — adanya eksudat, tonsil membesar dengan detritus, dan pembesaran kelenjar leher anterior lebih mengarah ke faringitis streptokokus',
      'Pemeriksaan hidung: mukosa hiperemis dengan sekret serosa; nyeri tekan sinus bila ada komplikasi sinusitis',
      'PEMERIKSAAN TORAKS lengkap: inspeksi untuk retraksi dan penggunaan otot bantu napas, palpasi fremitus, perkusi, dan AUSKULTASI — pada influenza tanpa komplikasi suara napas VESIKULER NORMAL tanpa ronki; adanya ronki basah halus, suara napas bronkial, atau perkusi redup menandakan PNEUMONIA',
      'Hitung frekuensi napas selama satu menit penuh, terutama pada anak — takipnea adalah tanda pneumonia paling sensitif di layanan primer',
      'Pemeriksaan jantung untuk menilai takikardia yang tidak sebanding dengan demam, irama, dan tanda gagal jantung',
      'Pemeriksaan kelenjar getah bening leher dan pemeriksaan kulit untuk ruam',
      'Pada anak: nilai tanda bahaya umum — tidak mau minum, muntah setiap kali diberi minum, kejang, letargi, napas cepat sesuai batas usia, tarikan dinding dada bagian bawah ke dalam, dan stridor saat tenang',
    ],
    penunjang: [
      'Diagnosis umumnya KLINIS — pada musim dengan aktivitas influenza tinggi, kombinasi demam mendadak dan batuk memiliki nilai prediksi yang cukup baik sehingga konfirmasi laboratorium tidak selalu diperlukan',
      'Rapid influenza diagnostic test (RIDT) berbasis deteksi antigen: hasil cepat namun SENSITIVITASNYA RENDAH sekitar 50-70%, sehingga HASIL NEGATIF TIDAK MENYINGKIRKAN diagnosis dan tidak boleh menunda pemberian antivirus pada pasien risiko tinggi',
      'RT-PCR merupakan pemeriksaan paling sensitif dan spesifik, sekaligus dapat menentukan subtipe virus; diindikasikan pada pasien rawat inap, pasien berat, imunokompromais, dan penyelidikan wabah',
      'Darah lengkap: leukosit umumnya normal atau menurun dengan limfositosis relatif; LEUKOSITOSIS dengan pergeseran ke kiri justru mengarahkan pada infeksi bakteri sekunder',
      'C-reactive protein dan prokalsitonin membantu membedakan infeksi virus dari bakteri bila tersedia dan diagnosis meragukan',
      'FOTO TORAKS diindikasikan bila terdapat sesak, saturasi menurun, ronki, atau demam yang tidak membaik setelah 5 hari — untuk mendeteksi pneumonia virus maupun pneumonia bakteri sekunder',
      'Analisis gas darah, elektrolit, ureum, kreatinin, dan fungsi hati pada kasus berat yang dirawat',
      'Kultur darah dan kultur sputum bila dicurigai pneumonia bakteri sekunder atau sepsis',
      'Pemeriksaan khusus untuk influenza A subtipe H5N1 bila terdapat riwayat kontak unggas sakit — kasus ini wajib dilaporkan sebagai bagian dari surveilans',
    ],
    etiologi:
      'Virus influenza, famili Orthomyxoviridae, virus RNA berantai negatif dan bersegmen. Influenza A merupakan penyebab wabah dan pandemi, disubtipe berdasarkan glikoprotein permukaan hemaglutinin (H) dan neuraminidase (N) — galur yang bersirkulasi pada manusia terutama H1N1 dan H3N2. Influenza B umumnya menimbulkan penyakit yang lebih ringan namun dapat berat pada anak. Influenza C menyebabkan penyakit ringan dan jarang bermakna klinis.',
    patofisiologi:
      'Virus ditularkan melalui droplet pernapasan, dan lebih jarang melalui kontak dengan permukaan terkontaminasi. Hemaglutinin virus berikatan dengan reseptor asam sialat pada sel epitel silindris bersilia saluran napas, virus masuk secara endositosis, bereplikasi, lalu dilepaskan dengan bantuan neuraminidase yang memutus ikatan asam sialat sehingga virus baru dapat menyebar ke sel di sekitarnya — enzim inilah yang menjadi sasaran obat oseltamivir dan zanamivir, dan hal itu menjelaskan mengapa antivirus hanya bermanfaat bila diberikan DINI dalam 48 jam saat replikasi virus masih berlangsung aktif; pemberian setelah puncak replikasi terlewat memberi manfaat yang jauh berkurang. Replikasi virus menimbulkan nekrosis dan deskuamasi epitel bersilia, yang menghancurkan tangga berjalan mukosiliar sebagai pertahanan mekanik utama saluran napas. Kerusakan ini membuka jalan bagi kolonisasi dan invasi bakteri — terutama Streptococcus pneumoniae, Staphylococcus aureus, dan Haemophilus influenzae — sehingga terjadi PNEUMONIA BAKTERI SEKUNDER yang khas muncul sebagai perburukan setelah pasien sempat membaik pada hari kelima hingga ketujuh; pola demam bifasik inilah yang harus selalu ditanyakan saat pasien kontrol. Gejala sistemik berupa demam tinggi, mialgia, dan rasa lemas hebat tidak disebabkan oleh kerusakan otot langsung melainkan oleh badai SITOKIN PROINFLAMASI (interleukin-6, TNF-alfa, interferon) yang dilepaskan sebagai respons imun — inilah sebabnya gejala sistemik influenza jauh lebih berat daripada selesma biasa meski keduanya sama-sama infeksi virus saluran napas. Sifat genom yang bersegmen memungkinkan terjadinya ANTIGENIC DRIFT berupa mutasi titik yang bertahap sehingga vaksin harus diperbarui setiap tahun, dan ANTIGENIC SHIFT berupa pertukaran segmen genom antar galur yang dapat melahirkan virus baru dengan potensi pandemi karena populasi belum memiliki kekebalan sama sekali.',
    faktorRisiko: [
      'Usia ekstrem: anak kurang dari 5 tahun (terutama kurang dari 2 tahun) dan lansia 65 tahun ke atas',
      'KEHAMILAN, terutama trimester kedua dan ketiga, serta 2 minggu pascapersalinan',
      'Penyakit paru kronik: asma, penyakit paru obstruktif kronik, bronkiektasis',
      'Penyakit jantung kronik, diabetes melitus, penyakit ginjal kronik, penyakit hati kronik',
      'Obesitas dengan indeks massa tubuh 40 atau lebih',
      'Imunokompromais: HIV, keganasan, kemoterapi, kortikosteroid jangka panjang, pascatransplantasi',
      'Gangguan neurologis yang mengganggu refleks batuk dan pembersihan sekret',
      'Penghuni panti jompo dan fasilitas perawatan jangka panjang',
      'Tenaga kesehatan dan pekerja di lingkungan padat',
      'Anak yang mendapat terapi aspirin jangka panjang (risiko sindrom Reye)',
      'Merokok dan paparan asap rokok',
    ],
    goldStandard:
      'Baku emas konfirmasi etiologi adalah RT-PCR terhadap spesimen usap nasofaring atau orofaring, yang memiliki sensitivitas dan spesifisitas tertinggi sekaligus mampu menentukan tipe dan subtipe virus. Namun dalam praktik layanan primer, diagnosis ditegakkan secara KLINIS berdasarkan awitan demam yang mendadak disertai batuk dan gejala sistemik menonjol pada musim dengan aktivitas influenza yang tinggi atau adanya kontak dengan kasus serupa. Penting dipahami bahwa hasil negatif pada rapid test TIDAK menyingkirkan influenza karena sensitivitasnya rendah, sehingga pada pasien risiko tinggi antivirus tetap diberikan atas dasar klinis tanpa menunggu hasil laboratorium.',
    diagnosisBanding: [
      'Selesma biasa (common cold) — awitan BERTAHAP, demam ringan atau tidak ada, gejala didominasi hidung tersumbat dan bersin, gejala sistemik ringan, pasien masih dapat beraktivitas',
      'COVID-19 — gambaran sangat mirip; adanya anosmia atau ageusia lebih mengarah ke COVID-19, konfirmasi memerlukan pemeriksaan antigen atau PCR SARS-CoV-2',
      'Demam dengue — demam tinggi mendadak dengan mialgia dan nyeri retro-orbital yang mirip, namun disertai nyeri sendi hebat, ruam, uji torniket positif, LEUKOPENIA dengan TROMBOSITOPENIA dan peningkatan hematokrit; membedakan keduanya sangat penting di daerah endemis karena pemberian NSAID pada dengue berbahaya',
      'Pneumonia komunitas — sesak, takipnea, ronki, dan konsolidasi pada foto toraks',
      'Faringitis streptokokus — nyeri tenggorokan menonjol dengan eksudat tonsil dan pembesaran kelenjar leher, TANPA batuk',
      'Demam tifoid — demam yang naik bertahap dan memuncak pada minggu kedua, disertai gangguan saluran cerna dan bradikardia relatif',
      'Malaria pada pasien dengan riwayat perjalanan ke daerah endemis — demam periodik dengan menggigil dan berkeringat',
      'Leptospirosis — riwayat kontak dengan air banjir, disertai nyeri betis, ikterik, dan konjungtiva suffusion',
    ],
    pengkajian:
      'Dipikirkan influenza pada pasien ini atas dasar demam tinggi yang timbul MENDADAK sehingga pasien dapat menunjuk dengan tepat kapan sakitnya dimulai, disertai gejala sistemik yang sangat menonjol berupa mialgia menyeluruh, nyeri kepala, dan rasa lemas hebat yang tidak sebanding dengan ringannya gejala hidung, bersamaan dengan batuk kering dan nyeri tenggorokan, pada latar adanya kontak dengan orang serumah atau rekan kerja yang mengalami keluhan serupa. Pada pemeriksaan fisik ditemukan faring hiperemis tanpa eksudat dengan auskultasi paru yang vesikuler normal tanpa ronki, frekuensi napas dalam batas normal, dan saturasi oksigen yang baik, sehingga saat ini belum terdapat tanda komplikasi pneumonia. Selesma biasa menjadi pembanding terdekat karena sama-sama merupakan infeksi virus saluran napas atas, namun pada selesma gejala muncul BERTAHAP selama beberapa hari, demam ringan atau tidak ada sama sekali, keluhan didominasi hidung tersumbat dan bersin, serta pasien tetap mampu beraktivitas — sangat berbeda dengan pasien ini yang tersungkur oleh gejala sistemik. Demam dengue merupakan pembanding yang wajib dipikirkan di daerah endemis karena sama-sama menimbulkan demam tinggi mendadak dengan mialgia dan nyeri kepala, namun pada dengue umumnya menonjol nyeri sendi hebat, nyeri retro-orbital, ruam, dan uji torniket positif, dengan gambaran laboratorium berupa leukopenia disertai trombositopenia serta peningkatan hematokrit; pembedaan ini bukan sekadar akademis sebab pemberian NSAID yang lazim untuk mialgia influenza justru berbahaya pada dengue karena meningkatkan risiko perdarahan. COVID-19 memiliki gambaran yang hampir tidak dapat dibedakan secara klinis sehingga pemeriksaan antigen atau PCR SARS-CoV-2 perlu dipertimbangkan sesuai situasi epidemiologi setempat. Yang menentukan keluaran pasien ini adalah pengenalan dini PERBURUKAN: pasien dan keluarga harus memahami bahwa influenza yang sedang membaik lalu MENDADAK MEMBURUK KEMBALI pada hari kelima hingga ketujuh dengan demam yang naik lagi dan dahak berubah menjadi kental merupakan pola khas pneumonia bakteri sekunder, komplikasi tersering sekaligus penyebab kematian utama pada influenza. Selain itu perlu dinilai apakah pasien termasuk kelompok risiko tinggi — usia lanjut, kehamilan, penyakit paru atau jantung kronik, diabetes, obesitas, atau imunokompromais — sebab pada kelompok ini oseltamivir diberikan segera atas dasar klinis tanpa menunggu konfirmasi laboratorium, karena menunda pemberian sampai hasil keluar berarti melewatkan jendela 48 jam ketika obat masih bermanfaat.',
    terapiSuportif: [
      'ISTIRAHAT cukup di rumah selama masa demam dan sampai bebas demam minimal 24 jam tanpa antipiretik',
      'HIDRASI adekuat: minum air, larutan oralit, sup hangat, atau jus; target produksi urin yang jernih dan cukup',
      'Antipiretik dan analgesik: parasetamol 500-1000 mg tiap 6-8 jam pada dewasa (maksimal 4 g per hari), atau 10-15 mg/kgBB per kali tiap 4-6 jam pada anak',
      'JANGAN memberikan ASPIRIN pada anak dan remaja dengan penyakit demam virus karena risiko SINDROM REYE berupa ensefalopati dan gagal hati akut',
      'Berkumur air garam hangat dan minuman hangat untuk meredakan nyeri tenggorokan',
      'Uap air hangat atau tetes hidung salin untuk hidung tersumbat',
      'Madu dapat meredakan batuk pada anak di atas 1 tahun — TIDAK boleh diberikan pada bayi kurang dari 1 tahun karena risiko botulisme',
      'Nutrisi berupa makanan lunak porsi kecil namun sering; tidak ada pantangan makanan khusus',
      'Hindari asap rokok dan berhenti merokok',
    ],
    tatalaksana: [
      'Sebagian besar kasus pada individu SEHAT bersifat SELF-LIMITING dan cukup ditangani dengan terapi suportif tanpa antivirus',
      'OSELTAMIVIR merupakan antivirus pilihan dan paling bermanfaat bila dimulai dalam 48 JAM PERTAMA sejak awitan gejala — memperpendek durasi sakit sekitar 1 hari dan menurunkan risiko komplikasi pada kelompok risiko tinggi',
      'Dosis oseltamivir dewasa: 75 mg dua kali sehari per oral selama 5 hari',
      'Dosis oseltamivir anak berdasarkan berat badan, dua kali sehari selama 5 hari — berat 15 kg atau kurang: 30 mg; berat lebih dari 15 sampai 23 kg: 45 mg; lebih dari 23 sampai 40 kg: 60 mg; lebih dari 40 kg: 75 mg',
      'Dosis pada bayi kurang dari 1 tahun: 3 mg/kgBB dua kali sehari selama 5 hari',
      'Penyesuaian dosis oseltamivir diperlukan pada gangguan fungsi ginjal dengan klirens kreatinin kurang dari 60 mL/menit',
      'INDIKASI antivirus tanpa memandang lamanya gejala: pasien yang dirawat inap, penyakit berat atau progresif, serta seluruh pasien kelompok RISIKO TINGGI — usia kurang dari 5 tahun atau 65 tahun ke atas, kehamilan dan 2 minggu pascapersalinan, penyakit paru/jantung/ginjal/hati kronik, diabetes melitus, obesitas berat, imunokompromais, dan penghuni panti perawatan',
      'Pada kelompok risiko tinggi, JANGAN MENUNDA pemberian antivirus untuk menunggu hasil pemeriksaan laboratorium',
      'Efek samping oseltamivir yang perlu diinformasikan: mual dan muntah (berkurang bila diminum bersama makanan), nyeri kepala, dan pada anak jarang dilaporkan gangguan perilaku sementara',
      'Zanamivir inhalasi merupakan alternatif namun DIKONTRAINDIKASIKAN pada asma dan penyakit paru obstruktif kronik karena risiko bronkospasme',
      'ANTIBIOTIK TIDAK DIBERIKAN pada influenza tanpa komplikasi — pemberian antibiotik pada infeksi virus tidak bermanfaat dan mendorong resistensi',
      'Antibiotik diberikan HANYA bila terdapat bukti infeksi bakteri sekunder: demam yang membaik lalu naik kembali, dahak purulen, ronki dengan konsolidasi, leukositosis, atau infiltrat pada foto toraks — pilihan disesuaikan dengan panduan pneumonia komunitas, misalnya amoksisilin dosis tinggi atau amoksisilin-klavulanat',
      'RUJUK atau rawat inap bila: sesak napas atau frekuensi napas meningkat, saturasi oksigen kurang dari 95% (kurang dari 92% pada dewasa sebagai ambang lebih tegas), penurunan kesadaran, hipotensi, dehidrasi yang tidak teratasi dengan cairan oral, kejang, sianosis, tanda bahaya umum pada anak, atau perburukan klinis pada pasien risiko tinggi',
      'PROFILAKSIS pascapajanan dengan oseltamivir 75 mg sekali sehari selama 10 hari dapat dipertimbangkan pada kontak erat berisiko sangat tinggi yang belum divaksinasi, namun vaksinasi tetap menjadi strategi pencegahan utama',
      'Kasus dengan riwayat kontak unggas sakit atau mati mendadak harus segera DILAPORKAN dan dirujuk untuk penanganan kecurigaan flu burung',
    ],
    edukasi: [
      'Jelaskan bahwa penyakit ini disebabkan VIRUS sehingga ANTIBIOTIK TIDAK DIPERLUKAN dan tidak akan mempercepat kesembuhan; sebagian besar pasien pulih dalam 5-7 hari meski batuk dan rasa lemas dapat bertahan hingga 2 minggu',
      'ETIKA BATUK dan pencegahan penularan: tutup mulut dan hidung dengan lengan bagian dalam atau tisu saat batuk dan bersin, buang tisu ke tempat sampah tertutup, cuci tangan dengan sabun dan air mengalir selama 20 detik, dan gunakan MASKER bila berada di dekat orang lain',
      'ISOLASI di rumah: tidak masuk kerja atau sekolah sampai bebas demam minimal 24 jam tanpa obat penurun panas — penderita paling menular pada 1 hari sebelum hingga 5-7 hari setelah gejala muncul; jangan menjenguk bayi, ibu hamil, atau lansia selama sakit',
      'Jadwal dan porsi makan: makan porsi kecil namun sering setiap 2-3 jam berupa makanan lunak dan hangat seperti bubur atau sup; minum minimal 8 gelas air per hari atau lebih saat demam; hindari minuman beralkohol dan batasi kopi karena bersifat diuretik',
      'Jam tidur: tidur dan istirahat total selama masa demam, upayakan 8-10 jam per malam ditambah istirahat siang; posisi kepala lebih tinggi membantu bila hidung tersumbat',
      'Pola olahraga: HENTIKAN olahraga selama demam, dan mulai kembali secara BERTAHAP setelah bebas demam 24-48 jam — mulai dengan aktivitas ringan seperti jalan santai selama beberapa hari sebelum kembali ke intensitas semula; memaksakan olahraga berat saat masih sakit berisiko menimbulkan miokarditis',
      'JANGAN memberi aspirin pada anak dan remaja yang sedang demam',
      'Berhati-hati dengan obat flu kombinasi yang dijual bebas karena umumnya sudah mengandung parasetamol — meminumnya bersama parasetamol terpisah berisiko keracunan hati',
      'PENCEGAHAN utama adalah VAKSINASI INFLUENZA setiap tahun, terutama bagi lansia, ibu hamil pada usia kehamilan berapa pun, anak usia 6 bulan hingga 5 tahun, penyandang penyakit kronik, dan tenaga kesehatan; vaksin perlu diulang tiap tahun karena galur virus berubah dan kekebalan menurun',
      'Follow up: kontrol dalam 2-3 hari bila keluhan tidak membaik, atau lebih cepat bila muncul tanda bahaya',
      'SEGERA kembali bila: sesak napas atau napas terasa cepat, nyeri dada, bibir atau ujung jari kebiruan, kebingungan atau sulit dibangunkan, kejang, muntah terus-menerus sehingga tidak dapat minum, buang air kecil sangat berkurang, atau DEMAM YANG SUDAH MEMBAIK LALU NAIK KEMBALI disertai dahak kental berwarna — pola terakhir ini merupakan tanda khas infeksi bakteri sekunder',
    ],
    komplikasi: [
      'PNEUMONIA BAKTERI SEKUNDER oleh Streptococcus pneumoniae, Staphylococcus aureus, atau Haemophilus influenzae — komplikasi tersering dan penyebab kematian utama',
      'Pneumonia virus primer yang dapat berkembang cepat menjadi gagal napas dan ARDS',
      'Eksaserbasi penyakit kronik yang mendasari: serangan asma, eksaserbasi PPOK, dekompensasi gagal jantung, dan ketoasidosis diabetik',
      'Otitis media akut dan sinusitis, terutama pada anak',
      'Miokarditis dan perikarditis',
      'Miositis dan rabdomiolisis dengan risiko gagal ginjal akut',
      'Komplikasi neurologis: ensefalitis, ensefalopati, mielitis transversa, dan sindrom Guillain-Barré',
      'SINDROM REYE pada anak dan remaja yang mendapat aspirin',
      'Dehidrasi dan gangguan elektrolit',
      'Sepsis dan kegagalan multiorgan pada kasus berat',
      'Pada kehamilan: peningkatan risiko kelahiran prematur, berat lahir rendah, dan kematian ibu',
    ],
    prognosis:
      'Pada individu sehat prognosis sangat baik dengan pemulihan sempurna dalam 5-7 hari, meski batuk dan rasa lemas dapat bertahan hingga dua minggu. Prognosis memburuk secara bermakna pada kelompok risiko tinggi — lansia, ibu hamil, penyandang penyakit paru dan jantung kronik, diabetes, obesitas berat, serta imunokompromais — di mana influenza dapat berujung pada pneumonia, gagal napas, dan kematian. Dua faktor yang paling menentukan keluaran dapat dikendalikan sepenuhnya: VAKSINASI TAHUNAN yang menurunkan risiko rawat inap dan kematian, serta pemberian ANTIVIRUS DINI dalam 48 jam pada kelompok risiko tinggi. Kematian akibat influenza sebagian besar terjadi bukan karena virusnya sendiri melainkan karena pneumonia bakteri sekunder dan perburukan penyakit kronik yang mendasarinya, sehingga pengenalan dini pola perburukan menjadi bagian paling berharga dari edukasi pasien.',
    referensi: ['SKDI2012', 'IDSAFLU2018', 'PPKFKTP2014', 'MURRAY2022', 'HARRISON2022'],
  },
  ...
  'Tension headache': {
    definisi:
      'Nyeri kepala tipe tegang (tension-type headache) adalah nyeri kepala primer yang paling sering dijumpai, bersifat bilateral dengan kualitas menekan atau mengikat seperti diikat pita, intensitas ringan hingga sedang, dan tidak memberat oleh aktivitas fisik rutin. Diklasifikasikan menjadi bentuk episodik jarang (kurang dari 1 hari per bulan), episodik sering (1-14 hari per bulan), dan kronik (15 hari atau lebih per bulan selama lebih dari 3 bulan).',
    anamnesis: {
      keluhanUtama:
        'Nyeri kepala di kedua sisi terasa seperti diikat atau ditekan benda berat sejak beberapa bulan, muncul hampir setiap hari terutama menjelang sore.',
      riwayatPenyakitSekarang:
    ...
    pemeriksaanFisik: [
      ...
      'Status generalis normal; pasien tampak tidak sakit berat dan dapat berkomunikasi dengan baik',
      'NYERI TEKAN PERIKRANIAL yang meningkat pada palpasi manual otot frontalis, temporalis, masseter, sternokleidomastoideus, splenius, dan trapezius — temuan paling khas dan menjadi dasar subklasifikasi ICHD-3',
      'Pemeriksaan neurologis lengkap harus NORMAL: kesadaran, nervi kraniales termasuk funduskopi untuk menyingkirkan papiledema, motorik, sensorik, refleks fisiologis dan patologis, serta koordinasi',
      'Tidak ada tanda rangsang meningeal (kaku kuduk, Kernig, Brudzinski) — bila positif, curigai meningitis atau perdarahan subaraknoid',
      'Periksa arteri temporalis pada pasien di atas 50 tahun: nyeri tekan, penebalan, atau denyut menghilang mengarah ke arteritis temporalis',
      'Periksa sinus paranasal, gigi geligi, sendi temporomandibular, dan lingkup gerak leher sebagai sumber nyeri alih',
      'Penilaian visus dan koreksi refraksi bila ada keluhan mata lelah',
    ],
    penunjang: [
      'Diagnosis KLINIS murni berdasarkan kriteria ICHD-3 — tidak ada pemeriksaan penunjang yang memastikan tension headache',
      'Pencitraan (CT atau MRI kepala) TIDAK diindikasikan pada nyeri kepala dengan gambaran khas dan pemeriksaan neurologis normal, dan justru menambah biaya serta kecemasan',
      'Pencitraan diindikasikan bila ada RED FLAGS (SNNOOP10): gejala sistemik/demam, riwayat keganasan atau HIV, defisit neurologis, onset mendadak (thunderclap), usia awitan di atas 50 tahun, perubahan pola nyeri, nyeri saat batuk/mengejan/perubahan posisi, papiledema, nyeri progresif, atau nyeri saat bangun tidur',
      'Laboratorium sesuai indikasi: darah lengkap, laju endap darah dan CRP bila curiga arteritis temporalis pada usia lanjut, fungsi tiroid bila ada gejala penyerta',
      'Pungsi lumbal bila curiga meningitis atau perdarahan subaraknoid dengan CT normal',
      'BUKU HARIAN NYERI KEPALA selama minimal 1 bulan merupakan alat paling berguna: mencatat tanggal, durasi, intensitas, pemicu, dan obat yang diminum — sekaligus mendeteksi medication overuse',
    ],
    etiologi:
      'Multifaktorial. Bukan penyakit dengan penyebab tunggal, melainkan interaksi antara peningkatan nyeri tekan otot perikranial (mekanisme perifer) dan sensitisasi sentral pada jalur nyeri trigeminoservikal, dipicu dan diperberat oleh stres psikososial, gangguan tidur, postur kerja yang buruk, serta faktor genetik.',
    patofisiologi:
      'Pada bentuk EPISODIK, mekanisme perifer mendominasi: kontraksi otot perikranial yang berkepanjangan akibat postur statis dan ketegangan emosional menyebabkan iskemia relatif dan pelepasan mediator inflamasi seperti bradikinin, serotonin, dan prostaglandin di jaringan miofasial, yang mensensitisasi nosiseptor perifer sehingga ambang nyeri tekan otot menurun. Aliran impuls nosiseptif yang terus-menerus dari otot perikranial ini kemudian membombardir neuron ordo kedua pada nukleus trigeminoservikal di batang otak dan kornu dorsalis servikal atas. Pada bentuk KRONIK, bombardir yang berkepanjangan menimbulkan SENSITISASI SENTRAL: neuron ordo kedua menjadi hipereksitabel, terjadi wind-up dan perluasan lapangan reseptif, sehingga rangsang yang semula tidak nyeri kini dipersepsi nyeri (alodinia). Bersamaan dengan itu terjadi kegagalan sistem inhibisi nyeri desending dari periaqueductal grey dan nukleus rafe magnus yang normalnya meredam sinyal nyeri. Inilah kunci klinis terpenting: begitu sensitisasi sentral terbentuk, nyeri menjadi relatif MANDIRI dari ketegangan otot awalnya sehingga terapi yang hanya menyasar otot menjadi tidak efektif, dan diperlukan obat yang bekerja sentral seperti amitriptilin. Mekanisme yang sama menjelaskan mengapa penggunaan analgesik berlebihan justru memperburuk keadaan — paparan analgesik kronik menurunkan ambang nyeri sentral dan menyebabkan medication overuse headache, sebuah lingkaran setan di mana obat pereda nyeri menjadi penyebab nyeri.',
    faktorRisiko: [
      'Stres psikososial: tekanan pekerjaan, masalah keluarga, tuntutan akademik',
      'Gangguan cemas dan depresi — komorbiditas yang sangat sering dan memperberat perjalanan penyakit',
      'Kualitas tidur buruk, durasi tidur kurang, dan jadwal tidur tidak teratur',
      'Postur kerja statis, lama menatap layar, dan posisi leher menunduk berkepanjangan',
      'Kelainan refraksi yang tidak terkoreksi dan kelelahan mata',
      'Melewatkan waktu makan, dehidrasi, dan asupan kafein berlebihan atau putus kafein',
      'Penggunaan analgesik berlebihan',
      'Jenis kelamin perempuan dan usia produktif 30-39 tahun sebagai puncak prevalensi',
    ],
    goldStandard:
      'Tidak ada baku emas berupa pemeriksaan penunjang. Diagnosis ditegakkan secara KLINIS dengan kriteria ICHD-3: minimal 10 episode nyeri kepala yang berlangsung 30 menit hingga 7 hari, memenuhi minimal DUA dari empat karakteristik — (1) lokasi bilateral, (2) kualitas menekan atau mengikat dan tidak berdenyut, (3) intensitas ringan sampai sedang, (4) tidak diperberat oleh aktivitas fisik rutin seperti berjalan atau naik tangga — DAN memenuhi kedua syarat berikut: tidak ada mual maupun muntah, serta tidak lebih dari satu di antara fotofobia atau fonofobia. Frekuensi episode menentukan subtipe episodik jarang, episodik sering, atau kronik.',
    diagnosisBanding: [
      'Migren tanpa aura — unilateral, berdenyut, intensitas sedang-berat, DIPERBERAT aktivitas fisik, disertai mual/muntah serta fotofobia DAN fonofobia sekaligus',
      'Nyeri kepala klaster — serangan unilateral sangat hebat di periorbital, durasi 15-180 menit, disertai gejala otonom ipsilateral (mata merah, lakrimasi, hidung tersumbat, ptosis) dan pasien gelisah tidak bisa diam',
      'Medication overuse headache — nyeri kepala harian pada pasien yang mengonsumsi analgesik melebihi ambang batas; harus selalu dipikirkan pada tension headache kronik',
      'Nyeri kepala servikogenik — unilateral, dipicu gerakan leher atau posisi tertentu, disertai keterbatasan lingkup gerak leher',
      'Nyeri kepala sekunder karena hipertensi, sinusitis, kelainan refraksi, gangguan sendi temporomandibular, atau masalah gigi',
      'Nyeri kepala sekunder berbahaya: tumor intrakranial, perdarahan subaraknoid, meningitis, trombosis sinus vena serebral, arteritis temporalis, hipertensi intrakranial idiopatik',
    ],
    pengkajian:
      'Dipikirkan nyeri kepala tipe tegang pada pasien ini atas dasar nyeri kepala bilateral dengan kualitas menekan dan mengikat yang tidak berdenyut, intensitas ringan sampai sedang sehingga pasien masih dapat menjalankan aktivitas, tidak diperberat oleh aktivitas fisik rutin, tanpa mual maupun muntah, dengan pemeriksaan neurologis yang seluruhnya dalam batas normal dan disertai nyeri tekan pada otot perikranial — gambaran ini telah memenuhi kriteria ICHD-3. Latar berupa beban kerja tinggi, postur kerja statis di depan layar, serta kualitas tidur yang buruk memperkuat dugaan tersebut. Migren menjadi pertimbangan utama karena sama-sama merupakan nyeri kepala primer berulang pada usia produktif, namun pada migren nyeri khas unilateral dan berdenyut, intensitasnya sedang sampai berat sehingga pasien terpaksa menghentikan aktivitas dan berbaring di ruang gelap, DIPERBERAT oleh aktivitas fisik ringan seperti naik tangga, serta disertai mual dan fotofobia bersamaan fonofobia — kombinasi yang tidak ditemukan pada pasien ini. Nyeri kepala klaster dapat disingkirkan karena serangannya sangat hebat dan terlokalisasi di periorbital dengan gejala otonom ipsilateral serta pasien tampak gelisah, sangat berbeda dengan nyeri yang tumpul dan menyeluruh pada pasien ini. Yang WAJIB dinilai ulang pada setiap kunjungan adalah kemungkinan MEDICATION OVERUSE HEADACHE, sebab pasien nyeri kepala kronik hampir selalu mengonsumsi analgesik bebas dalam jumlah yang tidak disadarinya, dan selama pola konsumsi ini tidak dihentikan maka profilaksis apa pun akan gagal. Selain itu, tidak ditemukannya red flags berupa onset mendadak, demam, defisit neurologis, papiledema, awitan di atas usia 50 tahun, maupun perubahan pola nyeri menjadi dasar untuk TIDAK melakukan pencitraan kepala, karena pemeriksaan yang tidak berindikasi hanya menambah beban biaya dan kecemasan pasien tanpa mengubah tata laksana.',
    terapiSuportif: [
      'Kompres hangat atau pijat ringan pada otot tengkuk dan bahu',
      'Latihan peregangan leher dan bahu setiap 30-60 menit saat bekerja',
      'Relaksasi napas dalam, relaksasi otot progresif, dan mindfulness',
      'Terapi kognitif perilaku dan biofeedback — terbukti efektif terutama pada bentuk kronik dengan komorbid cemas atau depresi',
      'Fisioterapi dan koreksi ergonomi tempat kerja: tinggi layar sejajar mata, sandaran punggung, jeda teratur',
      'Koreksi kelainan refraksi bila ada',
    ],
    tatalaksana: [
      'SERANGAN AKUT — parasetamol 500-1000 mg per oral, maksimal 4 g per hari pada dewasa dengan fungsi hati normal; merupakan pilihan pertama karena profil keamanan terbaik',
      'Alternatif NSAID: ibuprofen 400-800 mg, natrium diklofenak 50 mg, atau asam mefenamat 500 mg per oral; diminum bersama atau setelah makan dan dihindari pada riwayat ulkus peptikum, gangguan ginjal, dan asma sensitif aspirin',
      'BATASI analgesik maksimal 2 hari per minggu (kurang dari 15 hari per bulan untuk analgesik tunggal, kurang dari 10 hari per bulan untuk kombinasi) — batas ini disampaikan sejak kunjungan pertama untuk mencegah medication overuse headache',
      'HINDARI opioid dan analgesik kombinasi mengandung kafein atau barbiturat karena risiko medication overuse dan ketergantungan yang tinggi',
      'PROFILAKSIS diindikasikan bila nyeri kepala 15 hari atau lebih per bulan, atau bila serangan mengganggu produktivitas secara bermakna',
      'AMITRIPTILIN sebagai profilaksis lini pertama: mulai 10 mg (atau 12,5 mg) per oral malam hari, naikkan bertahap 10-25 mg setiap 1-2 minggu sesuai toleransi hingga 25-75 mg per hari; efek baru dinilai setelah 4-8 minggu pemakaian teratur',
      'Efek samping amitriptilin yang perlu diinformasikan: mengantuk (justru bermanfaat bila diminum malam), mulut kering, konstipasi, retensi urin, penambahan berat badan, dan hipotensi ortostatik; hati-hati pada usia lanjut, glaukoma sudut tertutup, hipertrofi prostat, dan gangguan hantaran jantung',
      'Alternatif profilaksis: mirtazapin atau venlafaksin bila amitriptilin tidak ditoleransi',
      'Lanjutkan profilaksis 6-12 bulan setelah tercapai perbaikan, lalu turunkan bertahap (tapering) — jangan dihentikan mendadak',
      'MEDICATION OVERUSE HEADACHE ditangani dengan menghentikan obat penyebab disertai edukasi bahwa nyeri akan MEMBERAT dahulu selama 1-2 minggu sebelum membaik, sambil memulai profilaksis; rujuk ke spesialis saraf bila pasien tidak berhasil lepas obat',
      'Rujuk ke spesialis saraf bila: terdapat red flags, tidak respons terhadap dua jenis profilaksis adekuat, medication overuse yang sulit dilepaskan, atau diagnosis meragukan',
    ],
    edukasi: [
      'Jelaskan bahwa ini adalah nyeri kepala PRIMER yang tidak berbahaya, bukan tumor otak maupun stroke — kecemasan akan penyakit berat sering menjadi bagian dari lingkaran nyeri, sehingga penjelasan yang meyakinkan merupakan bagian dari terapi',
      'BAHAYA ANALGESIK BERLEBIHAN: obat pereda nyeri yang diminum lebih dari 2 hari per minggu justru dapat berubah menjadi penyebab nyeri kepala harian — ini pesan edukasi paling penting pada tension headache',
      'Jadwal tidur: tidur 7-8 jam dengan jam tidur dan bangun yang KONSISTEN termasuk akhir pekan, hindari layar 1 jam sebelum tidur, kamar gelap dan sejuk',
      'Jadwal dan porsi makan: makan teratur 3 kali sehari dan JANGAN MELEWATKAN waktu makan karena hipoglikemia relatif merupakan pemicu; minum air 8 gelas per hari; batasi kopi maksimal 2 cangkir per hari dan hindari menghentikan kafein secara mendadak',
      'Pola olahraga: aktivitas aerobik intensitas sedang seperti jalan cepat, berenang, atau bersepeda selama 30 menit sebanyak 3-5 kali per minggu terbukti menurunkan frekuensi nyeri kepala',
      'Ergonomi kerja: atur layar sejajar mata, gunakan kursi bersandaran, dan lakukan peregangan leher-bahu setiap 30-60 menit',
      'Kelola stres dengan relaksasi napas dalam, dan cari bantuan profesional bila terdapat gejala cemas atau depresi yang menonjol',
      'BUKU HARIAN NYERI KEPALA: catat tanggal, durasi, intensitas skala 0-10, pemicu, dan setiap obat yang diminum — dibawa saat kontrol',
      'Follow up: kontrol 4 minggu setelah memulai profilaksis untuk menilai respons dan efek samping, kemudian setiap 2-3 bulan bila stabil',
      'SEGERA kembali bila: nyeri kepala mendadak dan sangat hebat seperti disambar petir, disertai demam dan kaku kuduk, kejang, penurunan kesadaran, kelemahan anggota gerak, gangguan bicara atau penglihatan, muntah menyembur, atau pola nyeri berubah total dari biasanya',
    ],
    komplikasi: [
      'Medication overuse headache — komplikasi tersering dan paling dapat dicegah',
      'Transformasi dari bentuk episodik menjadi kronik',
      'Gangguan cemas dan depresi sebagai komorbiditas yang saling memperberat',
      'Gangguan tidur kronik',
      'Penurunan produktivitas kerja, absenteisme, dan presenteisme',
      'Efek samping penggunaan NSAID jangka panjang: gastropati, ulkus peptikum, perdarahan saluran cerna, dan gangguan fungsi ginjal',
    ],
    prognosis:
      'Baik. Bentuk episodik umumnya terkendali dengan analgesik sederhana dan modifikasi gaya hidup tanpa memerlukan profilaksis. Bentuk kronik memiliki perjalanan yang lebih sulit namun sebagian besar pasien membaik bermakna dengan kombinasi amitriptilin, terapi perilaku, dan penghentian penggunaan analgesik berlebihan. Penentu prognosis yang paling kuat justru bukan pilihan obat melainkan keberhasilan mengendalikan stres, memperbaiki higiene tidur, dan menghentikan konsumsi analgesik yang berlebihan; tanpa ketiganya, nyeri kepala cenderung kambuh berulang meski profilaksis diberikan dengan benar.',
    referensi: ['SKDI2012', 'ICHD3', 'PERDOSSI2016', 'PPKFKTP2014', 'ADAMS2019'],
  },
  'Migren': {
  ...
  'Bells’ palsy': {
    definisi:
      'Kelumpuhan nervus fasialis (nervus kranialis VII) perifer akut yang bersifat IDIOPATIK — yaitu diagnosis eksklusi setelah penyebab lain disingkirkan. Karena lesinya berada di nukleus atau distal terhadapnya, kelemahan mengenai SELURUH sisi wajah termasuk otot dahi, berbeda dengan lesi sentral yang menyisakan dahi. Merupakan penyebab tersering paralisis fasialis akut, dengan insidens sekitar 20-30 per 100.000 penduduk per tahun.',
    anamnesis: {
      keluhanUtama:
        'Wajah sisi kanan tiba-tiba mencong sejak pagi tadi, mata kanan tidak dapat dipejamkan dan air minum bocor dari sudut mulut kanan.',
      riwayatPenyakitSekarang:
    ...
    pemeriksaanFisik: [
      ...
      'INSPEKSI wajah saat istirahat: lipatan dahi mendatar, alis turun, celah kelopak mata melebar, lipatan nasolabial mendatar, dan sudut mulut turun pada sisi yang lumpuh',
      'UJI MOTORIK NERVUS VII secara sistematis — minta pasien: (1) MENGANGKAT ALIS dan mengerutkan dahi, (2) memejamkan mata sekuatnya melawan tahanan pemeriksa, (3) mengembangkan cuping hidung, (4) menyeringai memperlihatkan gigi, (5) mengembungkan pipi, (6) bersiul, dan (7) menegangkan otot platisma di leher',
      'KETERLIBATAN DAHI merupakan temuan pemisah terpenting: pada lesi PERIFER pasien TIDAK dapat mengangkat alis pada sisi yang lumpuh, sedangkan pada lesi SENTRAL dahi tetap dapat dikerutkan karena otot dahi menerima persarafan bilateral dari korteks',
      'TANDA BELL: saat pasien berusaha memejamkan mata, bola mata berputar ke atas dan ke luar sementara kelopak tetap terbuka (lagoftalmos)',
      'Nilai derajat kelumpuhan dengan skala HOUSE-BRACKMANN I sampai VI — derajat awal merupakan penentu prognosis terkuat: derajat I normal, II disfungsi ringan, III sedang, IV sedang-berat, V berat, VI paralisis total',
      'Pemeriksaan MATA wajib: visus, kelengkapan penutupan kelopak, refleks kornea, dan pewarnaan fluoresein untuk mendeteksi erosi kornea',
      'OTOSKOPI WAJIB pada kedua telinga: cari VESIKEL pada liang telinga dan daun telinga (Ramsay Hunt), sekret, kolesteatoma, dan perforasi membran timpani — memeriksa telinga adalah langkah yang paling sering terlupakan namun paling sering mengubah diagnosis',
      'Periksa rongga mulut dan palatum untuk vesikel, serta uji pengecapan dua pertiga anterior lidah bila memungkinkan',
      'PALPASI KELENJAR PAROTIS — massa pada parotis merupakan penyebab paralisis fasialis yang tidak boleh terlewat',
      'Pemeriksaan SELURUH nervi kraniales lainnya serta motorik, sensorik, refleks, dan koordinasi — keterlibatan saraf kranial lain atau adanya defisit anggota gerak MENYINGKIRKAN Bell palsy dan mengarahkan ke lesi batang otak, tumor sudut serebelopontin, atau stroke',
      'Periksa kulit untuk ruam eritema migrans (penyakit Lyme) dan kelenjar getah bening leher',
    ],
    penunjang: [
      'Diagnosis KLINIS dan merupakan DIAGNOSIS EKSKLUSI — pada kasus khas dengan onset akut, keterlibatan seluruh sisi wajah termasuk dahi, dan pemeriksaan neurologis lain yang normal, TIDAK diperlukan pemeriksaan penunjang rutin',
      'Gula darah dan HbA1c: skrining diabetes melitus yang sering belum terdiagnosis dan memperburuk prognosis',
      'Pencitraan (MRI kepala dengan kontras atau CT os temporal) diindikasikan bila: perjalanan progresif lebih dari 3 minggu, tidak ada perbaikan sama sekali setelah 4 bulan, kelumpuhan rekuren pada sisi yang sama, keterlibatan saraf kranial lain, adanya massa parotis, riwayat trauma, atau kecurigaan keganasan',
      'Serologi Borrelia burgdorferi bila terdapat riwayat gigitan caplak atau tinggal di daerah endemis; serologi HIV pada paralisis fasialis bilateral atau faktor risiko',
      'Darah lengkap, laju endap darah, dan foto toraks bila dicurigai sarkoidosis (terutama pada paralisis fasialis bilateral)',
      'Elektroneuronografi dan elektromiografi bermanfaat pada kelumpuhan komplet (House-Brackmann VI) setelah hari ke-3 hingga minggu ke-3 untuk menilai derajat degenerasi dan memperkirakan prognosis — degenerasi lebih dari 90% menandakan prognosis buruk; pemeriksaan ini bersifat rujukan',
      'Uji Schirmer untuk menilai produksi air mata bila diperlukan penentuan letak lesi',
    ],
    etiologi:
      'Idiopatik menurut definisi, namun bukti terkuat menunjukkan REAKTIVASI virus herpes simpleks tipe 1 yang laten di ganglion genikulatum sebagai penyebab utama; virus varisela-zoster yang reaktif menimbulkan sindrom Ramsay Hunt yang secara definisi bukan Bell palsy. Penyebab lain yang harus disingkirkan sebelum menegakkan Bell palsy meliputi otitis media, kolesteatoma, trauma os temporal, tumor parotis, tumor sudut serebelopontin, penyakit Lyme, sarkoidosis, HIV, sindrom Guillain-Barré (khas menimbulkan kelumpuhan BILATERAL), dan stroke batang otak.',
    patofisiologi:
      'Reaktivasi virus herpes yang laten di ganglion genikulatum memicu peradangan dan edema pada nervus fasialis. Persoalan anatomiknya terletak pada kanalis fasialis di dalam os temporal — sebuah terowongan tulang yang tidak dapat melebar, dengan bagian tersempit pada segmen labirin dan foramen meatal. Ketika saraf yang meradang membengkak di dalam ruang yang kaku ini, terjadi KOMPRESI dan penekanan pada suplai darahnya sendiri, sehingga timbul iskemia yang memperberat edema dan menimbulkan lingkaran setan edema-kompresi-iskemia. Derajat kerusakan menentukan prognosis: bila hanya terjadi NEURAPRAKSIA yaitu blok hantaran tanpa kerusakan akson, pemulihan berlangsung cepat dan sempurna dalam beberapa minggu; bila terjadi AKSONOTMESIS dengan degenerasi Wallerian, akson harus tumbuh kembali dengan kecepatan sekitar 1 mm per hari sehingga pemulihan memakan waktu berbulan-bulan dan sering tidak sempurna. Pertumbuhan akson yang keliru arah (aberrant regeneration) inilah yang menimbulkan gejala sisa khas berupa SINKINESIS — sudut mulut ikut tertarik saat memejamkan mata — dan CROCODILE TEARS yaitu mata berair saat makan karena serabut yang seharusnya menuju kelenjar liur salah tumbuh menuju kelenjar lakrimal. Pemahaman ini menjelaskan mengapa KORTIKOSTEROID harus diberikan sedini mungkin dalam 72 jam: obat ini menekan edema pada fase ketika kerusakan masih reversibel, sedangkan pemberian yang terlambat tidak lagi dapat mencegah degenerasi akson yang sudah berlangsung. Urutan gejala penyerta juga dapat menunjukkan letak lesi di sepanjang perjalanan saraf: berkurangnya air mata menandakan lesi proksimal terhadap ganglion genikulatum, hiperakusis menandakan lesi proksimal terhadap cabang ke otot stapedius, dan gangguan pengecapan menandakan lesi proksimal terhadap percabangan korda timpani.',
    faktorRisiko: [
      'Diabetes melitus — meningkatkan risiko sekaligus memperburuk prognosis pemulihan',
    ...
    diagnosisBanding: [
      'Stroke — kelemahan wajah SENTRAL yang MENYISAKAN dahi (pasien masih dapat mengangkat alis), hampir selalu disertai kelemahan anggota gerak atau gangguan bicara; membedakan keduanya di menit-menit pertama adalah keterampilan klinis paling penting pada kasus wajah mencong',
      'Sindrom Ramsay Hunt (herpes zoster otikus) — vesikel nyeri di liang telinga, daun telinga, atau palatum, sering disertai gangguan pendengaran dan vertigo; kelumpuhan lebih berat dan prognosis lebih buruk sehingga memerlukan antivirus dosis penuh',
      'Otitis media akut atau kronik dengan kolesteatoma — riwayat keluar cairan dari telinga, temuan otoskopi abnormal; memerlukan penanganan sumber infeksi',
      'Tumor parotis — teraba massa pada parotis, kelemahan wajah berkembang PERLAHAN dan progresif',
      'Tumor sudut serebelopontin seperti schwannoma vestibular — disertai gangguan pendengaran progresif, tinitus, dan keterlibatan nervus V serta VIII',
      'Sindrom Guillain-Barré dan penyakit Lyme — penyebab tersering paralisis fasialis BILATERAL',
      'Trauma os temporal, sarkoidosis (sindrom Heerfordt), HIV, dan miastenia gravis',
    ],
    pengkajian:
      'Dipikirkan Bell palsy pada pasien ini atas dasar kelemahan separuh wajah yang timbul mendadak dalam kurang dari 72 jam dan MELIBATKAN otot dahi sehingga pasien tidak mampu mengangkat alis pada sisi yang lumpuh, disertai lagoftalmos dengan tanda Bell positif, sudut mulut yang turun, serta gangguan pengecapan dan hiperakusis yang menunjukkan letak lesi di sepanjang kanalis fasialis. Pemeriksaan nervi kraniales lainnya, kekuatan motorik keempat anggota gerak, sensorik, dan koordinasi seluruhnya dalam batas normal, sehingga lesi sentral dapat disingkirkan. Stroke merupakan diagnosis banding yang paling penting dan paling berbahaya bila terlewat, namun pada stroke kelemahan wajah bersifat sentral dan MENYISAKAN dahi karena otot dahi memperoleh persarafan kortikal bilateral, dan hampir selalu disertai defisit neurologis lain berupa kelemahan anggota gerak atau gangguan bicara — hal yang tidak ditemukan pada pasien ini. Sindrom Ramsay Hunt dipertimbangkan karena gambaran kelumpuhan fasialisnya identik, namun pada pemeriksaan otoskopi dan rongga mulut tidak ditemukan vesikel, tidak ada nyeri telinga hebat, tidak ada gangguan pendengaran maupun vertigo; pemeriksaan telinga ini wajib dilakukan sebab kekeliruan membedakan keduanya berarti pasien tidak memperoleh antivirus dosis penuh yang sangat menentukan pada Ramsay Hunt. Otitis media dan kolesteatoma disingkirkan dari riwayat telinga yang bersih dan gambaran membran timpani yang utuh, sedangkan tumor parotis disingkirkan dari palpasi parotis yang tidak teraba massa dan dari perjalanan penyakit yang akut, bukan progresif perlahan. Dua hal yang menentukan keluaran pasien ini bukanlah ketepatan diagnosis semata, melainkan KECEPATAN memulai kortikosteroid dalam 72 jam pertama saat kerusakan saraf masih reversibel, dan KEDISIPLINAN PROTEKSI MATA — sebab komplikasi yang paling merugikan dan paling dapat dicegah pada Bell palsy adalah ulkus kornea akibat mata yang tidak dapat menutup, yang dapat berujung pada kebutaan permanen pada saraf yang sesungguhnya akan pulih dengan sendirinya.',
    terapiSuportif: [
      'PROTEKSI MATA merupakan tindakan suportif terpenting dan bersifat WAJIB selama mata belum dapat menutup sempurna',
      'Air mata buatan tanpa pengawet setiap 1-2 jam sepanjang hari',
      'Salep mata pelumas pada malam hari, dan tutup mata dengan plester atau penutup mata saat tidur',
      'Gunakan kacamata pelindung di luar ruangan untuk menghindari debu dan angin',
      'Latihan otot wajah di depan cermin: mengangkat alis, memejamkan mata, menyeringai, mengembungkan pipi, dan bersiul, masing-masing 10-15 kali sebanyak 2-3 sesi per hari; dimulai setelah fase akut',
      'Pijat wajah lembut ke arah atas dan kompres hangat',
      'Fisioterapi wajah dan terapi cermin (mirror biofeedback) bermanfaat terutama untuk mencegah dan mengurangi sinkinesis',
      'Bantuan makan: makan perlahan, gunakan sisi yang sehat untuk mengunyah, dan bersihkan sisa makanan yang terselip di sulkus bukal',
      'Dukungan psikologis — perubahan wajah kerap menimbulkan rasa malu dan menarik diri, sehingga penjelasan mengenai prognosis yang baik sangat menenangkan',
    ],
    tatalaksana: [
      'KORTIKOSTEROID sedini mungkin, idealnya dalam 72 JAM PERTAMA sejak awitan — ini merupakan intervensi dengan bukti terkuat untuk meningkatkan angka pemulihan sempurna',
      'Prednison atau prednisolon 1 mg/kgBB per hari (dewasa umumnya 60 mg per hari) per oral dosis tunggal pagi hari selama 5-7 hari, dilanjutkan penurunan bertahap hingga total 10 hari; regimen alternatif 50 mg per hari selama 10 hari tanpa tapering juga digunakan',
      'Berikan kortikosteroid bersama makanan, dan pertimbangkan gastroprotektor pada pasien berisiko ulkus',
      'Pada penyandang DIABETES tetap diberikan kortikosteroid namun dengan PEMANTAUAN GULA DARAH KETAT dan penyesuaian dosis obat antidiabetes, karena manfaatnya melebihi risiko hiperglikemia sementara',
      'ANTIVIRUS tidak diberikan sebagai terapi tunggal. Penambahan valasiklovir 1000 mg tiga kali sehari selama 7 hari atau asiklovir 400 mg lima kali sehari selama 7-10 hari pada kortikosteroid dapat dipertimbangkan pada kelumpuhan BERAT (House-Brackmann IV-VI), meski manfaat tambahannya kecil',
      'Bila ditemukan VESIKEL (Ramsay Hunt), antivirus diberikan dengan dosis penuh dan bukan sekadar dipertimbangkan — valasiklovir 1000 mg tiga kali sehari selama 7 hari bersama kortikosteroid',
      'Analgesik parasetamol atau NSAID untuk nyeri retroaurikular',
      'Pada ANAK: kortikosteroid 1 mg/kgBB per hari selama 5-7 hari dengan tapering; prognosis pada anak umumnya sangat baik bahkan tanpa terapi',
      'Pada IBU HAMIL: prednisolon relatif aman dan tetap diberikan, sebaiknya dengan koordinasi bersama dokter kandungan',
      'Rujuk ke SPESIALIS SARAF bila: tidak ada perbaikan sama sekali dalam 3-4 bulan, kelumpuhan progresif melebihi 3 minggu, kelumpuhan bilateral, kelumpuhan rekuren, atau terdapat keterlibatan saraf kranial lain',
      'Rujuk ke SPESIALIS MATA segera bila terdapat mata merah, nyeri, penurunan visus, atau kekeruhan kornea',
      'Rujuk ke THT bila terdapat kelainan telinga, kecurigaan kolesteatoma, atau massa parotis',
      'Dekompresi bedah nervus fasialis sangat jarang diindikasikan, bersifat kontroversial, dan hanya dipertimbangkan pada kasus dengan degenerasi berat pada elektroneuronografi dalam dua minggu pertama di pusat rujukan',
    ],
    edukasi: [
      'INI BUKAN STROKE — penjelasan ini harus disampaikan pertama kali karena hampir semua pasien dengan wajah mencong datang dalam ketakutan akan stroke; jelaskan bahwa yang terganggu adalah saraf wajah, bukan otak',
      'Prognosis umumnya BAIK: sekitar 70% pasien pulih sempurna tanpa terapi dan angka ini meningkat hingga sekitar 80-85% dengan kortikosteroid dini; perbaikan awal biasanya mulai terlihat dalam 3 minggu dan pemulihan penuh dapat memakan waktu 3-6 bulan',
      'PERAWATAN MATA adalah tugas harian pasien yang paling penting — tetes air mata buatan tiap 1-2 jam, salep dan penutup mata saat tidur; mengabaikan hal ini dapat menyebabkan luka pada kornea hingga kebutaan permanen',
      'Obat kortikosteroid harus DIHABISKAN sesuai jadwal dan tidak dihentikan mendadak',
      'Jadwal dan porsi makan: makan dalam porsi kecil dan lebih sering, mengunyah dengan sisi yang sehat, hindari makanan yang terlalu cair yang mudah bocor dari mulut, gunakan sedotan bila perlu, dan bersihkan mulut setelah makan untuk mencegah sisa makanan tertinggal di pipi',
      'Jam tidur: istirahat cukup 7-8 jam per malam; tidur dengan mata tertutup plester pada sisi yang lumpuh',
      'Pola olahraga: aktivitas fisik biasa tidak dilarang; tambahkan latihan otot wajah di depan cermin 2-3 sesi per hari setelah fase akut mereda',
      'Angin dan udara dingin bukan penyebab penyakit ini meski banyak diyakini demikian — namun melindungi wajah dan mata dari angin tetap dianjurkan untuk kenyamanan dan keamanan mata',
      'Kenali kemungkinan gejala sisa: sinkinesis berupa sudut mulut ikut tertarik saat memejamkan mata, dan mata berair saat makan; sampaikan bahwa hal ini dapat terjadi pada pemulihan yang tidak sempurna dan dapat dikurangi dengan latihan terbimbing',
      'Follow up: kontrol dalam 1 minggu untuk menilai respons dan kondisi mata, kemudian setiap 2-4 minggu hingga pulih; bila tidak ada perbaikan sama sekali dalam 3-4 bulan harus dirujuk untuk pencitraan',
      'SEGERA kembali bila: mata merah, nyeri, atau penglihatan menurun; muncul vesikel di telinga; timbul kelemahan pada anggota gerak, gangguan bicara, atau gangguan menelan; kelumpuhan mengenai kedua sisi wajah; atau kelumpuhan justru bertambah berat setelah minggu pertama',
    ],
    komplikasi: [
      'KERATITIS EKSPOSUR, ulkus kornea, hingga perforasi dan kebutaan akibat lagoftalmos yang tidak dilindungi — komplikasi paling serius dan paling dapat dicegah',
      'SINKINESIS akibat regenerasi akson yang salah arah — gerakan wajah yang tidak dikehendaki menyertai gerakan lain',
      'CROCODILE TEARS (sindrom Bogorad) — mata berair saat makan',
      'Kontraktur otot wajah dan spasme hemifasial',
      'Kelemahan wajah residual yang menetap pada sekitar 15-30% kasus',
      'Gangguan pengecapan yang menetap',
      'Dampak psikososial: rasa rendah diri, kecemasan, depresi, dan penarikan diri dari kehidupan sosial',
      'Hiperglikemia, insomnia, gangguan mood, dan dispepsia sebagai efek samping kortikosteroid',
    ],
    prognosis:
      'Umumnya baik. Sekitar 70% pasien pulih sempurna tanpa pengobatan, dan angka ini meningkat menjadi sekitar 80-85% dengan pemberian kortikosteroid dalam 72 jam pertama. Tanda perbaikan biasanya mulai tampak dalam 3 minggu, dan pemulihan lengkap berlangsung hingga 3-6 bulan. Penentu prognosis terkuat adalah DERAJAT KELUMPUHAN AWAL — kelumpuhan inkomplet hampir selalu pulih sempurna, sedangkan kelumpuhan komplet (House-Brackmann VI) hanya pulih sempurna pada sekitar sepertiga kasus. Faktor yang memperburuk prognosis meliputi usia lanjut, diabetes melitus, hipertensi, kelumpuhan komplet sejak awal, tidak adanya perbaikan sama sekali dalam 3 minggu, serta sindrom Ramsay Hunt. Rekurensi terjadi pada sekitar 5-10% kasus dan setiap rekurensi menuntut penelusuran ulang penyebab sekunder.',
    referensi: ['SKDI2012', 'AAOBELL2013', 'PERDOSSI2016', 'PPKFKTP2014', 'ADAMS2019'],
  },
  'Lesi batang otak': {
  ...
  'Vertigo (Benign paroxysmal positional vertigo)': {
    definisi:
      'Vertigo paroksismal posisional jinak (BPPV) adalah gangguan vestibular perifer akibat lepasnya otokonia (kristal kalsium karbonat) dari makula utrikulus dan masuk ke dalam kanalis semisirkularis, sehingga perubahan posisi kepala terhadap gravitasi memicu serangan vertigo berputar yang singkat dan berulang. Merupakan penyebab vertigo tersering pada semua kelompok usia dan menyumbang sekitar seperempat dari seluruh keluhan pusing berputar di layanan primer.',
    anamnesis: {
      keluhanUtama:
        'Pusing berputar hebat yang muncul mendadak setiap kali berbalik badan di tempat tidur atau bangun dari berbaring, berlangsung kurang dari satu menit lalu hilang sendiri.',
      riwayatPenyakitSekarang:
    ...
    pemeriksaanFisik: [
      ...
      'MANUVER DIX-HALLPIKE — baku emas untuk kanalis posterior: pasien duduk di tepi tempat tidur, kepala ditolehkan 45 derajat ke sisi yang diperiksa, lalu dibaringkan cepat hingga kepala menggantung 20-30 derajat di bawah horizontal; pertahankan posisi dan amati mata pasien selama minimal 30 detik',
      'Hasil POSITIF pada BPPV kanalis posterior: timbul vertigo disertai NISTAGMUS TORSIONAL-UPBEAT (fase cepat berputar ke arah telinga yang di bawah) dengan tiga ciri khas — LATENSI 1-5 detik sebelum muncul, durasi SINGKAT kurang dari 1 menit, dan FATIGABLE yaitu berkurang bila manuver diulang; nistagmus berbalik arah saat pasien dikembalikan ke posisi duduk',
      'UJI SUPINE ROLL (manuver Pagnini-McClure) bila Dix-Hallpike negatif namun anamnesis sangat khas: pasien telentang, kepala ditolehkan cepat ke kanan lalu ke kiri untuk mendeteksi BPPV KANALIS HORIZONTAL yang menimbulkan nistagmus horizontal geotropik atau apogeotropik',
      'Pemeriksaan NISTAGMUS spontan pada posisi duduk — nistagmus spontan yang menetap BUKAN gambaran BPPV',
      'Uji HINTS pada vertigo akut menetap untuk memisahkan perifer dari sentral: Head Impulse (pada perifer terdapat sakade korektif; pada sentral NORMAL), Nystagmus (pada sentral berubah arah mengikuti arah pandangan atau bersifat vertikal murni), Test of Skew (deviasi vertikal pada penutupan mata bergantian menandakan lesi sentral)',
      'Pemeriksaan neurologis lengkap: seluruh nervi kraniales, motorik, sensorik, refleks, serta pemeriksaan SEREBELUM berupa uji telunjuk-hidung, tumit-lutut, disdiadokokinesis, dan uji Romberg serta cara berjalan',
      'Pemeriksaan TELINGA: otoskopi kedua telinga, uji penala Rinne dan Weber, serta uji bisik — pada BPPV pendengaran harus NORMAL',
      'Penilaian risiko jatuh pada pasien usia lanjut: uji Timed Up and Go dan kekuatan otot tungkai',
    ],
    penunjang: [
      'Diagnosis KLINIS murni berdasarkan anamnesis khas dan manuver posisional positif — TIDAK diperlukan pemeriksaan penunjang pada kasus yang khas',
      'PENCITRAAN TIDAK DIINDIKASIKAN secara rutin dan justru merupakan pemeriksaan berlebihan pada BPPV tipikal',
      'MRI kepala dengan perhatian pada fosa posterior diindikasikan bila terdapat tanda bahaya: nistagmus vertikal murni atau berubah arah, uji Head Impulse yang normal pada vertigo akut menetap, defisit neurologis fokal, nyeri kepala hebat, ataksia berat sehingga pasien tidak mampu berjalan, atau vertigo yang tidak membaik dengan manuver reposisi yang dikerjakan dengan benar',
      'Audiometri nada murni bila terdapat keluhan pendengaran, tinitus, atau rasa penuh di telinga untuk menyingkirkan penyakit Meniere dan schwannoma vestibular',
      'Laboratorium sesuai indikasi: darah lengkap, gula darah, profil lipid, fungsi tiroid, dan kadar vitamin D — defisiensi vitamin D berkaitan dengan BPPV rekuren dan suplementasinya menurunkan angka kekambuhan',
      'Elektrokardiografi bila keluhan lebih menyerupai presinkop atau terdapat riwayat palpitasi',
      'Videonistagmografi dan uji kalori merupakan pemeriksaan tingkat rujukan, tidak rutin untuk BPPV',
    ],
    etiologi:
      'Sebagian besar bersifat IDIOPATIK, terutama pada usia lanjut akibat degenerasi makula utrikulus. Penyebab sekunder meliputi trauma kepala (tersering pada usia muda), neuritis vestibularis atau labirinitis sebelumnya, penyakit Meniere, migren vestibular, tindakan bedah telinga atau bedah gigi, tirah baring lama, serta gangguan metabolisme kalsium seperti osteoporosis dan defisiensi vitamin D. Kanalis semisirkularis POSTERIOR terlibat pada sekitar 85-90% kasus karena posisinya paling bergantung terhadap gravitasi, diikuti kanalis horizontal, sedangkan kanalis anterior sangat jarang.',
    patofisiologi:
      'Otokonia yang normalnya melekat pada membran otolitik di makula utrikulus terlepas akibat degenerasi, trauma, atau proses lain, lalu terbawa arus endolimf dan masuk ke dalam kanalis semisirkularis — paling sering kanalis posterior karena letaknya paling rendah pada posisi kepala tegak maupun berbaring. Terdapat dua mekanisme. Pada KANALOLITIASIS yang jauh lebih sering, partikel bergerak BEBAS di dalam lumen kanalis; ketika kepala berubah posisi, gravitasi menarik partikel sehingga menimbulkan aliran endolimf yang membelokkan kupula dan merangsang sel rambut secara palsu, seolah-olah kepala sedang berputar padahal tidak. Pergerakan partikel ini memerlukan waktu untuk mulai bergerak, yang menjelaskan LATENSI 1-5 detik; berhenti setelah partikel mencapai titik terendah, yang menjelaskan DURASI kurang dari 1 menit; dan partikel terdispersi bila manuver diulang, yang menjelaskan sifat FATIGABLE. Pada KUPULOLITIASIS yang lebih jarang, partikel MELEKAT pada kupula sehingga kupula menjadi peka terhadap gravitasi secara terus-menerus; akibatnya nistagmus timbul tanpa latensi, berlangsung lebih lama, dan tidak fatigable. Karena persoalannya semata-mata adalah partikel yang berada di tempat yang salah, maka terapinya pun bersifat MEKANIK: manuver reposisi bekerja dengan memutar kepala melalui serangkaian posisi yang memanfaatkan gravitasi untuk menggiring partikel keluar dari kanalis kembali ke utrikulus, tempat partikel tidak lagi menimbulkan gejala. Pemahaman ini sekaligus menjelaskan mengapa obat antivertigo bukan terapi definitif — obat hanya menumpulkan persepsi vestibular tanpa memindahkan partikel, dan pemakaiannya yang berkepanjangan justru menekan kompensasi sentral sehingga pemulihan menjadi lebih lambat.',
    faktorRisiko: [
    ...
    diagnosisBanding: [
      'Penyakit Meniere — serangan vertigo berlangsung 20 menit hingga beberapa jam (jauh lebih lama), DISERTAI gangguan pendengaran sensorineural yang berfluktuasi, tinitus, dan rasa penuh di telinga',
      'Neuritis vestibularis — vertigo hebat yang MENETAP selama berhari-hari tanpa dipicu posisi, dengan nistagmus spontan unidireksional, tanpa gangguan pendengaran',
      'Labirinitis — seperti neuritis vestibularis namun DISERTAI gangguan pendengaran',
      'Vertigo sentral akibat stroke serebelum atau batang otak — nistagmus vertikal murni atau berubah arah, uji Head Impulse NORMAL, disertai defisit neurologis lain dan ataksia berat sehingga pasien tidak dapat berjalan; inilah diagnosis yang paling berbahaya bila terlewat',
      'Migren vestibular — vertigo berlangsung menit hingga jam disertai nyeri kepala migrenosa, fotofobia, dan fonofobia, dengan riwayat migren sebelumnya',
      'Hipotensi ortostatik dan presinkop — sensasi melayang dan mau pingsan (bukan berputar), muncul saat berdiri dari duduk atau berbaring, disertai penurunan tekanan darah pada pengukuran posisional',
      'Anemia, hipoglikemia, aritmia, gangguan cemas, dan hiperventilasi',
      'Schwannoma vestibular — gangguan pendengaran unilateral progresif dan tinitus dengan ketidakseimbangan yang perlahan, bukan serangan vertigo singkat',
    ],
    pengkajian:
      'Dipikirkan vertigo paroksismal posisional jinak pada pasien ini atas dasar serangan pusing berputar sejati yang selalu DIPICU oleh perubahan posisi kepala, khususnya saat berguling di tempat tidur dan bangun dari berbaring, dengan durasi setiap serangan yang sangat singkat kurang dari satu menit dan mereda spontan bila kepala dipertahankan diam, tanpa disertai gangguan pendengaran, tinitus, maupun rasa penuh di telinga, serta pemeriksaan neurologis dan otoskopi yang seluruhnya normal. Dugaan ini dipastikan oleh manuver Dix-Hallpike yang menimbulkan vertigo disertai nistagmus torsional-upbeat dengan latensi beberapa detik, durasi singkat, dan bersifat fatigable — kombinasi latensi, durasi singkat, dan fatigabilitas ini merupakan sidik jari kanalolitiasis dan tidak dijumpai pada penyebab vertigo lainnya. Penyakit Meniere menjadi pertimbangan karena sama-sama menimbulkan serangan vertigo berulang, namun serangannya berlangsung dua puluh menit hingga beberapa jam dan selalu disertai gejala koklea berupa penurunan pendengaran yang berfluktuasi, telinga berdenging, serta rasa penuh — ketiganya tidak ditemukan pada pasien ini. Neuritis vestibularis dipertimbangkan pada vertigo perifer akut, namun keluhannya bersifat MENETAP berhari-hari dan tidak dipicu posisi, dengan nistagmus spontan yang tampak bahkan saat pasien duduk diam. Yang paling penting disingkirkan adalah VERTIGO SENTRAL akibat stroke serebelum atau batang otak, sebab kekeliruan di sini berakibat fatal; pada pasien ini uji Head Impulse menunjukkan sakade korektif yang justru menandakan lesi perifer, nistagmus bersifat torsional dan tidak berubah arah maupun vertikal murni, tidak ditemukan skew deviation, tidak ada defisit neurologis fokal, dan pasien tetap mampu berjalan tanpa ataksia berat. Perlu ditekankan bahwa kunci tata laksana pasien ini adalah MANUVER REPOSISI KANALIT, bukan obat — memberikan betahistin atau dimenhidrinat berkepanjangan tanpa mengerjakan manuver adalah kesalahan yang paling sering terjadi pada BPPV, karena obat tidak memindahkan partikel yang menjadi akar masalah dan pemakaian lamanya justru menghambat kompensasi sentral sehingga keluhan berlarut-larut.',
    terapiSuportif: [
      'Latihan BRANDT-DAROFF di rumah sebagai terapi habituasi mandiri: dari posisi duduk, berbaring cepat ke satu sisi dengan kepala menoleh 45 derajat ke arah berlawanan, tahan 30 detik atau sampai vertigo mereda, duduk kembali 30 detik, lalu ulangi ke sisi lain — 5 pengulangan setiap sesi, 3 sesi per hari',
      'Rehabilitasi vestibular berupa latihan adaptasi gaze stabilization dan latihan keseimbangan, terutama pada pasien usia lanjut atau yang masih merasa tidak seimbang setelah manuver berhasil',
      'Pencegahan jatuh di rumah: penerangan yang cukup terutama menuju kamar mandi pada malam hari, pegangan di kamar mandi, singkirkan karpet lepas dan kabel di lantai, gunakan alas kaki bertapak tidak licin',
      'Bangun dari tempat tidur secara BERTAHAP: duduk dahulu 30 detik sebelum berdiri',
      'Suplementasi vitamin D dan kalsium pada pasien dengan kadar vitamin D rendah — terbukti menurunkan angka kekambuhan BPPV',
      'Hidrasi cukup dan menghindari kelelahan berlebihan',
    ],
    tatalaksana: [
      'MANUVER REPOSISI KANALIT adalah terapi DEFINITIF dan lini pertama — tingkat keberhasilannya mencapai 80-90% setelah satu hingga dua kali pengerjaan',
      'MANUVER EPLEY untuk BPPV kanalis posterior: (1) pasien duduk, kepala ditolehkan 45 derajat ke sisi yang sakit; (2) baringkan cepat dengan kepala menggantung 20 derajat, tahan 30-60 detik hingga nistagmus mereda; (3) putar kepala 90 derajat ke sisi berlawanan, tahan 30-60 detik; (4) putar kepala dan badan lagi 90 derajat sehingga wajah menghadap ke lantai, tahan 30-60 detik; (5) dudukkan pasien perlahan dengan kepala sedikit menunduk',
      'Manuver SEMONT sebagai alternatif untuk kanalis posterior, khususnya bila pasien sulit menoleransi posisi Epley',
      'Manuver BARBECUE ROLL (Lempert) atau posisi Gufoni untuk BPPV kanalis HORIZONTAL',
      'Ulangi manuver pada kunjungan yang sama bila masih terdapat nistagmus, dan evaluasi ulang dalam 1-2 minggu; kegagalan setelah tiga kali manuver yang dikerjakan benar merupakan indikasi rujukan',
      'OBAT ANTIVERTIGO BUKAN TERAPI UTAMA dan tidak menyembuhkan BPPV. Betahistin 3 x 8-24 mg, dimenhidrinat 3 x 50 mg, atau flunarizin 5-10 mg malam hari hanya diberikan JANGKA SANGAT PENDEK (maksimal 3 hari) untuk meredakan mual dan vertigo hebat, atau sebagai premedikasi sebelum manuver pada pasien yang sangat mual',
      'Pemakaian vestibular supresan LEBIH DARI BEBERAPA HARI HARUS DIHINDARI karena menekan kompensasi sentral, memperlambat pemulihan, dan meningkatkan risiko jatuh serta sedasi terutama pada usia lanjut',
      'Antiemetik seperti ondansetron atau metoklopramid bila muntah hebat, dan rehidrasi bila terjadi dehidrasi',
      'Pembatasan aktivitas pascamanuver seperti tidur setengah duduk atau menghindari posisi tertentu TIDAK terbukti meningkatkan keberhasilan dan tidak lagi dianjurkan secara rutin',
      'Rujuk ke spesialis saraf atau THT bila: gagal dengan manuver yang dikerjakan benar sebanyak tiga kali, kekambuhan yang sangat sering, dicurigai keterlibatan kanalis multipel, terdapat gangguan pendengaran, atau muncul tanda vertigo sentral',
      'Tindakan bedah berupa oklusi kanalis semisirkularis posterior hanya untuk kasus sangat jarang yang tidak tertangani (intractable) di pusat rujukan',
    ],
    edukasi: [
      'Jelaskan bahwa penyakit ini JINAK — vertigo timbul karena ada serpihan kristal kecil yang berpindah ke saluran keseimbangan di telinga dalam, bukan karena tumor otak, stroke, ataupun kekurangan darah ke otak sebagaimana sering dikhawatirkan pasien',
      'Terapi utamanya adalah MANUVER, BUKAN OBAT — sampaikan bahwa manuver dapat menghilangkan keluhan pada sebagian besar pasien dalam satu hingga dua kali pengerjaan, dan bahwa obat antivertigo yang diminum terus-menerus justru memperlambat pemulihan',
      'Selama manuver, vertigo dan mual akan MEMBERAT SEMENTARA — ini normal dan pertanda partikel sedang bergerak; pasien perlu bertahan dan tidak menghentikan manuver di tengah jalan',
      'Bangun tidur secara bertahap: duduk dahulu setengah menit sebelum berdiri; hindari gerakan kepala yang cepat dan mendadak pada beberapa hari pertama',
      'Jadwal dan porsi makan: makan porsi kecil lebih sering bila masih mual, hindari makanan berlemak dan berbau tajam saat serangan, dan pastikan asupan cairan cukup; pada pasien dengan kecurigaan penyakit Meniere batasi garam — namun pembatasan garam TIDAK diperlukan pada BPPV murni',
      'Jam tidur: tidur cukup 7-8 jam; posisi tidur setengah duduk boleh digunakan bila membuat nyaman namun tidak wajib',
      'Pola olahraga: lanjutkan aktivitas fisik seperti biasa segera setelah keluhan mereda — menghindari gerakan justru memperlambat kompensasi; latihan Brandt-Daroff 3 sesi per hari serta latihan keseimbangan seperti berjalan dan tai chi sangat dianjurkan',
      'KESELAMATAN: jangan mengemudi, bekerja di ketinggian, berenang, atau mengoperasikan mesin selama serangan masih sering muncul',
      'Kekambuhan terjadi pada sekitar 15-50% pasien dalam 5 tahun — bila kambuh, manuver dapat diulang dan pasien dapat diajari mengerjakannya sendiri di rumah',
      'Follow up: kontrol 1-2 minggu setelah manuver untuk evaluasi ulang dengan Dix-Hallpike; bila masih positif, manuver diulang',
      'SEGERA kembali bila: vertigo disertai nyeri kepala hebat, pandangan ganda, bicara pelo, kesulitan menelan, baal atau lemah pada wajah maupun anggota gerak, tidak mampu berjalan sama sekali, penurunan pendengaran mendadak, atau vertigo yang menetap terus-menerus tanpa dipengaruhi posisi',
    ],
    komplikasi: [
      'JATUH dengan cedera — terutama fraktur kolum femoris pada pasien usia lanjut; ini merupakan komplikasi paling merugikan',
      'Konversi kanalis (canal switch) saat manuver: partikel berpindah dari kanalis posterior ke kanalis horizontal, sehingga pola nistagmus berubah dan diperlukan manuver yang berbeda',
      'Mual dan muntah hebat selama manuver hingga dehidrasi',
      'Ketidakseimbangan residual dan rasa melayang yang menetap beberapa minggu setelah nistagmus hilang',
      'Kecemasan, fobia gerakan, dan pembatasan aktivitas yang berlebihan sehingga menurunkan kebugaran dan memperbesar risiko jatuh',
      'Sedasi berlebihan, jatuh, dan gangguan kognitif akibat penggunaan vestibular supresan jangka panjang',
      'Keterlambatan mendiagnosis stroke fosa posterior bila semua vertigo dianggap BPPV tanpa pemeriksaan yang cermat',
    ],
    prognosis:
      'Sangat baik. Manuver reposisi kanalit berhasil menghilangkan gejala pada 80-90% pasien setelah satu hingga dua kali pengerjaan, dan sebagian besar sisanya membaik dengan pengulangan. Bahkan tanpa terapi, BPPV sering mereda sendiri dalam beberapa minggu hingga bulan karena partikel larut atau berpindah dengan sendirinya, namun membiarkannya berarti membiarkan pasien menanggung risiko jatuh dan pembatasan aktivitas yang tidak perlu. Kekambuhan cukup sering, sekitar 15-50% dalam lima tahun, dan lebih tinggi pada BPPV pascatrauma, usia lanjut, penyakit vestibular penyerta, serta defisiensi vitamin D — pada kelompok ini koreksi vitamin D dan pengajaran manuver mandiri menjadi bagian penting dari pencegahan jangka panjang.',
    referensi: ['SKDI2012', 'AAOBPPV2017', 'PERDOSSI2016', 'PPKFKTP2014', 'CUMMINGS2021'],
  },
  'Cerebral palsy': {
  ...
  'Refluks gastroesofagus': {
    definisi:
      'Penyakit refluks gastroesofagus (GERD) adalah kondisi naiknya isi lambung ke dalam esofagus yang menimbulkan gejala mengganggu dan/atau komplikasi. Perlu dibedakan antara refluks FISIOLOGIS yang terjadi pada setiap orang beberapa kali sehari tanpa gejala, dengan PENYAKIT refluks yang menimbulkan keluhan bermakna sehingga menurunkan kualitas hidup. Pada bayi, regurgitasi merupakan fenomena fisiologis yang dialami sebagian besar bayi sehat dan membaik sendiri seiring pematangan sfingter esofagus bawah.',
    anamnesis: {
      keluhanUtama:
        'Rasa panas terbakar yang menjalar dari ulu hati ke arah dada dan tenggorokan sejak beberapa bulan, muncul terutama setelah makan dan saat berbaring.',
      riwayatPenyakitSekarang:
      ...
      riwayatNutrisi:
        'Pola makan terperinci: jumlah dan besar porsi, jam makan terakhir sebelum tidur, konsumsi gorengan, kopi, teh, cokelat, minuman bersoda, makanan pedas, dan kebiasaan langsung berbaring setelah makan. Pada BAYI: jenis pemberian minum (ASI atau formula), volume dan frekuensi, teknik menyusui dan pelekatan, posisi saat dan setelah minum, serta apakah disendawakan.',
      riwayatTumbuhKembang:
        'Pada bayi dan anak: kurva pertumbuhan berat dan panjang badan — regurgitasi fisiologis pada bayi TIDAK mengganggu kenaikan berat badan, sehingga bayi yang gumoh namun berat badannya naik baik dan tampak nyaman (happy spitter) tidak memerlukan terapi apa pun.',
      riwayatSosialEkonomi:
        'Kebiasaan MEROKOK dan konsumsi ALKOHOL, pekerjaan yang mengharuskan membungkuk atau mengangkat beban berat, jadwal kerja malam yang mengacaukan waktu makan, tingkat stres, aktivitas fisik, dan kemampuan menjalani terapi jangka panjang.',
    },
    pemeriksaanFisik: [
      'Tanda vital lengkap; pada GERD tanpa komplikasi umumnya normal',
      'ANTROPOMETRI: berat badan, tinggi badan, INDEKS MASSA TUBUH, dan LINGKAR PINGGANG — obesitas sentral merupakan faktor risiko yang paling dapat dimodifikasi dan penurunan berat badan merupakan intervensi dengan bukti terkuat',
      'Penilaian status gizi dan tanda penurunan berat badan yang tidak disengaja seperti baju yang menjadi longgar',
      'Konjungtiva untuk menilai anemia — anemia merupakan alarm feature yang mengarah pada perdarahan tersembunyi',
      'Pemeriksaan rongga mulut dan gigi: erosi email gigi pada permukaan palatal, halitosis, dan tanda peradangan faring posterior',
      'Pemeriksaan leher: palpasi kelenjar getah bening supraklavikula (kelenjar Virchow) dan tiroid',
      'Pemeriksaan TORAKS dan JANTUNG — wajib untuk menyingkirkan penyebab kardiak pada setiap keluhan nyeri dada; auskultasi paru untuk mengi yang dapat mencerminkan asma terkait refluks',
      'Pemeriksaan ABDOMEN: inspeksi, auskultasi bising usus, palpasi nyeri tekan epigastrium, pemeriksaan hepar dan lien, serta pencarian MASSA abdomen',
      'Colok dubur bila terdapat kecurigaan perdarahan saluran cerna untuk menilai melena',
      'Pada bayi: nilai berat badan terhadap kurva pertumbuhan, status hidrasi, tanda gagal tumbuh, serta amati proses menyusui secara langsung untuk menilai pelekatan dan posisi',
    ],
    penunjang: [
      'Pada pasien dengan gejala khas berupa heartburn dan regurgitasi TANPA alarm symptoms, diagnosis ditegakkan secara KLINIS dan pemeriksaan penunjang TIDAK diperlukan pada tahap awal',
      'UJI TERAPEUTIK PPI (PPI test): pemberian penghambat pompa proton dosis standar selama 2-4 minggu; perbaikan gejala yang bermakna mendukung diagnosis, meski uji ini tidak sepenuhnya spesifik',
      'ENDOSKOPI SALURAN CERNA ATAS diindikasikan bila: terdapat ALARM SYMPTOMS (disfagia, odinofagia, penurunan berat badan, muntah persisten, perdarahan saluran cerna, anemia, massa abdomen), usia awitan di atas 50-60 tahun terutama di daerah dengan prevalensi kanker lambung tinggi, gejala tidak membaik setelah terapi PPI adekuat, gejala kambuh berulang setelah terapi dihentikan, atau terdapat faktor risiko esofagus Barrett',
      'Endoskopi menilai derajat ESOFAGITIS dengan klasifikasi Los Angeles A sampai D, mendeteksi esofagus Barrett, striktur, ulkus, dan keganasan; perlu dipahami bahwa sekitar 60-70% pasien GERD memiliki gambaran endoskopi NORMAL (non-erosive reflux disease), sehingga endoskopi normal tidak menyingkirkan diagnosis',
      'Biopsi diambil dari lesi yang mencurigakan dan dari esofagus distal bila dicurigai esofagus Barrett atau esofagitis eosinofilik',
      'PEMANTAUAN pH ESOFAGUS 24 JAM dengan atau tanpa impedansi merupakan pemeriksaan paling objektif — diindikasikan pada gejala yang tidak respons PPI dengan endoskopi normal, dan sebelum pertimbangan operasi antirefluks; pemeriksaan tingkat rujukan',
      'MANOMETRI esofagus resolusi tinggi untuk menyingkirkan gangguan motilitas seperti akalasia dan skleroderma, serta wajib dikerjakan sebelum operasi antirefluks',
      'Pemeriksaan Helicobacter pylori (urea breath test, antigen tinja, atau biopsi) sesuai indikasi — terutama pada pasien dengan dispepsia di daerah prevalensi tinggi',
      'Darah lengkap untuk menilai anemia; tinja darah samar bila dicurigai perdarahan tersembunyi',
      'ELEKTROKARDIOGRAFI dan penanda jantung pada setiap pasien dengan NYERI DADA sebelum keluhan diatribusikan kepada GERD — menyingkirkan sindrom koroner akut adalah prioritas yang tidak boleh dibalik urutannya',
      'Barium meal esofagografi berguna untuk menilai striktur dan hernia hiatus namun sensitivitasnya rendah untuk esofagitis; pada bayi berguna untuk menyingkirkan kelainan anatomi seperti malrotasi dan stenosis pilorus',
    ],
    etiologi:
      'Gangguan sawar antirefluks pada sambungan gastroesofagus. Penyebab utamanya adalah relaksasi sementara sfingter esofagus bawah yang berlebihan dan tidak dipicu proses menelan (transient lower esophageal sphincter relaxation), disertai penurunan tonus basal sfingter, hernia hiatus yang memisahkan sfingter dari penopang krura diafragma, peningkatan tekanan intraabdomen akibat obesitas atau kehamilan, serta gangguan pengosongan lambung.',
    patofisiologi:
      'Sambungan gastroesofagus normalnya dipertahankan oleh sawar antirefluks yang terdiri atas sfingter esofagus bawah, krura diafragma yang menjepitnya dari luar, ligamentum frenoesofagus, dan sudut His yang tajam antara esofagus dan fundus lambung sehingga berfungsi sebagai katup. Pada GERD, mekanisme dominan adalah RELAKSASI SEMENTARA SFINGTER ESOFAGUS BAWAH yang terjadi terlalu sering dan tidak berkaitan dengan proses menelan — pada saat itu tekanan sfingter turun mendekati nol sehingga isi lambung yang asam bebas naik ke esofagus. Hernia hiatus memperberat keadaan dengan memindahkan sfingter ke rongga toraks sehingga terpisah dari penopang krura diafragma, sekaligus menciptakan kantong asam (acid pocket) tepat di atas sambungan yang siap mengalir balik. Obesitas sentral dan kehamilan meningkatkan tekanan intraabdomen sehingga gradien tekanan mendorong isi lambung ke atas, sekaligus memperlebar sudut His. Bahan refluksat yang merusak bukan hanya asam lambung, melainkan juga pepsin dan garam empedu yang teraspirasi dari duodenum. Kerusakan bermula pada tingkat mikroskopik berupa PELEBARAN RUANG ANTAR SEL epitel skuamosa, yang memungkinkan ion hidrogen menembus lebih dalam dan merangsang ujung saraf nosiseptif — hal ini menjelaskan mengapa pasien dapat merasakan heartburn hebat meski gambaran endoskopinya tampak normal, sehingga endoskopi yang bersih tidak boleh diartikan sebagai bukti bahwa keluhan pasien tidak nyata. Bila pajanan asam berlanjut, terjadi erosi dan ulserasi (esofagitis erosif), lalu penyembuhan dengan fibrosis yang menimbulkan STRIKTUR dan disfagia. Sebagai respons adaptif terhadap pajanan asam kronik, epitel skuamosa esofagus distal dapat mengalami METAPLASIA menjadi epitel kolumnar bertipe usus — inilah ESOFAGUS BARRETT, yang merupakan lesi prakanker dan dapat berkembang melalui displasia derajat rendah dan tinggi menjadi ADENOKARSINOMA esofagus. Rangkaian ini menjelaskan mengapa pasien dengan gejala kronik lebih dari 5-10 tahun, terutama laki-laki usia lanjut dengan obesitas, memerlukan pertimbangan skrining endoskopi meski gejalanya terkendali dengan obat. Pada gejala EKSTRAESOFAGUS, mekanismenya melibatkan mikroaspirasi refluksat ke laring dan saluran napas, serta refleks vagal esofagobronkial yang menimbulkan batuk dan bronkospasme — inilah sebabnya batuk kronik dan suara serak dapat menjadi satu-satunya manifestasi tanpa disertai heartburn sama sekali. Pada BAYI, sfingter esofagus bawah masih pendek dan belum matang, posisi tubuh lebih sering berbaring, serta asupan cairan sangat besar relatif terhadap kapasitas lambung, sehingga regurgitasi merupakan hal yang WAJAR dan akan membaik sendiri seiring pematangan sfingter dan mulainya makanan padat, umumnya sebelum usia 12-18 bulan.',
    faktorRisiko: [
      'OBESITAS dan obesitas sentral — faktor risiko terkuat sekaligus paling dapat dimodifikasi',
      'Hernia hiatus',
      'Kehamilan',
      'Merokok dan konsumsi alkohol',
      'Pola makan: porsi besar, tinggi lemak, makan larut malam, langsung berbaring setelah makan',
      'Makanan dan minuman pemicu: cokelat, kopi, teh, minuman bersoda, mint, makanan pedas, buah sitrus, dan tomat',
      'Obat: penghambat kanal kalsium, nitrat, teofilin, antikolinergik, benzodiazepin, NSAID, bifosfonat',
      'Gangguan motilitas dan pengosongan lambung: gastroparesis diabetik, skleroderma',
      'Usia lanjut',
      'Faktor genetik dan riwayat keluarga',
    ],
    goldStandard:
      'Baku emas untuk membuktikan adanya pajanan asam patologis pada esofagus adalah PEMANTAUAN pH ESOFAGUS 24 JAM dengan impedansi, yang mengukur waktu total pH esofagus di bawah 4 dan menilai korelasi antara episode refluks dengan gejala pasien. Namun pemeriksaan ini tidak dikerjakan rutin. Dalam praktik klinis, diagnosis GERD ditegakkan berdasarkan GEJALA KHAS berupa heartburn dan regurgitasi tanpa alarm symptoms, yang didukung oleh respons terhadap terapi penghambat pompa proton. ENDOSKOPI merupakan baku emas untuk menilai KOMPLIKASI — esofagitis erosif, esofagus Barrett, striktur, dan keganasan — namun bukan untuk menegakkan diagnosis GERD itu sendiri, sebab sebagian besar pasien GERD memiliki gambaran endoskopi yang normal.',
    diagnosisBanding: [
      'SINDROM KORONER AKUT dan angina pektoris — nyeri dada yang dapat sangat menyerupai GERD; harus disingkirkan LEBIH DAHULU pada setiap keluhan nyeri dada, terutama pada pasien dengan faktor risiko kardiovaskular',
      'Ulkus peptikum dan dispepsia fungsional — nyeri epigastrium lebih dominan daripada rasa terbakar retrosternal, dapat berkaitan dengan Helicobacter pylori',
      'Akalasia — DISFAGIA terhadap makanan padat DAN cair sejak awal, regurgitasi makanan yang belum tercerna dan tidak asam, penurunan berat badan',
      'Esofagitis eosinofilik — disfagia dan riwayat impaksi makanan pada pasien muda dengan latar atopi, tidak respons terhadap PPI, diagnosis melalui biopsi esofagus',
      'Esofagitis infeksi (kandida, herpes, sitomegalovirus) — odinofagia hebat pada pasien imunokompromais',
      'Esofagitis akibat obat (pil esophagitis) — nyeri menelan mendadak setelah menelan obat tertentu dengan air yang sedikit atau sambil berbaring',
      'KEGANASAN esofagus atau lambung — disfagia progresif dari padat ke cair, penurunan berat badan, anemia, usia lanjut',
      'Kolelitiasis dan pankreatitis — nyeri epigastrium menjalar ke punggung dengan pemicu makanan berlemak',
      'Gastroparesis — rasa penuh cepat, mual, dan muntah makanan lama pada penyandang diabetes',
      'Pada bayi: stenosis pilorus (muntah menyembur proyektil pada usia 3-6 minggu), malrotasi dengan volvulus, alergi protein susu sapi, dan infeksi saluran kemih',
    ],
    pengkajian:
      'Dipikirkan penyakit refluks gastroesofagus pada pasien ini atas dasar keluhan rasa terbakar retrosternal yang menjalar ke arah leher disertai regurgitasi cairan asam ke mulut, yang khas muncul setelah makan dan memberat pada posisi berbaring maupun saat membungkuk, serta mereda dengan antasida dan posisi tegak — kombinasi heartburn dan regurgitasi dengan pola pemicu posisional ini memiliki nilai diagnostik yang tinggi sehingga diagnosis dapat ditegakkan secara klinis. Latar berupa indeks massa tubuh yang meningkat dengan obesitas sentral, kebiasaan makan porsi besar menjelang tidur, serta merokok memperkuat dugaan tersebut sekaligus menunjukkan titik intervensi yang paling menentukan. Tidak ditemukannya alarm symptoms berupa kesulitan menelan, penurunan berat badan yang tidak disengaja, muntah darah, buang air besar hitam, maupun anemia menjadi dasar untuk memulai terapi empirik tanpa endoskopi terlebih dahulu. Sindrom koroner akut merupakan diagnosis banding yang paling berbahaya bila terlewat karena nyeri dada iskemik dapat sangat menyerupai heartburn, dan kesalahan mengatribusikan nyeri dada kepada lambung merupakan salah satu kekeliruan klinis yang paling merugikan; pada pasien ini nyeri jelas berhubungan dengan makan dan posisi, tidak dipicu aktivitas fisik, tidak disertai keringat dingin maupun sesak, dengan elektrokardiografi dalam batas normal. Ulkus peptikum dipertimbangkan karena sama-sama menimbulkan keluhan epigastrium, namun pada ulkus nyeri lebih terlokalisasi di epigastrium dan berkaitan dengan waktu makan tertentu, tanpa rasa terbakar yang menjalar ke atas maupun regurgitasi. Akalasia disingkirkan karena tidak ada disfagia terhadap makanan padat maupun cair dan tidak ada penurunan berat badan. Yang perlu ditekankan adalah bahwa keberhasilan jangka panjang pada pasien ini tidak ditentukan oleh penghambat pompa proton semata, melainkan oleh MODIFIKASI GAYA HIDUP — terutama penurunan berat badan, penghentian merokok, dan tidak makan dalam tiga jam sebelum berbaring — sebab obat hanya menekan produksi asam tanpa memperbaiki sawar antirefluks yang menjadi akar masalah, sehingga keluhan hampir selalu kambuh begitu obat dihentikan bila kebiasaan pemicunya tidak berubah. Selain itu, pada pasien dengan gejala kronik bertahun-tahun perlu dipertimbangkan risiko ESOFAGUS BARRETT sebagai lesi prakanker, yang justru dapat berkembang diam-diam meski keluhannya terkendali dengan obat.',
    terapiSuportif: [
      'PENURUNAN BERAT BADAN pada pasien dengan indeks massa tubuh berlebih — intervensi gaya hidup dengan bukti PALING KUAT; penurunan 5-10% berat badan saja sudah memberikan perbaikan gejala bermakna',
      'MENINGGIKAN KEPALA TEMPAT TIDUR 15-20 cm dengan mengganjal kaki tempat tidur bagian kepala, BUKAN dengan menumpuk bantal yang justru melipat perut dan meningkatkan tekanan intraabdomen',
      'Tidur MIRING KE KIRI — secara anatomis menempatkan sambungan gastroesofagus di atas permukaan cairan lambung',
      'BERHENTI MEROKOK dan menghentikan konsumsi alkohol',
      'Tidak makan dalam 3 JAM sebelum berbaring atau tidur',
      'Makan porsi KECIL namun lebih sering, dan makan perlahan',
      'Hindari pakaian dan ikat pinggang yang ketat pada perut',
      'Hindari membungkuk dan mengangkat beban berat segera setelah makan',
      'Permen karet bebas gula setelah makan dapat meningkatkan produksi saliva yang membantu menetralkan asam',
      'Kelola stres dan cukupi waktu tidur',
    ],
    tatalaksana: [
      'PENGHAMBAT POMPA PROTON (PPI) merupakan terapi lini pertama yang paling efektif — omeprazol 20 mg, lansoprazol 30 mg, pantoprazol 40 mg, esomeprazol 20-40 mg, atau rabeprazol 20 mg, SEKALI SEHARI',
      'CARA MINUM SANGAT MENENTUKAN: PPI diminum 30-60 MENIT SEBELUM MAKAN, umumnya sebelum sarapan, karena obat ini hanya menghambat pompa proton yang sedang aktif; kegagalan terapi PPI paling sering disebabkan cara minum yang salah, bukan karena obatnya tidak manjur',
      'Durasi terapi awal 4-8 MINGGU, kemudian dievaluasi; pada esofagitis erosif derajat C dan D diberikan 8 minggu dilanjutkan terapi rumatan',
      'Bila respons belum memadai setelah 8 minggu, tingkatkan menjadi DUA KALI SEHARI (sebelum sarapan dan sebelum makan malam) sebelum menyimpulkan sebagai refrakter',
      'Setelah gejala terkendali, turunkan ke dosis efektif TERENDAH atau pemakaian sesuai kebutuhan (on-demand); pada esofagitis berat dan esofagus Barrett, terapi rumatan jangka panjang tetap diperlukan',
      'Hentikan PPI secara BERTAHAP — penghentian mendadak menimbulkan rebound hipersekresi asam yang membuat gejala kambuh sementara dan sering disalahartikan sebagai kegagalan penyapihan',
      'ANTAGONIS RESEPTOR H2 seperti ranitidin (bila tersedia dan sesuai regulasi setempat) atau famotidin 20-40 mg dua kali sehari sebagai alternatif pada gejala ringan, atau ditambahkan pada malam hari untuk mengatasi nocturnal acid breakthrough',
      'ANTASIDA dan alginat untuk gejala sesekali dan sebagai pereda cepat — alginat membentuk lapisan pelindung di atas isi lambung dan bermanfaat pada refluks pascamakan; diminum 1 jam setelah makan dan sebelum tidur',
      'Prokinetik seperti domperidon 3 x 10 mg dapat dipertimbangkan bila terdapat gejala pengosongan lambung yang lambat, namun BUKAN terapi rutin dan penggunaan jangka panjang perlu kehati-hatian karena risiko pemanjangan interval QT',
      'HENTIKAN atau ganti obat yang memperberat refluks bila memungkinkan',
      'Eradikasi Helicobacter pylori bila terbukti positif, terutama pada pasien dengan riwayat ulkus peptikum',
      'PADA KEHAMILAN: mulai dengan modifikasi gaya hidup dan antasida yang tidak mengandung natrium bikarbonat; sukralfat aman; bila perlu, antagonis H2 dan PPI (omeprazol dan lansoprazol memiliki data keamanan yang memadai) dapat digunakan dengan pertimbangan manfaat-risiko',
      'PADA BAYI dengan regurgitasi fisiologis (happy spitter) yang berat badannya naik baik: TIDAK diberikan obat apa pun — cukup edukasi orang tua, perbaikan teknik menyusui, pemberian minum dengan volume lebih kecil namun lebih sering, menyendawakan setelah minum, dan mempertahankan posisi tegak 20-30 menit setelah minum',
      'Pada bayi dengan gejala bermakna: pertimbangkan uji eliminasi protein susu sapi selama 2-4 minggu (ibu menyusui menghindari produk susu, atau ganti ke formula terhidrolisat ekstensif) sebelum mempertimbangkan obat penekan asam, karena alergi protein susu sapi sering menyerupai GERD',
      'PPI pada bayi dan anak diberikan hanya atas indikasi jelas dan tidak untuk regurgitasi tanpa komplikasi, karena penggunaannya berkaitan dengan peningkatan risiko infeksi saluran napas dan saluran cerna',
      'RUJUK ke spesialis penyakit dalam atau gastroenterologi bila: terdapat alarm symptoms, gagal terapi PPI dua kali sehari selama 8 minggu, kekambuhan cepat setelah terapi dihentikan, dicurigai esofagus Barrett, atau gejala ekstraesofagus yang tidak membaik',
      'Operasi antirefluks (fundoplikasi Nissen) atau prosedur endoskopik dipertimbangkan pada pasien yang terbukti GERD secara objektif namun tidak dapat atau tidak bersedia mengonsumsi PPI jangka panjang, atau dengan hernia hiatus besar — wajib didahului manometri dan pemantauan pH',
    ],
    edukasi: [
      'Jelaskan bahwa GERD merupakan penyakit KRONIK dan cenderung KAMBUH — tujuan terapi adalah mengendalikan gejala dan mencegah komplikasi, bukan menyembuhkan sekali untuk selamanya; oleh karena itu perubahan gaya hidup jauh lebih menentukan daripada obat',
      'CARA MINUM OBAT: PPI harus diminum 30-60 menit SEBELUM makan pagi dalam keadaan perut kosong — ini adalah pesan edukasi terpenting karena kesalahan cara minum merupakan penyebab kegagalan terapi yang paling sering',
      'Jangan menghentikan PPI secara mendadak; penyapihan dilakukan bertahap sesuai anjuran dokter',
      'JADWAL MAKAN: 3 kali makan utama dengan 2 kali selingan, jarak antar waktu makan 3-4 jam, MAKAN TERAKHIR minimal 3 JAM sebelum berbaring atau tidur; jangan melewatkan waktu makan lalu makan dalam porsi sangat besar',
      'PORSI MAKAN: gunakan piring yang lebih kecil, isi setengah piring dengan sayur, seperempat karbohidrat, dan seperempat protein; makan perlahan dan kunyah dengan baik; berhenti sebelum merasa terlalu kenyang',
      'MAKANAN YANG DIHINDARI bila terbukti memicu keluhan pada diri sendiri: gorengan dan makanan berlemak, cokelat, kopi dan teh kental, minuman bersoda, mint, makanan sangat pedas, jeruk dan tomat, serta alkohol — tidak semua orang memiliki pemicu yang sama, sehingga catat makanan yang menimbulkan gejala pada diri Anda sendiri',
      'JAM TIDUR: tidur 7-8 jam per malam dengan kepala tempat tidur ditinggikan 15-20 cm dengan mengganjal kaki tempat tidur (bukan dengan menumpuk bantal), dan usahakan tidur MIRING KE KIRI',
      'POLA OLAHRAGA: aktivitas aerobik intensitas sedang seperti jalan cepat atau bersepeda 30 menit sebanyak 5 kali per minggu untuk membantu penurunan berat badan; HINDARI olahraga yang melibatkan membungkuk, sit-up, dan angkat beban berat segera setelah makan — beri jeda minimal 2 jam setelah makan sebelum berolahraga',
      'PENURUNAN BERAT BADAN: target penurunan 5-10% dari berat badan awal secara bertahap 0,5-1 kg per minggu; ini merupakan intervensi tunggal yang paling efektif pada pasien dengan berat badan berlebih',
      'BERHENTI MEROKOK — nikotin melemahkan katup antara lambung dan kerongkongan',
      'Follow up: kontrol 4-8 minggu setelah memulai terapi untuk menilai respons; bila membaik, dosis diturunkan bertahap; bila tidak membaik, evaluasi ulang cara minum obat sebelum menyimpulkan kegagalan terapi',
      'PADA ORANG TUA BAYI: jelaskan bahwa gumoh adalah hal WAJAR pada bayi sehat, dialami sebagian besar bayi, dan akan hilang sendiri sebelum usia 1-1,5 tahun seiring pematangan otot lambung; selama berat badan bayi naik baik dan bayi tampak nyaman, tidak diperlukan obat apa pun. Perbaiki teknik menyusui, berikan minum dengan volume lebih kecil namun lebih sering, sendawakan bayi setelah minum, dan pertahankan posisi tegak 20-30 menit setelah minum. JANGAN menidurkan bayi dalam posisi tengkurap untuk mengatasi gumoh karena meningkatkan risiko sindrom kematian bayi mendadak',
      'SEGERA kembali bila: sulit atau nyeri menelan, makanan terasa tersangkut, muntah darah atau muntah seperti ampas kopi, buang air besar berwarna hitam seperti aspal, berat badan turun tanpa sebab, muntah terus-menerus, atau nyeri dada disertai keringat dingin dan sesak. Pada bayi: muntah menyembur berulang, muntah berwarna hijau, berat badan tidak naik atau turun, menolak minum, tampak sangat rewel, atau terdapat darah pada muntahan maupun tinja',
    ],
    komplikasi: [
      'Esofagitis erosif dengan berbagai derajat keparahan',
      'STRIKTUR esofagus akibat fibrosis penyembuhan, menimbulkan disfagia progresif terhadap makanan padat',
      'Ulkus esofagus dengan risiko perdarahan dan anemia defisiensi besi',
      'ESOFAGUS BARRETT — metaplasia intestinal sebagai lesi prakanker yang memerlukan surveilans endoskopi berkala',
      'ADENOKARSINOMA esofagus — komplikasi paling ditakuti meski jarang, berkembang melalui jalur Barrett dan displasia',
      'Komplikasi ekstraesofagus: laringitis refluks, batuk kronik, perburukan asma, sinusitis kronik, dan erosi email gigi',
      'Pneumonia aspirasi, terutama pada usia lanjut dan pasien dengan gangguan menelan',
      'Gangguan tidur kronik dan penurunan kualitas hidup',
      'Efek samping PPI jangka panjang yang perlu ditimbang: peningkatan risiko infeksi Clostridioides difficile dan pneumonia, hipomagnesemia, defisiensi vitamin B12, serta kaitan dengan fraktur osteoporotik pada penggunaan bertahun-tahun',
      'Pada bayi dengan GERD patologis: gagal tumbuh, esofagitis, anemia, dan pneumonia aspirasi berulang',
    ],
    prognosis:
      'Baik untuk pengendalian gejala — sebagian besar pasien mengalami perbaikan bermakna dengan kombinasi modifikasi gaya hidup dan penghambat pompa proton. Namun GERD merupakan penyakit KRONIK dengan kecenderungan kambuh yang tinggi: sekitar 70-80% pasien mengalami kekambuhan dalam satu tahun setelah terapi dihentikan bila faktor gaya hidupnya tidak diperbaiki. Prognosis jangka panjang ditentukan oleh keberhasilan menurunkan berat badan, menghentikan merokok, dan mengatur waktu makan — bukan oleh pilihan merek obat. Komplikasi serius berupa esofagus Barrett terjadi pada sekitar 5-15% pasien GERD kronik, dan risiko progresi Barrett menjadi adenokarsinoma sekitar 0,1-0,5% per tahun, sehingga surveilans endoskopi berkala pada kelompok ini bernilai penting. Pada BAYI prognosis sangat baik: regurgitasi fisiologis membaik spontan pada lebih dari 90% bayi sebelum usia 12-18 bulan tanpa memerlukan pengobatan apa pun.',
    referensi: ['SKDI2012', 'ACGGERD2022', 'PPKFKTP2014', 'SLEISENGER2021', 'PAPDI2014'],
  },
  ...
  'Penyakit cacing tambang': {
    definisi:
      'Infeksi usus oleh nematoda Ancylostoma duodenale atau Necator americanus, cacing yang MENEMPEL pada mukosa usus halus dan MENGISAP DARAH secara terus-menerus. Berbeda dengan askariasis yang menimbulkan malnutrisi melalui persaingan nutrien, cacing tambang menyebabkan kehilangan darah kronik sehingga manifestasi utamanya adalah ANEMIA DEFISIENSI BESI — menjadikannya penyebab anemia kecacingan paling penting di daerah tropis dan penyebab utama anemia defisiensi besi pada perempuan usia subur dan anak di negara berkembang.',
    anamnesis: {
      keluhanUtama:
        'Badan terasa lemah, cepat lelah, dan pucat sejak beberapa bulan, disertai jantung sering berdebar bila beraktivitas.',
      riwayatPenyakitSekarang:
      ...
      riwayatNutrisi:
        'Asupan sumber zat besi hewani (daging merah, hati, ikan) yang penyerapannya jauh lebih baik dibanding sumber nabati, konsumsi TEH atau KOPI bersamaan dengan makan yang menghambat penyerapan besi, asupan vitamin C yang meningkatkan penyerapan, pola makan vegetarian, dan riwayat penurunan berat badan.',
      riwayatTumbuhKembang:
        'Pada anak: kurva pertumbuhan berat dan tinggi badan, pencapaian perkembangan, kemampuan konsentrasi, dan prestasi belajar — anemia defisiensi besi pada masa pertumbuhan menimbulkan gangguan kognitif yang sebagian bersifat menetap.',
      riwayatSosialEkonomi:
        'PEKERJAAN yang menjadi kunci pada penyakit ini: petani, pekerja perkebunan (khususnya karet, kelapa sawit, dan teh), penambang, dan pekerja yang kontak dengan tanah lembap; kebiasaan BEKERJA TANPA ALAS KAKI; ketersediaan jamban dan kebiasaan buang air besar sembarangan; kebiasaan anak bermain di tanah tanpa alas kaki; sumber air bersih; kepadatan hunian; kemampuan membeli makanan sumber protein hewani; serta akses terhadap program pemberian obat cacing.',
    },
    pemeriksaanFisik: [
      'Tanda vital: perhatikan TAKIKARDIA dan tekanan nadi yang melebar sebagai kompensasi anemia; frekuensi napas meningkat pada anemia berat',
      'Keadaan umum: pasien tampak PUCAT dan lemah, namun sering masih tampak tenang karena adaptasi kronik',
      'PENILAIAN ANEMIA secara sistematis: konjungtiva palpebra PUCAT, mukosa bibir dan lidah pucat, telapak tangan pucat, dan pucat pada dasar kuku',
      'Tanda DEFISIENSI BESI yang lebih spesifik: KOILONIKIA (kuku berbentuk sendok dan rapuh), atrofi papil lidah sehingga lidah tampak licin dan terasa perih, angular cheilitis atau stomatitis angularis pada sudut bibir, serta rambut kering dan mudah patah',
      'ANTROPOMETRI: berat badan, tinggi badan, indeks massa tubuh pada dewasa; pada anak plot BB/U, TB/U, dan BB/TB dengan Z-score menurut standar WHO atau CDC',
      'Pemeriksaan JANTUNG: takikardia, dan pada anemia berat dapat terdengar BISING SISTOLIK EJEKSI derajat rendah di seluruh area katup akibat aliran darah hiperdinamik — bising ini bersifat fungsional dan menghilang setelah anemia terkoreksi',
      'Tanda GAGAL JANTUNG pada anemia sangat berat: peningkatan tekanan vena jugularis, ronki basah di basal paru, hepatomegali, dan EDEMA TUNGKAI — kombinasi anemia berat dengan edema pada pekerja perkebunan merupakan gambaran klasik cacing tambang',
      'Pemeriksaan ABDOMEN: nyeri tekan epigastrium ringan, hepatosplenomegali (bila ada, pikirkan penyebab lain seperti talasemia atau malaria)',
      'Pemeriksaan KULIT KAKI dan sela jari: ruam papulovesikuler eritematosa yang gatal (ground itch) pada infeksi baru, serta bekas garukan dan infeksi sekunder',
      'Pemeriksaan paru untuk mengi dan ronki pada fase migrasi larva',
      'Colok dubur untuk menilai warna tinja dan menyingkirkan penyebab perdarahan lain bila diperlukan',
    ],
    penunjang: [
      'PEMERIKSAAN TINJA: ditemukannya TELUR cacing tambang menegakkan diagnosis; telur berbentuk oval dengan dinding tipis transparan berisi 4-8 sel blastomer, dan secara mikroskopis telur A. duodenale serta N. americanus TIDAK DAPAT dibedakan',
      'Penting: tinja harus diperiksa SEGERA (dalam beberapa jam), sebab bila dibiarkan pada suhu ruang telur akan menetas menjadi larva sehingga dapat keliru diidentifikasi sebagai Strongyloides — kesalahan ini berkonsekuensi karena kedua infeksi memerlukan obat yang berbeda',
      'Metode Kato-Katz sebagai teknik kuantitatif untuk menentukan intensitas: ringan 1-1.999, sedang 2.000-3.999, dan berat 4.000 atau lebih telur per gram tinja',
      'Metode konsentrasi dan biakan Harada-Mori meningkatkan sensitivitas pada infeksi ringan',
      'DARAH LENGKAP: anemia MIKROSITIK HIPOKROM dengan penurunan MCV dan MCH; hitung eosinofil MENINGKAT terutama pada fase awal infeksi — kombinasi anemia mikrositik dengan eosinofilia sangat sugestif ke arah kecacingan dan membedakannya dari defisiensi besi akibat sebab lain',
      'Apusan darah tepi: eritrosit mikrositik hipokrom dengan anisositosis dan poikilositosis, sel pensil, dan eosinofilia',
      'PROFIL BESI: feritin serum RENDAH (penanda paling awal dan paling spesifik untuk cadangan besi, meski merupakan reaktan fase akut yang dapat meningkat palsu saat inflamasi), besi serum rendah, kapasitas ikat besi total (TIBC) MENINGKAT, dan saturasi transferin menurun',
      'Tinja darah samar positif akibat kehilangan darah kronik dari lokasi perlekatan cacing',
      'Elektroforesis hemoglobin bila anemia mikrositik tidak membaik dengan besi atau terdapat riwayat keluarga, untuk menyingkirkan TALASEMIA',
      'Pemeriksaan tambahan sesuai konteks: apusan darah tepi untuk malaria di daerah endemis, dan pemeriksaan sumber perdarahan lain (endoskopi, kolonoskopi) pada dewasa usia lanjut dengan anemia defisiensi besi yang tidak sepenuhnya dijelaskan oleh kecacingan',
    ],
    etiologi:
      'Necator americanus (spesies dominan di sebagian besar daerah tropis termasuk Indonesia) dan Ancylostoma duodenale. Keduanya merupakan soil-transmitted helminth, namun berbeda dengan Ascaris yang ditularkan melalui telur yang tertelan, cacing tambang menular melalui LARVA FILARIFORM yang MENEMBUS KULIT UTUH — umumnya kulit kaki dan sela jari yang bersentuhan dengan tanah lembap yang tercemar tinja. A. duodenale juga dapat menular melalui jalur oral dan transmamari melalui air susu ibu.',
    patofisiologi:
    ...
    faktorRisiko: [
      ...
      'Status sosial ekonomi rendah dan tingkat pendidikan terbatas',
      'Asupan zat besi yang rendah, terutama kurangnya sumber protein hewani',
      'Kehamilan dan perempuan usia subur dengan menstruasi banyak — kebutuhan besi tinggi memperberat dampak kehilangan darah',
      'Penggunaan tinja manusia sebagai pupuk',
    ],
    goldStandard:
      'Baku emas diagnosis adalah DITEMUKANNYA TELUR cacing tambang pada pemeriksaan mikroskopis tinja, dengan metode Kato-Katz sebagai teknik kuantitatif rujukan yang menentukan intensitas infeksi dalam telur per gram tinja. Diagnosis lengkap memerlukan penilaian dampaknya, yaitu pembuktian ANEMIA DEFISIENSI BESI melalui darah lengkap yang menunjukkan anemia mikrositik hipokrom disertai profil besi berupa feritin serum rendah, besi serum rendah, dan TIBC yang meningkat. Perlu diperhatikan bahwa pemeriksaan tinja harus dikerjakan segera setelah pengambilan, sebab telur yang menetas menjadi larva pada sampel yang lama dapat keliru diidentifikasi sebagai Strongyloides stercoralis.',
    diagnosisBanding: [
      'Anemia defisiensi besi akibat sebab lain: asupan besi kurang, menoragia, perdarahan saluran cerna karena ulkus peptikum atau hemoroid, dan KEGANASAN KOLOREKTAL yang wajib disingkirkan pada dewasa di atas 50 tahun dengan anemia defisiensi besi',
      'TALASEMIA dan hemoglobinopati lain — sama-sama anemia mikrositik, namun feritin NORMAL atau MENINGKAT, terdapat riwayat keluarga, dan indeks Mentzer (MCV dibagi jumlah eritrosit) kurang dari 13 lebih mengarah ke talasemia',
      'Anemia penyakit kronik — umumnya normositik normokrom, feritin normal atau meningkat dengan TIBC yang justru menurun',
      'Infeksi kecacingan lain: askariasis (menonjolkan malnutrisi dan nyeri perut, bukan anemia berat), trikuriasis (disentri dan prolaps rekti), dan strongiloidiasis (larva currens dan risiko hiperinfeksi)',
      'Malaria pada daerah endemis — anemia dengan demam periodik dan splenomegali',
      'Malnutrisi energi-protein dan defisiensi mikronutrien lain termasuk defisiensi vitamin B12 dan asam folat (menimbulkan anemia MAKROSITIK)',
      'Anemia pada penyakit ginjal kronik',
      'Perdarahan saluran cerna tersembunyi akibat penggunaan NSAID',
    ],
    pengkajian:
      'Dipikirkan penyakit cacing tambang pada pasien ini atas dasar keluhan lemah, cepat lelah, dan pucat yang berlangsung sangat perlahan selama berbulan-bulan, disertai jantung berdebar saat beraktivitas, pada seorang petani yang terbiasa BEKERJA TANPA ALAS KAKI di tanah kebun dan tinggal di lingkungan tanpa jamban — kombinasi anemia kronik dengan riwayat pajanan tanah tanpa alas kaki merupakan petunjuk yang sangat kuat. Pemeriksaan fisik menemukan konjungtiva sangat pucat, koilonikia, dan atrofi papil lidah yang khas untuk defisiensi besi yang telah berlangsung lama, disertai takikardia dan bising sistolik ejeksi fungsional sebagai tanda kompensasi jantung terhadap anemia. Pemeriksaan darah menunjukkan anemia mikrositik hipokrom dengan feritin serum yang rendah dan TIBC yang meningkat sehingga memastikan defisiensi besi, sementara ditemukannya EOSINOFILIA bersamaan dengan gambaran tersebut mengarahkan penyebabnya kepada infeksi kecacingan dan bukan sekadar kekurangan asupan; diagnosis dipastikan oleh ditemukannya telur cacing tambang berdinding tipis dengan blastomer pada pemeriksaan tinja. Talasemia menjadi pembanding penting karena sama-sama menimbulkan anemia mikrositik hipokrom dan sering ditemukan di Indonesia, namun pada talasemia kadar feritin justru normal atau meningkat, terdapat riwayat keluarga dan anemia sejak masa kanak, serta jumlah eritrosit relatif tinggi dibanding derajat anemianya — pembedaan ini sangat penting sebab memberikan besi kepada penyandang talasemia justru berbahaya karena menambah beban besi yang sudah berlebih. Askariasis dipertimbangkan sebagai infeksi kecacingan penyerta yang sangat sering terjadi bersamaan, namun askariasis tidak menjelaskan anemia seberat ini karena cacing gelang tidak mengisap darah. Yang wajib dipikirkan pada pasien dewasa dengan anemia defisiensi besi, terlebih bila berusia di atas 50 tahun, adalah KEGANASAN KOLOREKTAL sebagai sumber perdarahan tersembunyi — menemukan telur cacing pada tinja TIDAK boleh dijadikan alasan untuk berhenti mencari penyebab lain bila derajat anemia tidak sebanding dengan intensitas infeksi atau bila anemia tidak membaik setelah cacing diobati dan besi diberikan dengan benar. Perlu ditekankan pula bahwa pengobatan pasien ini terdiri atas DUA komponen yang sama pentingnya dan sering hanya dikerjakan separuh: albendazol untuk membunuh cacing, DAN suplementasi besi selama minimal 3 bulan SETELAH hemoglobin normal untuk mengisi kembali cadangan besi tubuh — menghentikan besi begitu hemoglobin membaik berarti meninggalkan cadangan yang masih kosong sehingga anemia akan kembali dalam hitungan bulan. Terakhir, pada anemia berat yang sudah lama, transfusi bila diperlukan harus diberikan perlahan dengan pemantauan ketat karena volume plasma pasien sudah meningkat sebagai kompensasi sehingga sangat rentan mengalami kelebihan beban cairan.',
    terapiSuportif: [
      'SUPLEMENTASI ZAT BESI merupakan komponen terapi yang sama pentingnya dengan obat cacing',
      'Dewasa: ferro sulfat 200 mg (setara 60-65 mg besi elemental) 1-3 kali sehari, atau ferro fumarat/glukonat dengan dosis setara',
      'Anak: 3-6 mg besi elemental per kilogram berat badan per hari, dibagi 1-2 dosis',
      'Diminum saat PERUT KOSONG (1 jam sebelum atau 2 jam setelah makan) bersama sumber VITAMIN C seperti air jeruk untuk meningkatkan penyerapan; bila menimbulkan mual, boleh diminum bersama makanan meski penyerapan sedikit berkurang',
      'HINDARI meminum besi bersamaan dengan TEH, KOPI, SUSU, antasida, kalsium, dan makanan tinggi serat karena semuanya menghambat penyerapan — beri jarak minimal 2 jam',
      'LANJUTKAN besi selama MINIMAL 3 BULAN SETELAH hemoglobin mencapai normal untuk mengisi kembali cadangan besi — inilah kesalahan paling sering, yaitu menghentikan besi begitu hemoglobin membaik',
      'Perbaikan gizi dengan makanan kaya zat besi hewani: hati, daging merah, ikan, telur; ditambah sumber nabati seperti bayam dan kacang-kacangan yang dikonsumsi bersama sumber vitamin C',
      'Suplementasi asam folat, terutama pada ibu hamil',
      'Pemberian obat cacing dan tablet tambah darah rutin pada ibu hamil di daerah endemis sesuai program',
      'Pengobatan infeksi penyerta seperti malaria bila ada',
    ],
    tatalaksana: [
      'ALBENDAZOL 400 mg per oral DOSIS TUNGGAL merupakan pilihan utama untuk dewasa dan anak berusia 2 tahun atau lebih; pada anak usia 12-24 bulan diberikan 200 mg dosis tunggal',
      'Albendazol memiliki efikasi yang lebih baik daripada mebendazol terhadap cacing tambang, sehingga menjadi pilihan yang lebih disukai',
      'MEBENDAZOL sebagai alternatif: 100 mg dua kali sehari selama 3 HARI (regimen 3 hari lebih efektif daripada dosis tunggal 500 mg untuk cacing tambang)',
      'Pirantel pamoat 10 mg/kgBB per hari selama 3 hari merupakan alternatif, terutama bila benzimidazol tidak tersedia atau pada kehamilan',
      'Pada infeksi BERAT, pertimbangkan mengulang albendazol setelah 2 minggu',
      'TRANSFUSI PACKED RED CELL hanya diberikan atas indikasi ketat: hemoglobin kurang dari 5 g/dL, atau hemoglobin kurang dari 7 g/dL disertai tanda dekompensasi berupa gagal jantung, sesak saat istirahat, atau gangguan kesadaran',
      'Bila transfusi diperlukan pada anemia KRONIK berat, berikan PERLAHAN — satu unit dalam 4 jam dengan pemantauan ketat, pertimbangkan pemberian furosemid, karena volume plasma yang sudah meningkat membuat pasien sangat rentan mengalami kelebihan beban cairan dan edema paru',
      'Pada KEHAMILAN: hindari albendazol dan mebendazol pada TRIMESTER PERTAMA; pada trimester kedua dan ketiga, WHO merekomendasikan pemberian obat cacing pada ibu hamil di daerah endemis dengan prevalensi tinggi karena manfaatnya terhadap anemia maternal dan luaran kehamilan melebihi risikonya; suplementasi besi dan asam folat wajib diberikan',
      'PEMBERIAN OBAT CACING MASSAL sesuai program: albendazol 400 mg dosis tunggal DUA KALI SETAHUN pada daerah dengan prevalensi 50% atau lebih, dan SEKALI SETAHUN bila prevalensi 20-49%, mencakup anak usia prasekolah dan sekolah, perempuan usia subur termasuk ibu hamil trimester kedua dan ketiga serta ibu menyusui, dan pekerja berisiko tinggi',
      'PERIKSA ULANG tinja dan hemoglobin 2-4 minggu setelah pengobatan; kenaikan hemoglobin yang diharapkan setelah terapi besi adekuat adalah sekitar 1-2 g/dL dalam 4 minggu',
      'Bila hemoglobin TIDAK MEMBAIK setelah 4 minggu terapi besi yang diminum dengan benar, evaluasi ulang: kepatuhan minum obat, cara minum yang salah, perdarahan yang masih berlangsung dari sumber lain, malabsorpsi, atau diagnosis alternatif seperti talasemia — jangan sekadar menambah dosis besi',
      'RUJUK bila: anemia sangat berat dengan tanda gagal jantung, tidak respons terhadap terapi adekuat, dicurigai keganasan sebagai sumber perdarahan (terutama dewasa di atas 50 tahun dengan anemia defisiensi besi), atau dicurigai talasemia',
    ],
    edukasi: [
      'Jelaskan bahwa penyebab lemas dan pucat adalah CACING YANG MENGISAP DARAH di usus, dan cacing masuk melalui KULIT KAKI yang menginjak tanah tercemar — bukan tertelan; pemahaman ini menjadi dasar mengapa memakai alas kaki adalah pencegahan yang paling utama',
      'GUNAKAN ALAS KAKI setiap kali keluar rumah, bekerja di kebun atau sawah, dan saat anak bermain di tanah; gunakan sarung tangan saat mengolah tanah',
      'GUNAKAN JAMBAN untuk buang air besar dan jangan buang air besar di kebun atau tanah — telur cacing di tinja adalah sumber pencemaran tanah',
      'Cuci tangan dengan sabun dan air mengalir sebelum makan dan setelah buang air besar; cuci kaki dengan sabun setelah bekerja di tanah',
      'CARA MINUM TABLET TAMBAH DARAH: diminum saat perut kosong bersama air jeruk atau buah kaya vitamin C; JANGAN diminum bersama teh, kopi, atau susu karena akan menghambat penyerapan — beri jarak minimal 2 jam',
      'Tinja akan berwarna HITAM setelah minum tablet besi dan hal ini NORMAL, bukan pertanda perdarahan; bila mual, minumlah setelah makan',
      'JANGAN BERHENTI minum tablet besi begitu merasa lebih segar — obat harus diteruskan minimal 3 bulan setelah kadar darah normal untuk mengisi kembali cadangan besi tubuh; berhenti terlalu dini membuat anemia kembali dalam beberapa bulan',
      'Jadwal dan porsi makan: 3 kali makan utama dan 2 kali selingan; perbanyak sumber zat besi hewani seperti hati ayam, daging, dan ikan yang jauh lebih mudah diserap tubuh dibanding sayuran; sertakan buah kaya vitamin C seperti jeruk, jambu, dan pepaya pada setiap kali makan; jangan minum teh atau kopi dalam waktu 2 jam sekitar waktu makan',
      'Jam tidur: tidur cukup 7-8 jam per malam bagi dewasa dan 9-11 jam bagi anak usia sekolah untuk membantu pemulihan',
      'Pola olahraga: selama anemia masih berat, batasi aktivitas berat dan istirahat cukup; setelah kadar darah membaik, mulai kembali aktivitas secara BERTAHAP — jangan langsung bekerja berat karena jantung masih dalam masa pemulihan',
      'OBAT CACING BERKALA setiap 6 bulan untuk seluruh keluarga di daerah endemis',
      'Pada ibu hamil: minum tablet tambah darah setiap hari selama kehamilan sesuai anjuran, dan periksa kehamilan secara teratur',
      'Follow up: kontrol 4 minggu untuk periksa ulang kadar hemoglobin, dan periksa ulang tinja 2-4 minggu setelah minum obat cacing',
      'SEGERA kembali bila: sesak napas saat istirahat, kaki bengkak, dada berdebar hebat, pingsan, muntah darah, buang air besar hitam seperti aspal atau berdarah, atau kondisi justru memburuk meski sudah minum obat',
    ],
    komplikasi: [
      'ANEMIA DEFISIENSI BESI BERAT dengan gagal jantung curah tinggi (high-output heart failure)',
      'Hipoalbuminemia dan EDEMA ANASARKA akibat kehilangan protein melalui usus pada infestasi berat',
      'Hambatan PERTUMBUHAN dan perkembangan fisik pada anak',
      'GANGGUAN KOGNITIF, penurunan konsentrasi, dan prestasi belajar yang menurun — sebagian dapat bersifat menetap bila terjadi pada masa perkembangan otak',
      'Penurunan produktivitas kerja dan kapasitas fisik pada orang dewasa, dengan dampak ekonomi yang bermakna pada masyarakat pertanian',
      'Pada KEHAMILAN: anemia maternal berat, berat lahir rendah, kelahiran prematur, peningkatan risiko perdarahan pascapersalinan, dan peningkatan kematian ibu serta perinatal',
      'Infeksi sekunder pada lesi kulit tempat masuknya larva',
      'Kelebihan beban cairan dan edema paru akibat transfusi yang diberikan terlalu cepat pada anemia kronik berat',
      'Penurunan respons imun sehingga meningkatkan kerentanan terhadap infeksi lain',
    ],
    prognosis:
      'Sangat baik bila kedua komponen terapi dikerjakan dengan lengkap: pemberantasan cacing dengan albendazol yang menyembuhkan sebagian besar kasus, disertai suplementasi besi yang cukup lama untuk memulihkan cadangan besi tubuh. Kadar hemoglobin umumnya mulai naik dalam 2-4 minggu dan kembali normal dalam 2-3 bulan, namun cadangan besi memerlukan tambahan 3 bulan lagi untuk terisi kembali. Prognosis memburuk pada anemia sangat berat yang sudah disertai gagal jantung, serta pada ibu hamil yang datang terlambat. Sebagaimana pada kecacingan lain, tantangan sesungguhnya adalah REINFEKSI — selama pekerja masih berjalan tanpa alas kaki di tanah yang tercemar dan buang air besar sembarangan masih berlangsung, angka infeksi kembali ke tingkat semula dalam waktu 6-12 bulan. Oleh karena itu prognosis jangka panjang pada tingkat individu maupun masyarakat ditentukan oleh penggunaan alas kaki, penyediaan jamban, dan keberlanjutan program pemberian obat cacing berkala, bukan oleh keberhasilan pengobatan satu episode. Dampak jangka panjang berupa gangguan kognitif pada anak yang mengalami anemia berat berkepanjangan dapat bersifat sebagian menetap, sehingga deteksi dan pengobatan dini pada kelompok usia ini bernilai jauh melebihi pengobatan pada orang dewasa.',
    referensi: ['SKDI2012', 'WHOSTH2020', 'PPKFKTP2014', 'HARRISON2022', 'HOFFBRAND2019'],
  },
  'Strongiloidiasis': {
  ...
  'Askariasis': {
    definisi:
      'Infeksi usus oleh cacing gelang Ascaris lumbricoides, nematoda usus terbesar pada manusia dengan panjang dewasa 15-35 cm. Merupakan infeksi kecacingan yang ditularkan melalui tanah (soil-transmitted helminth) yang paling banyak menjangkiti manusia di dunia, dengan perkiraan lebih dari 800 juta orang terinfeksi, dan menjadi masalah kesehatan masyarakat penting pada anak usia sekolah di daerah dengan sanitasi buruk.',
    anamnesis: {
      keluhanUtama:
        'Anak mengeluarkan cacing panjang berwarna putih kekuningan saat buang air besar, disertai perut sering terasa sakit dan nafsu makan menurun.',
      riwayatPenyakitSekarang:
      ...
      riwayatTumbuhKembang:
        'Pada anak: kurva pertumbuhan berat badan dan tinggi badan, pencapaian perkembangan, kemampuan konsentrasi, dan prestasi belajar — askariasis berat pada anak menimbulkan hambatan pertumbuhan dan gangguan kognitif yang dapat menetap.',
      riwayatImunisasi: 'Kelengkapan imunisasi dasar sesuai usia dan riwayat mengikuti program pemberian obat cacing di sekolah atau posyandu.',
      riwayatSosialEkonomi:
        'Ketersediaan JAMBAN keluarga dan kebiasaan buang air besar sembarangan di kebun atau sungai, sumber air bersih untuk minum dan mencuci, kebiasaan mencuci tangan dengan sabun sebelum makan dan setelah buang air besar, kebiasaan anak bermain di tanah tanpa alas kaki, kebiasaan memotong kuku, penggunaan tinja manusia sebagai pupuk kebun, kepadatan hunian, tingkat pendidikan orang tua, dan kemampuan mengakses obat cacing.',
    },
    pemeriksaanFisik: [
      'Tanda vital lengkap dan penilaian keadaan umum',
      'ANTROPOMETRI pada anak: berat badan, tinggi atau panjang badan, lingkar kepala, dan lingkar lengan atas; plot pada kurva BB/U, TB/U, dan BB/TB serta hitung Z-score menurut standar WHO (kurang dari usia 5 tahun) atau CDC — askariasis kronik merupakan penyebab gagal tumbuh yang sering luput dikenali',
      'Konjungtiva pucat sebagai tanda anemia, meski anemia berat lebih khas pada cacing tambang daripada askariasis',
      'Perut tampak BUNCIT dengan ekstremitas kurus pada infeksi kronik disertai malnutrisi',
      'Pemeriksaan ABDOMEN: inspeksi distensi dan gerakan usus yang tampak (darm contour dan darm steifung pada obstruksi), auskultasi bising usus yang meningkat dengan nada tinggi (metalik) pada obstruksi dini atau menghilang pada obstruksi lanjut, palpasi nyeri tekan dan MASSA yang dapat teraba seperti gumpalan tali (bolus cacing) terutama di kuadran kanan bawah, serta perkusi timpani',
      'Nyeri tekan kuadran kanan atas dengan tanda Murphy positif dan ikterik bila terjadi askariasis bilier',
      'AUSKULTASI PARU: mengi dan ronki pada fase migrasi larva (sindrom Loeffler)',
      'Pemeriksaan kulit dan rambut untuk tanda malnutrisi: rambut mudah dicabut dan berwarna kemerahan, kulit kering, serta tanda defisiensi mikronutrien',
      'Inspeksi perianal untuk ekskoriasi akibat garukan dan pemeriksaan kuku yang panjang serta kotor',
      'Pemeriksaan tanda dehidrasi dan syok bila datang dengan komplikasi obstruksi',
    ],
    penunjang: [
      'PEMERIKSAAN TINJA merupakan pemeriksaan utama: ditemukannya TELUR Ascaris lumbricoides pada mikroskop menegakkan diagnosis; telur yang dibuahi berbentuk oval dengan dinding tebal berlapis albuminoid yang bergerigi dan khas berwarna kecokelatan',
      'Metode Kato-Katz merupakan teknik kuantitatif yang direkomendasikan WHO untuk menghitung INTENSITAS infeksi dalam telur per gram tinja, sekaligus dipakai dalam program pengendalian; intensitas ringan kurang dari 5.000, sedang 5.000-49.999, dan berat 50.000 atau lebih telur per gram',
      'Metode konsentrasi seperti formol-eter meningkatkan sensitivitas pada infeksi ringan',
      'Perlu diketahui bahwa pemeriksaan tinja dapat NEGATIF pada infeksi yang hanya terdiri atas cacing jantan saja, pada infeksi prapatensi (dalam 2-3 bulan pertama sebelum cacing bertelur), dan pada obstruksi bilier — sehingga hasil negatif tidak menyingkirkan diagnosis bila cacing dewasa terlihat keluar',
      'Identifikasi CACING DEWASA yang keluar bersama tinja atau muntahan bersifat diagnostik dan tidak memerlukan konfirmasi lain',
      'DARAH LENGKAP: EOSINOFILIA menonjol terutama pada fase migrasi larva, serta anemia ringan pada infeksi kronik dengan malnutrisi',
      'FOTO TORAKS pada fase paru menunjukkan infiltrat yang berpindah-pindah (fleeting infiltrates) yang khas untuk sindrom Loeffler',
      'FOTO POLOS ABDOMEN tiga posisi bila dicurigai OBSTRUKSI: tampak gambaran air-fluid level bertingkat, dilatasi usus halus, dan kadang bayangan cacing yang khas menyerupai gambaran whirlpool atau untaian tali',
      'ULTRASONOGRAFI ABDOMEN sangat berguna dan merupakan pemeriksaan pilihan untuk askariasis BILIER — cacing tampak sebagai struktur tubuler ekogenik memanjang di dalam duktus biliaris atau kandung empedu, kadang terlihat bergerak',
      'Fungsi hati, amilase, dan lipase bila dicurigai komplikasi bilier atau pankreatitis',
      'Endoskopi retrograd kolangiopankreatografi (ERCP) bersifat diagnostik sekaligus terapeutik pada askariasis bilier di pusat rujukan',
    ],
    etiologi:
      'Ascaris lumbricoides, nematoda usus dengan siklus hidup yang memerlukan pematangan telur di TANAH — inilah sebabnya digolongkan sebagai soil-transmitted helminth. Penularan terjadi melalui jalur FEKAL-ORAL dengan menelan telur infektif yang mencemari tanah, air, sayuran mentah, atau makanan; TIDAK ada penularan langsung dari orang ke orang karena telur yang baru dikeluarkan bersama tinja belum infektif dan memerlukan 2-4 minggu di tanah yang lembap dan hangat untuk menjadi infektif.',
    patofisiologi:
      'Telur infektif yang tertelan menetas di usus halus melepaskan larva yang menembus dinding usus, masuk ke sirkulasi portal, lalu bermigrasi ke HATI dan selanjutnya melalui jantung kanan menuju PARU. Di paru, larva menembus kapiler masuk ke alveolus, tumbuh selama sekitar 10-14 hari, kemudian naik melalui bronkus dan trakea ke faring untuk kemudian TERTELAN kembali dan kembali ke usus halus tempatnya menjadi dewasa. Migrasi melalui paru inilah yang menimbulkan reaksi hipersensitivitas berupa infiltrat eosinofilik dengan batuk, mengi, dan sesak yang dikenal sebagai SINDROM LOEFFLER — pemahaman ini penting secara klinis karena gejala paru muncul beberapa minggu SEBELUM telur dapat ditemukan pada tinja, sehingga pemeriksaan tinja pada fase ini akan negatif dan pasien sering keliru didiagnosis sebagai asma atau pneumonia. Seluruh siklus dari tertelannya telur hingga cacing betina mulai bertelur memerlukan waktu sekitar 2-3 bulan (masa prapatensi). Cacing dewasa hidup di lumen usus halus selama 1-2 tahun; seekor betina mampu menghasilkan sekitar 200.000 telur per hari. Cacing dewasa TIDAK mengisap darah dan tidak menempel pada mukosa — inilah pembeda mendasar dengan cacing tambang, dan menjelaskan mengapa askariasis tidak menimbulkan anemia berat melainkan malnutrisi melalui mekanisme berbeda: cacing bersaing memperebutkan nutrien di lumen usus, mengganggu pencernaan dan penyerapan protein, lemak, laktosa, serta vitamin A, sekaligus menurunkan nafsu makan. Pada anak dengan asupan gizi yang sudah pas-pasan, kehilangan ini cukup untuk menghambat pertumbuhan dan perkembangan kognitif. Komplikasi berat timbul karena SIFAT MIGRASI cacing dewasa: ketika terganggu oleh demam, obat anestesi, atau obat cacing yang bekerja lambat, cacing menjadi gelisah dan bermigrasi ke tempat yang salah — masuk ke duktus biliaris melalui papila Vateri menimbulkan kolik bilier, kolangitis, dan pankreatitis; naik ke lambung lalu dimuntahkan atau keluar melalui hidung; bahkan dapat menembus dinding usus yang lemah dan menimbulkan peritonitis. Pada infestasi berat, terutama pada anak yang lumen ususnya kecil, sekumpulan cacing dapat membentuk BOLUS yang menyumbat lumen usus halus sehingga terjadi obstruksi mekanik hingga volvulus dan perforasi.',
    faktorRisiko: [
      'Sanitasi buruk: tidak memiliki jamban dan kebiasaan buang air besar sembarangan',
      'Sumber air bersih yang tidak memadai',
      'Higiene perorangan kurang: tidak mencuci tangan dengan sabun, kuku panjang dan kotor',
      'Anak usia prasekolah dan usia sekolah (2-10 tahun) — kelompok dengan prevalensi dan intensitas tertinggi',
      'Kebiasaan bermain di tanah dan memasukkan tangan ke mulut',
      'Konsumsi sayuran mentah atau lalapan yang tidak dicuci bersih',
      'Penggunaan tinja manusia sebagai pupuk kebun',
      'Iklim tropis dengan tanah lembap dan hangat yang menunjang pematangan telur',
      'Kepadatan hunian dan status sosial ekonomi rendah',
      'Tingkat pendidikan orang tua yang rendah',
    ],
    goldStandard:
      'Baku emas diagnosis adalah DITEMUKANNYA TELUR Ascaris lumbricoides pada pemeriksaan mikroskopis tinja, dengan metode Kato-Katz sebagai teknik kuantitatif rujukan yang sekaligus menentukan intensitas infeksi dalam telur per gram tinja. Ditemukannya CACING DEWASA yang keluar melalui tinja, mulut, atau hidung juga bersifat diagnostik dan tidak memerlukan konfirmasi lebih lanjut. Pada askariasis bilier, ULTRASONOGRAFI merupakan pemeriksaan pilihan yang memperlihatkan cacing sebagai struktur tubuler ekogenik di dalam saluran empedu.',
    diagnosisBanding: [
      'Infeksi kecacingan lain: trikuriasis (dapat menimbulkan disentri dan prolaps rekti), cacing tambang (menonjolkan ANEMIA berat), strongiloidiasis (dapat menimbulkan hiperinfeksi pada imunokompromais), dan enterobiasis (gatal perianal malam hari)',
      'Malnutrisi energi-protein akibat asupan yang kurang tanpa infeksi kecacingan',
      'Dispepsia fungsional dan nyeri perut fungsional pada anak',
      'Tuberkulosis abdomen dan tuberkulosis paru — sama-sama menimbulkan berat badan sulit naik dan batuk lama',
      'Asma bronkial pada fase paru — perbedaannya terletak pada eosinofilia yang mencolok, infiltrat berpindah pada foto toraks, dan sifat gejala yang sementara berlangsung 1-2 minggu lalu hilang sendiri',
      'Pneumonia dan bronkitis',
      'Obstruksi usus akibat sebab lain: intususepsi, hernia inkarserata, adhesi pascaoperasi, dan volvulus',
      'Kolelitiasis dan kolangitis akibat batu empedu pada gambaran askariasis bilier',
      'Apendisitis akut pada nyeri kuadran kanan bawah',
    ],
    pengkajian:
      'Dipikirkan askariasis pada pasien ini atas dasar riwayat mengeluarkan cacing panjang berwarna putih kekuningan bersama tinja — temuan yang sesungguhnya sudah bersifat diagnostik — disertai keluhan nyeri perut hilang timbul di sekitar pusar, perut kembung, nafsu makan menurun, dan berat badan yang sulit naik, pada latar lingkungan dengan sanitasi terbatas, kebiasaan bermain di tanah tanpa alas kaki, dan riwayat tidak pernah memperoleh obat cacing. Pemeriksaan antropometri yang menunjukkan berat badan di bawah kurva pertumbuhan yang sesuai usia memperkuat dugaan adanya dampak nutrisi dari infeksi ini, dan ditemukannya telur khas berdinding tebal dengan lapisan albuminoid bergerigi pada pemeriksaan tinja memastikan diagnosis. Infeksi kecacingan lain menjadi pembanding utama karena berbagi lingkungan penularan yang sama dan sering terjadi bersamaan; cacing tambang dibedakan oleh dominannya ANEMIA DEFISIENSI BESI berat yang tidak sebanding dengan keluhan pencernaan serta riwayat rasa gatal pada kaki saat larva menembus kulit, sedangkan trikuriasis dibedakan oleh gejala disentri dengan tinja berlendir-berdarah dan pada infeksi berat dapat menimbulkan prolaps rekti — keduanya perlu dipikirkan sebagai infeksi penyerta, dan justru karena itulah albendazol dipilih sebab berspektrum luas terhadap ketiganya. Tuberkulosis dipertimbangkan pada anak dengan berat badan sulit naik dan batuk lama, namun pada pasien ini tidak ditemukan riwayat kontak dengan penderita tuberkulosis dewasa, tidak ada demam sore hari yang berkepanjangan maupun keringat malam, dan gejala paru bila ada bersifat sementara sesuai fase migrasi larva. Malnutrisi primer akibat asupan yang kurang juga dipertimbangkan, namun pada pasien ini asupan makan sehari-hari relatif memadai sehingga hambatan pertumbuhan lebih dijelaskan oleh persaingan nutrien dan gangguan penyerapan akibat cacing. Dua hal yang perlu ditegaskan pada kasus ini: pertama, ALBENDAZOL DOSIS TUNGGAL sudah cukup untuk askariasis tanpa komplikasi dan tidak perlu obat yang mahal; kedua, dan ini yang jauh lebih menentukan, PENGOBATAN TANPA PERBAIKAN SANITASI hanya bersifat sementara — anak akan terinfeksi kembali dalam hitungan bulan selama tanah di sekitar rumah masih tercemar tinja manusia, sehingga penyediaan jamban, kebiasaan mencuci tangan dengan sabun, dan pemberian obat cacing berkala dua kali setahun merupakan bagian tak terpisahkan dari terapi, bukan sekadar anjuran tambahan. Perlu pula diwaspadai bahwa obat cacing yang bekerja dengan melumpuhkan cacing secara perlahan dapat memicu MIGRASI cacing ke saluran empedu, sehingga munculnya nyeri perut kanan atas yang hebat setelah minum obat wajib segera dievaluasi.',
    terapiSuportif: [
      'Perbaikan status gizi: makanan tinggi energi dan protein dengan porsi kecil namun sering pada anak dengan hambatan pertumbuhan',
      'Suplementasi zat besi bila terdapat anemia defisiensi besi',
      'Suplementasi vitamin A sesuai program pada anak balita di daerah endemis',
      'Pemantauan berat badan berkala pada kartu menuju sehat atau buku KIA',
      'Rehidrasi dan koreksi elektrolit bila terdapat muntah berulang',
      'Pada obstruksi parsial: puasa, pemasangan pipa nasogastrik untuk dekompresi, cairan intravena, dan pemantauan ketat sebelum mempertimbangkan tindakan bedah',
    ],
    tatalaksana: [
      'ALBENDAZOL 400 mg per oral DOSIS TUNGGAL merupakan pilihan utama pada dewasa dan anak berusia 2 tahun atau lebih; pada anak usia 12-24 bulan diberikan 200 mg dosis tunggal',
      'MEBENDAZOL sebagai alternatif: 500 mg per oral dosis tunggal, atau 100 mg dua kali sehari selama 3 hari',
      'PIRANTEL PAMOAT 10 mg/kgBB per oral dosis tunggal (maksimal 1 g) merupakan alternatif yang aman, termasuk untuk anak kecil dan dapat dipertimbangkan pada kehamilan trimester kedua dan ketiga',
      'Obat sebaiknya diminum bersama makanan berlemak untuk meningkatkan penyerapan albendazol, dan tidak memerlukan puasa maupun pencahar sebagaimana anggapan lama',
      'Angka kesembuhan albendazol dosis tunggal untuk askariasis sangat tinggi, mencapai lebih dari 95%',
      'PERIKSA ULANG TINJA 2-3 MINGGU setelah pengobatan untuk memastikan kesembuhan; ulangi terapi bila masih ditemukan telur',
      'OBATI SELURUH ANGGOTA KELUARGA dan kontak serumah, sebab penularan bersifat lingkungan dan pengobatan satu orang saja akan berujung reinfeksi',
      'Pada KEHAMILAN: hindari albendazol dan mebendazol pada TRIMESTER PERTAMA; pengobatan pada trimester kedua dan ketiga dapat diberikan bila infeksi bermakna secara klinis, dengan pirantel pamoat sebagai pilihan yang paling banyak digunakan',
      'PEMBERIAN OBAT CACING MASSAL sesuai program WHO dan Kementerian Kesehatan: albendazol 400 mg atau mebendazol 500 mg dosis tunggal, diberikan DUA KALI SETAHUN pada anak usia prasekolah dan usia sekolah di daerah dengan prevalensi 50% atau lebih, dan SEKALI SETAHUN bila prevalensi 20-49%',
      'ASKARIASIS BILIER: pendekatan awal umumnya KONSERVATIF dengan puasa, cairan intravena, antispasmodik, analgesik, dan antibiotik bila terdapat kolangitis; obat cacing diberikan SETELAH gejala akut mereda karena cacing yang mati di dalam saluran empedu justru dapat menjadi nidus batu',
      'ERCP untuk ekstraksi cacing dari saluran empedu diindikasikan bila terapi konservatif gagal dalam 24-48 jam, terdapat kolangitis berat, atau pankreatitis',
      'OBSTRUKSI USUS: mulai dengan penanganan konservatif berupa puasa, dekompresi nasogastrik, cairan intravena, dan koreksi elektrolit; sebagian besar obstruksi parsial membaik dengan cara ini. Pemberian piperazin (yang melumpuhkan cacing sehingga terdorong keluar oleh peristaltik) atau minyak mineral melalui pipa nasogastrik dapat dipertimbangkan, sedangkan albendazol diberikan setelah obstruksi teratasi',
      'LAPAROTOMI diindikasikan pada obstruksi komplet yang tidak membaik, tanda peritonitis, perforasi, volvulus, atau iskemia usus — tindakan berupa milking bolus cacing ke arah sekum atau enterotomi untuk mengeluarkan cacing',
      'RUJUK SEGERA bila: nyeri perut hebat menetap, muntah hijau, perut distensi dan tegang, tidak dapat buang air besar maupun buang angin, tanda peritonitis, ikterik dengan demam, atau dehidrasi berat',
    ],
    edukasi: [
      'Jelaskan bahwa penularan terjadi melalui TELUR CACING YANG TERTELAN dari tanah, air, atau makanan yang tercemar tinja manusia — BUKAN dari makan makanan manis sebagaimana sering diyakini masyarakat; telur baru menjadi infektif setelah beberapa minggu di tanah sehingga penyakit ini tidak menular langsung dari orang ke orang',
      'CUCI TANGAN dengan SABUN dan air mengalir pada lima waktu penting: sebelum makan, sebelum menyiapkan makanan, setelah buang air besar, setelah menceboki anak, dan setelah bermain di tanah',
      'GUNAKAN JAMBAN untuk buang air besar — jangan buang air besar di kebun, sungai, atau sembarang tempat; ini merupakan pemutus rantai penularan yang paling mendasar',
      'JANGAN gunakan tinja manusia sebagai pupuk tanaman',
      'Cuci sayuran dan buah dengan air bersih mengalir, dan MASAK air minum hingga mendidih',
      'Potong KUKU anak secara teratur dan biasakan memakai ALAS KAKI saat bermain di luar rumah',
      'Jadwal dan porsi makan: berikan makanan bergizi seimbang 3 kali makan utama dengan 2 kali selingan; pada anak dengan berat badan kurang, tambahkan porsi dan tingkatkan kepadatan energi makanan dengan menambahkan minyak, santan, atau telur; pantau kenaikan berat badan setiap bulan di posyandu',
      'Jam tidur: anak usia sekolah memerlukan tidur 9-11 jam per malam untuk mendukung pemulihan dan pertumbuhan',
      'Pola olahraga dan aktivitas: anak dapat beraktivitas dan bermain seperti biasa; setelah bermain di tanah wajib mencuci tangan dan kaki dengan sabun',
      'OBAT CACING BERKALA setiap 6 bulan untuk seluruh anggota keluarga di daerah endemis, terutama anak usia 1-12 tahun — ini merupakan pencegahan yang murah dan efektif',
      'Setelah minum obat, cacing dapat keluar bersama tinja dalam beberapa hari dan hal ini normal',
      'Follow up: periksa ulang tinja 2-3 minggu setelah pengobatan, dan pantau berat badan setiap bulan',
      'SEGERA kembali bila: nyeri perut hebat yang terus-menerus, perut membesar dan keras, muntah berwarna hijau, tidak bisa buang air besar dan buang angin, demam tinggi, mata dan kulit menguning, atau cacing keluar melalui mulut maupun hidung',
    ],
    komplikasi: [
      'OBSTRUKSI USUS akibat bolus cacing — komplikasi bedah tersering, terutama pada anak dengan infestasi berat',
      'Volvulus, intususepsi, iskemia usus, dan PERFORASI dengan peritonitis',
      'ASKARIASIS BILIER: kolik bilier, kolangitis asendens, kolesistitis, abses hati, dan batu empedu dengan cacing sebagai nidus',
      'PANKREATITIS akut akibat cacing yang menyumbat duktus pankreatikus',
      'Apendisitis akibat cacing yang masuk ke lumen apendiks',
      'SINDROM LOEFFLER berupa pneumonitis eosinofilik pada fase migrasi larva',
      'MALNUTRISI, hambatan pertumbuhan, dan defisiensi mikronutrien terutama vitamin A',
      'Anemia ringan dan gangguan penyerapan laktosa',
      'GANGGUAN KOGNITIF dan penurunan prestasi belajar pada anak yang dapat bersifat menetap',
      'Migrasi cacing ke saluran napas yang dapat menimbulkan asfiksia — jarang namun fatal',
    ],
    prognosis:
      'Sangat baik pada infeksi tanpa komplikasi — albendazol dosis tunggal menyembuhkan lebih dari 95% kasus dengan biaya yang sangat murah. Prognosis menjadi serius pada komplikasi obstruksi usus dan askariasis bilier, yang memerlukan penanganan bedah atau endoskopik dan menyumbang angka kematian bermakna pada anak di daerah dengan akses layanan terbatas. Persoalan sesungguhnya bukanlah pengobatannya, melainkan REINFEKSI: di lingkungan dengan sanitasi buruk, angka infeksi kembali mencapai tingkat semula dalam waktu 6-12 bulan setelah pengobatan, sehingga prognosis jangka panjang sepenuhnya bergantung pada penyediaan jamban, akses air bersih, perilaku cuci tangan, dan keberlanjutan program pemberian obat cacing berkala — bukan pada obat yang diberikan hari ini. Dampak jangka panjang berupa hambatan pertumbuhan dan gangguan kognitif pada anak dapat sebagian bersifat menetap bila infeksi berlangsung lama pada masa pertumbuhan kritis, sehingga pencegahan bernilai jauh lebih besar daripada pengobatan.',
    referensi: ['SKDI2012', 'WHOSTH2020', 'PPKFKTP2014', 'HARRISON2022'],
  },
  'Skistosomiasis': {
  ...
  'Hemoroid grade 1-2': {
    definisi:
      'Hemoroid adalah pelebaran dan pergeseran ke bawah bantalan vaskular (anal cushion) pada kanalis analis yang menimbulkan gejala. Perlu dipahami bahwa bantalan hemoroid merupakan struktur ANATOMIS NORMAL yang berperan dalam kontinensia halus — yang disebut penyakit adalah ketika bantalan ini membesar, mengalami kongesti, dan turun sehingga menimbulkan perdarahan atau prolaps. Hemoroid INTERNA berasal dari pleksus hemoroidalis superior di ATAS linea dentata sehingga dilapisi mukosa tanpa persarafan somatik dan TIDAK NYERI, sedangkan hemoroid EKSTERNA berada di bawah linea dentata, dilapisi anoderm yang kaya serabut nyeri, dan sangat nyeri bila mengalami trombosis. Derajat 1 berarti bantalan membesar namun tidak prolaps keluar anus; derajat 2 berarti prolaps saat mengejan namun kembali masuk SPONTAN.',
    anamnesis: {
      keluhanUtama:
        'Keluar darah merah segar menetes setelah buang air besar sejak beberapa bulan, tanpa disertai nyeri.',
      riwayatPenyakitSekarang:
      ...
      riwayatNutrisi:
        'Asupan SERAT harian secara terperinci: porsi sayur dan buah per hari, konsumsi biji-bijian utuh, serta asupan CAIRAN dalam gelas per hari; kebiasaan makan makanan pedas dan konsumsi alkohol yang dapat memperberat keluhan.',
      riwayatSosialEkonomi:
        'PEKERJAAN yang mengharuskan duduk atau berdiri berjam-jam (sopir, pekerja kantor, penjaga toko) atau mengangkat beban berat, kebiasaan menahan keinginan buang air besar, kebiasaan berlama-lama di toilet sambil bermain telepon genggam (kebiasaan modern yang sangat sering menjadi penyebab dan jarang ditanyakan), tingkat aktivitas fisik, kebiasaan merokok, serta kemampuan mengakses tindakan lanjutan bila diperlukan.',
    },
    pemeriksaanFisik: [
      'Tanda vital lengkap; nilai takikardia dan hipotensi bila perdarahan banyak',
      'Konjungtiva untuk menilai ANEMIA — hemoroid derajat 1-2 jarang menyebabkan anemia bermakna, sehingga adanya anemia justru harus memicu pencarian sumber perdarahan lain',
      'Penilaian status gizi dan tanda penurunan berat badan',
      'Pemeriksaan ABDOMEN lengkap: inspeksi, auskultasi, palpasi untuk MASSA dan nyeri tekan, serta pemeriksaan hepar dan lien — hepatomegali dengan tanda hipertensi portal mengubah diagnosis menjadi varises anorektal',
      'POSISIKAN pasien dengan benar: posisi lateral kiri (Sims) atau litotomi, dengan penerangan yang cukup, menjaga privasi, dan menjelaskan setiap langkah pemeriksaan',
      'INSPEKSI PERIANAL: nilai adanya skin tag, benjolan yang menonjol, fisura (paling sering pada posisi jam 6 atau jam 12), fistula, abses, ekskoriasi kulit akibat garukan, prolaps mukosa, dan kebersihan perianal',
      'Minta pasien MENGEJAN saat diinspeksi untuk menilai apakah terdapat prolaps dan apakah kembali masuk spontan — inilah yang menentukan derajat 1 versus derajat 2 versus derajat 3',
      'COLOK DUBUR (rectal toucher) WAJIB dikerjakan pada setiap perdarahan per anum: nilai tonus sfingter, nyeri, adanya MASSA atau lesi yang teraba, dan periksa warna feses serta darah pada sarung tangan. PENTING: hemoroid interna derajat 1-2 umumnya TIDAK TERABA pada colok dubur karena lunak dan kolaps saat ditekan, sehingga colok dubur yang normal TIDAK menyingkirkan hemoroid — tujuan utamanya adalah menyingkirkan massa rektum',
      'ANOSKOPI merupakan pemeriksaan yang menegakkan diagnosis dan menentukan derajat: menampilkan bantalan hemoroid interna yang membesar, umumnya pada posisi jam 3, 7, dan 11 dalam posisi litotomi',
      'Pada nyeri hebat, pemeriksaan colok dubur dan anoskopi mungkin tidak dapat ditoleransi — jangan memaksakan; pikirkan fisura ani atau trombosis dan pertimbangkan pemeriksaan setelah nyeri terkendali',
      'Pemeriksaan kelenjar getah bening inguinal',
    ],
    penunjang: [
      'ANOSKOPI merupakan pemeriksaan penunjang utama sekaligus penentu derajat; sederhana, murah, dan dapat dikerjakan di layanan primer yang memiliki alat',
      'DARAH LENGKAP untuk menilai anemia dan derajat perdarahan — anemia defisiensi besi yang bermakna pada hemoroid derajat 1-2 merupakan temuan yang TIDAK LAZIM dan wajib memicu pencarian sumber perdarahan lain',
      'KOLONOSKOPI diindikasikan dan tidak boleh ditunda pada: usia 40-50 tahun ke atas dengan perdarahan per anum, adanya ALARM SYMPTOMS (perubahan pola buang air besar, penurunan berat badan, anemia defisiensi besi, tinja bercampur lendir atau berubah bentuk), riwayat keluarga kanker kolorektal atau poliposis, perdarahan yang tidak sesuai dengan temuan hemoroid, atau perdarahan yang menetap meski hemoroid telah ditangani',
      'Sigmoidoskopi fleksibel sebagai alternatif terbatas bila kolonoskopi tidak tersedia, dengan kesadaran bahwa pemeriksaan ini tidak menjangkau kolon proksimal',
      'Profil besi bila terdapat anemia mikrositik',
      'Fungsi hati, albumin, dan waktu protrombin bila dicurigai penyakit hati kronik dengan hipertensi portal',
      'Pemeriksaan pembekuan darah pada pasien yang mengonsumsi antikoagulan atau memiliki riwayat perdarahan mudah',
      'Tinja darah samar bukan pemeriksaan yang berguna pada pasien yang sudah jelas mengalami perdarahan per anum kasat mata',
    ],
    etiologi:
      'Bukan varises vena sebagaimana anggapan lama, melainkan degenerasi jaringan penyangga bantalan anal. Penyebab utamanya adalah peningkatan tekanan intraabdomen yang berulang dan berkepanjangan — terutama akibat KONSTIPASI dengan mengejan berlebihan dan kebiasaan duduk lama di toilet — yang menyebabkan robekan bertahap pada ligamentum Treitz (muskulus submukosa ani) yang menambatkan bantalan pada sfingter internus, sehingga bantalan turun dan mengalami kongesti. Faktor lain meliputi kehamilan, obesitas, diet rendah serat, penuaan, pekerjaan dengan posisi duduk atau berdiri lama, dan hipertensi portal (yang secara teknis menimbulkan varises anorektal, bukan hemoroid).',
    patofisiologi:
      'Bantalan anal terdiri atas jaringan vaskular berupa sinusoid, otot polos, dan jaringan ikat elastis yang ditambatkan pada sfingter internus oleh ligamentum Treitz. Struktur ini normal dan berperan menyumbang sekitar 15-20% tekanan istirahat kanalis analis sehingga menjaga kontinensia terhadap gas dan cairan — inilah alasan penting mengapa tindakan yang mengangkat seluruh bantalan secara berlebihan dapat menimbulkan inkontinensia. Mengejan yang berulang dan berkepanjangan meningkatkan tekanan pada bantalan sekaligus menariknya ke arah distal; lama-kelamaan serat jaringan ikat dan otot penambat mengalami fragmentasi dan robekan sehingga bantalan kehilangan penambatnya dan TURUN ke arah anus. Penurunan ini menyebabkan bendungan aliran balik vena, sehingga sinusoid melebar, mukosa di atasnya menipis dan mudah terkikis oleh tinja yang keras. Karena sinusoid ini berhubungan langsung dengan arteriol melalui hubungan arteriovenosa, maka darah yang keluar bersifat ARTERIAL sehingga tampak MERAH SEGAR dan menetes — bukan darah vena yang gelap sebagaimana sering diduga; pemahaman ini menjelaskan gambaran klinis khas yang membedakannya dari perdarahan saluran cerna bagian atas maupun lesi kolon proksimal. Letak bantalan yang berada di ATAS linea dentata, pada mukosa yang dipersarafi serabut otonom viseral dan bukan somatik, menjelaskan mengapa hemoroid interna TIDAK NYERI meski berdarah banyak — dan sebaliknya, mengapa keluhan nyeri hebat pada pasien dengan perdarahan per anum hampir selalu berasal dari sumber lain seperti fisura ani atau dari hemoroid eksterna yang mengalami trombosis di bawah linea dentata. Prolaps yang berulang menimbulkan sekresi lendir yang mengiritasi kulit perianal sehingga muncul gatal dan ekskoriasi. Bila prolaps menjadi menetap dan terjepit oleh spasme sfingter, aliran darah terbendung total sehingga terjadi strangulasi dan trombosis yang sangat nyeri. Rantai sebab ini menjelaskan mengapa terapi yang paling menentukan bukanlah obat topikal melainkan MELUNAKKAN TINJA dan MENGHILANGKAN KEBIASAAN MENGEJAN — sebab selama tekanan berulang terhadap bantalan tidak dihentikan, kerusakan jaringan penambat akan terus berlanjut dan gejala akan kembali berapa pun banyaknya salep yang dioleskan.',
    faktorRisiko: [
      'KONSTIPASI kronik dan kebiasaan MENGEJAN berlebihan — faktor terpenting dan paling dapat dimodifikasi',
      'Diet rendah serat dan asupan cairan yang kurang',
    ...
    goldStandard:
      'Diagnosis ditegakkan secara KLINIS melalui anamnesis khas berupa perdarahan merah segar tanpa nyeri, disertai INSPEKSI PERIANAL saat mengejan, COLOK DUBUR, dan ANOSKOPI yang merupakan pemeriksaan penentu untuk memastikan adanya hemoroid interna sekaligus menentukan derajatnya. Penderajatan Goligher: derajat 1 bantalan membesar dan berdarah namun tidak prolaps; derajat 2 prolaps saat mengejan dan kembali masuk SPONTAN; derajat 3 prolaps dan harus dimasukkan kembali dengan bantuan jari; derajat 4 prolaps menetap dan tidak dapat direposisi. Yang tidak kalah penting dari menegakkan diagnosis hemoroid adalah MENYINGKIRKAN KEGANASAN KOLOREKTAL — pada pasien berusia 40-50 tahun ke atas atau dengan alarm symptoms, KOLONOSKOPI wajib dikerjakan meski hemoroid sudah terbukti ada, sebab keberadaan hemoroid tidak menjamin tidak adanya lesi lain di kolon proksimal.',
    diagnosisBanding: [
      'KARSINOMA KOLOREKTAL dan polip — diagnosis yang paling berbahaya bila terlewat; ditandai perubahan pola buang air besar yang menetap, tinja berubah bentuk, penurunan berat badan, anemia, dan darah bercampur lendir; risiko meningkat tajam di atas usia 50 tahun',
      'FISURA ANI — NYERI HEBAT seperti disayat saat dan setelah buang air besar yang dapat berlangsung berjam-jam, dengan darah dalam jumlah sedikit menempel pada tisu; nyeri merupakan pembeda utama dari hemoroid interna yang tidak nyeri',
      'Hemoroid EKSTERNA dengan trombosis — benjolan keunguan yang sangat nyeri dan muncul mendadak di tepi anus',
      'Abses dan fistula perianal — nyeri berdenyut, demam, pembengkakan, dan keluarnya nanah',
      'Prolaps REKTI — mukosa yang keluar berbentuk lingkaran konsentris melingkari seluruh anus, berbeda dengan hemoroid yang berbentuk lobulus terpisah',
      'Penyakit radang usus (kolitis ulseratif dan penyakit Crohn) — diare berdarah berlendir, nyeri perut, penurunan berat badan, dan gejala di luar usus',
      'Divertikulosis dan angiodisplasia — perdarahan per anum dalam jumlah banyak pada usia lanjut',
      'Kondiloma akuminata dan kanker anus — lesi pada anoderm yang tampak pada inspeksi',
      'Varises anorektal pada hipertensi portal — disertai stigmata penyakit hati kronik',
      'Proktitis akibat infeksi atau radiasi',
      'Solitary rectal ulcer syndrome pada pasien dengan kebiasaan mengejan berat',
    ],
    pengkajian:
      'Dipikirkan hemoroid interna pada pasien ini atas dasar keluhan keluarnya darah MERAH SEGAR yang MENETES setelah tinja keluar dan menempel pada tisu, TANPA disertai nyeri sama sekali, yang berulang berkaitan dengan periode konstipasi, pada latar diet rendah serat, asupan cairan yang kurang, pekerjaan dengan posisi duduk berjam-jam, dan kebiasaan berlama-lama di toilet sambil bermain telepon genggam. Sifat perdarahan yang merah segar dan tidak bercampur merata dengan tinja menunjukkan sumber perdarahan yang sangat distal, sedangkan tidak adanya nyeri sesuai dengan letak bantalan hemoroid di ATAS linea dentata yang tidak memiliki persarafan nyeri somatik. Pada pemeriksaan, benjolan tampak menonjol saat pasien mengejan dan MASUK KEMBALI SPONTAN tanpa perlu didorong sehingga sesuai dengan derajat 2, dan anoskopi memperlihatkan bantalan hemoroid yang membesar tanpa lesi lain pada kanalis analis. Fisura ani menjadi pembanding terdekat karena sama-sama menimbulkan perdarahan merah segar pada saat buang air besar, namun pada fisura keluhan yang mendominasi adalah NYERI HEBAT seperti disayat yang berlangsung berjam-jam setelah defekasi sehingga pasien sampai takut buang air besar, dengan jumlah darah yang jauh lebih sedikit dan hanya menempel pada tisu — pola nyeri inilah yang paling tegas memisahkan keduanya dan pada pasien ini sama sekali tidak ditemukan. Prolaps rekti dipertimbangkan karena sama-sama menimbulkan benjolan keluar saat mengejan, namun pada prolaps rekti yang keluar berupa mukosa melingkar konsentris mengelilingi seluruh lumen anus, bukan lobulus terpisah sebagaimana temuan pada pasien ini. Yang paling penting dan tidak boleh diabaikan adalah KARSINOMA KOLOREKTAL: kekeliruan klinis yang paling merugikan pada kasus perdarahan per anum adalah menghentikan penelusuran begitu hemoroid ditemukan, padahal hemoroid merupakan kelainan yang sangat lazim sehingga keberadaannya sama sekali tidak menjamin tidak ada lesi lain di kolon yang lebih proksimal. Oleh karena itu, pada pasien berusia empat puluh tahun ke atas, atau bila terdapat perubahan pola buang air besar yang menetap, tinja yang berubah bentuk, penurunan berat badan, anemia defisiensi besi, atau riwayat keluarga kanker kolorektal, KOLONOSKOPI wajib dikerjakan meski hemoroid sudah terbukti. Terakhir, perlu ditegaskan bahwa keberhasilan jangka panjang pada pasien ini ditentukan oleh MELUNAKKAN TINJA melalui serat dan cairan serta menghentikan kebiasaan mengejan dan berlama-lama di toilet — bukan oleh salep atau supositoria, sebab obat topikal hanya meredakan gejala sementara tanpa menyentuh mekanisme kerusakan jaringan penambat yang menjadi akar penyakit.',
    terapiSuportif: [
      'DIET TINGGI SERAT sebagai landasan terapi: target 25-35 gram serat per hari dari sayur, buah, dan biji-bijian utuh — terbukti menurunkan gejala dan perdarahan secara bermakna',
      'Tingkatkan serat secara BERTAHAP selama 1-2 minggu untuk menghindari kembung dan nyeri perut yang membuat pasien menghentikannya',
      'ASUPAN CAIRAN 8-10 gelas (sekitar 2 liter) per hari — menambah serat tanpa menambah cairan justru memperberat konstipasi',
      'RENDAM DUDUK (sitz bath) dengan air hangat suam-suam kuku selama 10-15 menit, 2-3 kali sehari terutama setelah buang air besar — meredakan spasme sfingter dan memberi kenyamanan',
      'Bersihkan daerah anus dengan air dan keringkan dengan menepuk lembut, bukan menggosok; hindari tisu kasar dan tisu basah beralkohol atau berparfum yang mengiritasi',
      'KEBIASAAN BUANG AIR BESAR yang benar: pergi ke toilet segera saat ada keinginan dan jangan ditahan, batasi waktu di toilet MAKSIMAL 3-5 MENIT, jangan membawa telepon genggam atau bacaan ke toilet, dan jangan mengejan',
      'Gunakan penopang kaki kecil (jongkok modifikasi) agar posisi lutut lebih tinggi dari panggul sehingga sudut anorektal terbuka dan defekasi lebih mudah tanpa mengejan',
      'Aktivitas fisik teratur untuk memperbaiki motilitas usus',
      'Hindari duduk atau berdiri terlalu lama tanpa jeda; bangun dan berjalan setiap 1 jam bagi pekerja kantor',
      'Turunkan berat badan pada pasien dengan obesitas',
    ],
    tatalaksana: [
      'HEMOROID DERAJAT 1 DAN 2 ditangani secara KONSERVATIF sebagai lini pertama — sebagian besar membaik tanpa tindakan apa pun',
      'SUPLEMEN SERAT: psyllium (ispaghula husk) 1-2 sendok makan per hari dilarutkan dalam segelas air penuh, atau serat lain seperti metilselulosa — merupakan intervensi dengan bukti paling kuat, menurunkan perdarahan hingga sekitar 50%',
      'LAKSATIF OSMOTIK bila serat saja belum memadai: laktulosa 15-30 mL per hari atau polietilen glikol; sesuaikan dosis hingga tinja lunak dan mudah keluar tanpa mengejan',
      'HINDARI laksatif stimulan (bisakodil, senna) untuk penggunaan jangka panjang karena menimbulkan kram dan ketergantungan',
      'OBAT VENOTONIK oral berupa flavonoid termikronisasi (diosmin dan hesperidin) 500 mg — untuk serangan akut 2 tablet tiga kali sehari selama 4 hari, dilanjutkan 2 tablet dua kali sehari selama 3 hari; untuk rumatan 1 tablet dua kali sehari; membantu mengurangi perdarahan dan edema',
      'SEDIAAN TOPIKAL berupa salep atau supositoria yang mengandung anestesi lokal, pelindung mukosa, atau kortikosteroid — hanya untuk meredakan gejala JANGKA PENDEK; sediaan berkortikosteroid dibatasi MAKSIMAL 7 HARI karena penggunaan lama menimbulkan atrofi kulit perianal',
      'Analgesik parasetamol bila terdapat rasa tidak nyaman; HINDARI NSAID bila perdarahan aktif dan hindari opioid karena memperberat konstipasi',
      'LIGASI KARET GELANG (rubber band ligation) merupakan tindakan pilihan bila terapi konservatif selama 4-6 minggu gagal, terutama pada derajat 2 dan sebagian derajat 1 dan 3 — dikerjakan pada mukosa di ATAS linea dentata yang tidak berpersarafan nyeri; efektif, murah, dan dapat dikerjakan rawat jalan',
      'Alternatif tindakan minimal invasif lain: skleroterapi injeksi (berguna khususnya pada pasien yang mengonsumsi antikoagulan), koagulasi inframerah, dan bipolar diatermi',
      'Pembedahan berupa hemoroidektomi, hemoroidopeksi stapler, atau ligasi arteri hemoroidalis dengan panduan Doppler dicadangkan untuk derajat 3 dan 4, hemoroid campuran yang bergejala berat, atau kegagalan tindakan minimal invasif — TIDAK diindikasikan pada derajat 1-2',
      'Hentikan atau sesuaikan obat yang menyebabkan konstipasi bila memungkinkan',
      'Pada KEHAMILAN: tangani secara konservatif dengan serat, cairan, rendam duduk, dan sediaan topikal yang aman; laktulosa aman digunakan; tunda tindakan invasif hingga pascapersalinan karena hemoroid kehamilan sering membaik sendiri setelah melahirkan',
      'Pada pasien dengan ANTIKOAGULAN: konsultasikan penyesuaian obat sebelum tindakan; skleroterapi lebih disukai daripada ligasi karena risiko perdarahan lebih rendah',
      'RUJUK bila: usia 40-50 tahun ke atas dengan perdarahan per anum (untuk kolonoskopi), terdapat alarm symptoms, perdarahan menyebabkan anemia, gagal terapi konservatif 4-6 minggu, hemoroid derajat 3-4, atau terdapat komplikasi berupa trombosis dan strangulasi',
    ],
    edukasi: [
      'Jelaskan bahwa hemoroid merupakan pembesaran bantalan pembuluh darah yang secara alami memang ada di dubur, bukan tumor maupun kanker; namun tegaskan bahwa perdarahan dari dubur pada usia di atas empat puluh tahun TETAP harus diperiksa lebih lanjut untuk memastikan tidak ada penyebab lain di usus besar',
      'KUNCI PENYEMBUHAN adalah membuat TINJA LUNAK dan BERHENTI MENGEJAN — bukan salep; salep hanya membantu meredakan keluhan sementara',
      'JADWAL DAN PORSI MAKAN: makan 3 kali sehari secara teratur dengan 2 kali selingan berupa buah; setiap kali makan sertakan sayur sebanyak sekitar satu mangkuk kecil dan konsumsi 2-3 potong buah per hari; pilih buah tinggi serat seperti pepaya, pir, apel dengan kulit, dan buah naga; ganti sebagian nasi putih dengan beras merah atau oat; kurangi makanan olahan, gorengan, dan makanan sangat pedas',
      'MINUM 8-10 GELAS AIR per hari — menambah serat tanpa menambah air justru membuat tinja lebih keras',
      'Tambah serat SECARA BERTAHAP selama satu hingga dua minggu agar perut tidak kembung',
      'KEBIASAAN DI TOILET: buang air besar segera saat terasa ingin dan jangan ditahan; batasi waktu di toilet maksimal 3-5 MENIT; JANGAN membawa telepon genggam atau bacaan ke toilet — duduk berlama-lama sambil mengejan adalah penyebab yang paling sering pada pasien masa kini; gunakan bangku kecil untuk menopang kaki agar posisi lebih menyerupai jongkok',
      'RENDAM DUDUK dengan air hangat 10-15 menit sebanyak 2-3 kali sehari, terutama setelah buang air besar',
      'Bersihkan dubur dengan air dan keringkan dengan menepuk lembut; hindari menggosok dengan tisu kasar dan hindari tisu basah beralkohol',
      'JAM TIDUR: tidur 7-8 jam per malam; usahakan jadwal buang air besar yang teratur, umumnya paling mudah pada pagi hari setelah sarapan karena refleks gastrokolik paling aktif saat itu',
      'POLA OLAHRAGA: jalan kaki, berenang, atau bersepeda intensitas sedang selama 30 menit sebanyak 5 kali per minggu untuk melancarkan pergerakan usus; HINDARI angkat beban berat dan olahraga yang membuat menahan napas sambil mengejan (manuver Valsava); bagi pekerja yang duduk lama, bangun dan berjalan setiap satu jam',
      'Turunkan berat badan bila berlebih',
      'Follow up: kontrol 4-6 minggu untuk menilai respons terapi konservatif; bila perdarahan menetap, dipertimbangkan tindakan ligasi',
      'SEGERA kembali bila: perdarahan bertambah banyak atau terus-menerus, badan terasa lemas dan pucat, benjolan keluar dan tidak bisa dimasukkan kembali, nyeri hebat mendadak pada dubur, demam, keluar nanah, berat badan turun tanpa sebab, pola buang air besar berubah menetap, atau tinja menjadi kecil-kecil seperti pensil',
    ],
    komplikasi: [
      'ANEMIA DEFISIENSI BESI akibat perdarahan kronik — jarang pada derajat 1-2, sehingga kehadirannya harus memicu pencarian penyebab lain',
      'Trombosis hemoroid dengan nyeri hebat mendadak',
      'Prolaps yang terjepit (inkarserata) dan STRANGULASI dengan nekrosis — kegawatan yang memerlukan tindakan segera',
      'Perkembangan menjadi derajat yang lebih tinggi bila faktor pencetus tidak diperbaiki',
      'Ulserasi mukosa dan perdarahan masif (jarang)',
      'Dermatitis perianal dan gatal kronik akibat sekresi lendir',
      'Infeksi lokal, abses perianal, dan sangat jarang sepsis pelvis pasca tindakan',
      'Komplikasi tindakan: nyeri, perdarahan pascaligasi (umumnya pada hari ke-7 sampai ke-10 saat karet terlepas), retensi urin, dan striktur atau inkontinensia setelah hemoroidektomi luas',
      'KETERLAMBATAN DIAGNOSIS KANKER KOLOREKTAL karena seluruh perdarahan diatribusikan kepada hemoroid — komplikasi paling merugikan dan sepenuhnya dapat dicegah',
    ],
    prognosis:
      'Sangat baik. Sebagian besar hemoroid derajat 1 dan 2 membaik hanya dengan terapi konservatif berupa serat, cairan, dan perbaikan kebiasaan buang air besar, dengan penurunan gejala perdarahan yang bermakna dalam beberapa minggu. Ligasi karet gelang memiliki angka keberhasilan sekitar 70-80% pada pasien yang gagal terapi konservatif. Namun kekambuhan cukup sering dan hampir selalu berkaitan dengan kembalinya kebiasaan lama — konstipasi, mengejan, dan duduk berlama-lama di toilet — sehingga prognosis jangka panjang ditentukan oleh keberlanjutan perubahan pola makan dan kebiasaan, bukan oleh jenis tindakan yang dijalani. Yang paling menentukan keselamatan pasien pada akhirnya bukanlah hemoroidnya sendiri, yang jinak dan jarang mengancam jiwa, melainkan ketelitian menyingkirkan keganasan kolorektal pada setiap perdarahan per anum, terutama pada pasien berusia di atas empat puluh tahun.',
    referensi: ['SKDI2012', 'ASCRSHEM2018', 'PPKFKTP2014', 'SCHWARTZ2019', 'SLEISENGER2021'],
  },
  'Hemoroid grade 3-4': {
