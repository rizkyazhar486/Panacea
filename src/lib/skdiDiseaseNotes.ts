...
export const SKDI_DISEASE_NOTES: Record<string, SkdiDiseaseNote> = {
  ...
  'Kehamilan normal': {
    definisi: 'Kehamilan tanpa penyulit dengan pertumbuhan janin dan adaptasi maternal yang sesuai usia kehamilan.',
    diagnosis: ['Amenore, tes kehamilan positif, tanda Hegar/Chadwick; hitung usia kehamilan dari HPHT dengan rumus Naegele dan konfirmasi USG trimester pertama (paling akurat); pemeriksaan Leopold dan DJJ pada trimester lanjut'],
    tatalaksana: ['Antenatal care minimal 6 kali dengan 2 kali pemeriksaan dokter sesuai standar nasional; suplementasi asam folat (idealnya prakonsepsi) dan tablet tambah darah, imunisasi TT, skrining anemia-HIV-sifilis-hepatitis B-gula darah, pemantauan tekanan darah dan pertumbuhan janin; EDUKASI TANDA BAHAYA (perdarahan, nyeri kepala hebat, pandangan kabur, bengkak, gerak janin berkurang, ketuban pecah) dan rencana persalinan'],
    referensi: ['SKDI2012', 'POGI2016', 'WILLIAMSOB2022'],
  },
