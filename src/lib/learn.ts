...
export const TOPICS: Topic[] = [
  ...
  {
    id: 'quotients',
    title: 'The quotients, graded honestly',
    summary: 'Twelve things get called a "quotient". Four are measurements. The rest are frameworks — useful, but not the same thing.',
    minutes: 9,
    icon: '\ud83e\udde9',
    takeaway: 'Use the validated few to measure yourself and the rest as vocabulary for thinking — the damage comes from treating a framework as a score.',
    sections: [
      {
        heading: 'What makes something a real measurement',
        tier: 'strong',
        body: 'Three properties separate a test from a questionnaire. Reliability: it gives you a similar answer next month if nothing changed. Validity: it measures the thing it claims rather than something adjacent. Incremental validity: it tells you something you could not already get more cheaply from a simpler measure. Most popular quotients fail the third even when they pass the first two — they largely restate personality traits already captured elsewhere.',
        caveat: 'These criteria come from psychometrics and personnel selection, where the stakes forced rigour. They are the right standard, but applying them strictly would discard many concepts that people still find genuinely useful for reflection.',
      },
      {
        heading: 'The ones with real psychometric standing',
        tier: 'strong',
        body: 'General cognitive ability (IQ) is the most thoroughly validated construct in psychology, with high reliability and consistent prediction of learning speed and job performance across decades of research. Conscientiousness, from the Big Five personality model, is the best-supported non-cognitive predictor of long-term outcomes. Physical capacity is the most objective of all — VO\u2082max, grip strength, and body composition are measured, not reported. Cultural intelligence has a validated scale with a reasonable evidence base, though smaller.',
        caveat: 'Predicting group averages is not predicting an individual. IQ predicts a meaningful share of variance in performance, which still leaves most of it unexplained by anything a test can see. Treat these as one input, never a verdict.',
      },
      {
        heading: 'Emotional intelligence: two different things sharing a name',
        tier: 'moderate',
        body: 'Ability-based emotional intelligence — measured by performance on emotion-recognition tasks — behaves like a genuine ability and adds modestly to prediction. Self-reported or "trait" emotional intelligence, which is what almost every online EQ test actually is, correlates so heavily with existing personality traits that it adds little beyond them. When someone reports an EQ score, the first question is which of the two they measured.',
        caveat: 'The field is contested and commercially crowded. Even the ability-based measures have been criticised for how their "correct" answers are decided, since emotion recognition has no answer key in the way arithmetic does.',
      },
      {
        heading: 'Adversity, resilience, and grit',
        tier: 'weak',
        body: 'Resilience has usable research scales and predicts outcomes modestly. Grit became famous and then ran into a problem: meta-analysis showed it overlaps almost entirely with conscientiousness and adds little predictive power on its own. Adversity Quotient is a commercial framework rather than a peer-reviewed construct. All three describe something real about people; none of them measures it well enough to score you.',
        caveat: 'Weak measurement does not mean the underlying quality is unreal. Persistence through difficulty clearly matters — it is the claim to have quantified it that does not hold.',
      },
      {
        heading: 'Spiritual, leadership, vision, moral, digital',
        tier: 'weak',
        body: 'These are frameworks, not instruments. They have no standardised tests with published reliability, and several are trademarked consultancy products. That does not make them worthless: purpose in life has been associated with lower mortality in large cohorts, and leadership behaviours can be assessed — just not by a quotient. Use them as language for what to work on, not as numbers to track.',
        caveat: 'The purpose-and-mortality association is observational, and reverse causation is very plausible — people who are ill, isolated, or depressed report less sense of purpose.',
      },
      {
        heading: 'The one error that does the most damage',
        tier: 'moderate',
        body: 'Giving someone a number carries authority that the underlying measure has not earned. People remember scores and forget confidence intervals, and a low score on an invalid test can change what someone believes they are capable of. This is why an app should either measure something properly or describe it qualitatively — the dangerous middle is a confident-looking score built on nothing.',
        caveat: 'There is also a cost to refusing all measurement: without any feedback, people default to self-assessment, which is less accurate still. The answer is honest labelling of precision, not abstinence.',
      },
    ],
  },
  {
    id: 'assessment-craft',
    title: 'How experienced assessors actually judge people',
    summary: 'What selection science found works — and why almost none of it is a personality quiz.',
    minutes: 8,
    icon: '\ud83d\udd2c',
    takeaway: 'Watch behaviour on a real task, score it against criteria written in advance, and get more than one observer — everything else is decoration.',
    sections: [
      {
        heading: 'Work samples beat opinions',
        tier: 'strong',
        body: 'Across a century of personnel-selection research, the strongest predictors of performance are cognitive ability tests, structured interviews, and work-sample tests — actually doing a scaled-down version of the job. Unstructured interviews, where a senior person forms an impression through conversation, predict far more weakly than their popularity suggests. Applied to yourself, this means the honest test of a skill is a task with an outcome, not an opinion about your capacity for it.',
        caveat: 'The best-known summary of these validities was later corrected for statistical over-adjustment, and the revised estimates are lower than the famous ones. The ranking held; the absolute numbers came down.',
      },
      {
        heading: 'Structure is what makes judgement reliable',
        tier: 'strong',
        body: 'A structured interview asks every person the same questions in the same order and scores answers against criteria written before anyone was seen. That single change roughly doubles predictive power compared with free conversation, because it removes the interviewer\u2019s drift toward whoever they find agreeable. The same logic works on yourself: define the standard before you look at the result, or you will grade to whatever you found.',
        caveat: 'Structure reduces bias, it does not remove it. Criteria written by one person still encode that person\u2019s assumptions about what good looks like.',
      },
      {
        heading: 'More than one observer, and observers who disagree',
        tier: 'moderate',
        body: 'Assessment centres and 360-degree feedback exist because a single viewpoint is unreliable. What makes multi-source feedback useful is not the average — it is the disagreement. Where your self-rating and others\u2019 ratings diverge is the information; where they agree you learned nothing you did not know.',
        caveat: 'Self-ratings are the least accurate source in nearly every study, and 360 feedback can damage performance when it arrives without support or context. The mechanism is not mysterious: unstructured criticism from anonymous colleagues is hard to act on.',
      },
      {
        heading: 'Base rates, and why anecdotes mislead',
        tier: 'strong',
        body: 'Before judging whether something worked, ask how often it would have appeared to work anyway. A method that helps one person in ten still produces glowing testimonials from that one. Almost every claim in self-development is supported by exactly this — the successful cases speak, and the people for whom it did nothing quietly stop mentioning it.',
        caveat: 'Base-rate reasoning is easier to state than to apply, since honest base rates are rarely available for the things people most want to improve.',
      },
      {
        heading: 'Beware the score that flatters everyone',
        tier: 'moderate',
        body: 'People rate vague, mostly positive descriptions as highly accurate about themselves — the effect behind horoscopes and many personality reports. A profile that feels startlingly accurate is weak evidence that it measured anything, because a well-written generic profile produces the same feeling. The test of a measure is whether it distinguishes people, not whether it resonates.',
        caveat: 'This does not mean every resonant result is empty. It means resonance carries no evidential weight either way, so it should not be what convinces you.',
      },
    ],
  },
  {
    id: 'own-scorecard',
    title: 'Building a scorecard you cannot fool',
    summary: 'A practical, honest system: what to measure objectively, what to track behaviourally, and what to leave unscored.',
    minutes: 8,
    icon: '\ud83d\udccb',
    takeaway: 'Measure outputs you cannot argue with, review them on a fixed schedule, and write down in advance what would prove you wrong.',
    sections: [
      {
        heading: 'Three tiers, and be honest about which is which',
        tier: 'moderate',
        body: 'Tier one is objective and countable: VO\u2082max, strength, sleep regularity, work shipped, deadlines met, money saved. Tier two is behavioural evidence rather than a score: did you take the harder option when it mattered, did you finish what you started, did you ask for feedback and change something. Tier three is reflective and deliberately unscored: purpose, values, relationships. Forcing tier three into a number is exactly the error described elsewhere on this page.',
        caveat: 'The tiers are a framework of ours, not a validated model. Their value is in preventing false precision, and they should be judged on whether they do that.',
      },
      {
        heading: 'Test on a schedule, not on a feeling',
        tier: 'moderate',
        body: 'Re-testing when you feel good produces a rising line that reflects mood selection rather than progress. Fixed intervals — the same test, same conditions, same time of day, every eight to twelve weeks — are what make a trend mean anything. This is the single practice that separates measurement from self-congratulation.',
        caveat: 'Fixed-interval testing is standard practice in sports science and clinical monitoring rather than a finding from a specific trial in self-development.',
      },
      {
        heading: 'Write the falsifier before you start',
        tier: 'moderate',
        body: 'For each thing you are trying to build, write the observation that would tell you it is not working — a lift that has not moved in twelve weeks, a skill you still cannot demonstrate, a habit you have kept fewer than half the intended days. Deciding this in advance is what makes review capable of producing a "no", and a review that can only produce a "yes" is not a review.',
        caveat: 'Borrowed from scientific method and clinical trial pre-registration. Sound reasoning, but no study demonstrates that individuals who pre-specify develop faster.',
      },
      {
        heading: 'Deliberate practice needs a coach or a scoreboard',
        tier: 'moderate',
        body: 'What separates practice that improves you from practice that merely occupies you is immediate, accurate feedback on specific errors, at a difficulty just beyond current ability. Where feedback is automatic — a lift, a race time, a test score — you can self-coach. Where it is not — leadership, judgement, communication — you need another person, because your own assessment of those is the least reliable data available.',
        caveat: 'The strong version of the deliberate-practice claim, that it explains most of expert performance, did not survive replication; later meta-analyses found it explains a much smaller share. The principle of feedback-driven practice held up; the claim that it is sufficient did not.',
      },
      {
        heading: 'What Panaceamed should and should not score you on',
        tier: 'weak',
        body: 'This app can legitimately measure physical capacity, sleep, training load, and adherence, because those come from devices and logs rather than self-report. It should not present an IQ, EQ, or leadership score, because it cannot administer those under conditions that make them valid — and a number that looks authoritative but is not is worse than no number. Where it can help beyond the physical is by tracking behaviour and consistency, which is the raw material every framework on this page is really pointing at.',
        caveat: 'This is a product judgement, not a research finding. A properly administered, professionally supervised assessment is a different matter from a quiz inside an app.',
      },
    ],
  },
  {
