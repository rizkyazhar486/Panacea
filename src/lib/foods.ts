...
export const EXERCISES: Exercise[] = [
  ...
  { name: 'Jalan santai', emoji: '🚶‍♀️', kcalPerMin: 3, intensity: 'Ringan' },
  { name: 'Naik tangga', emoji: '🪜', kcalPerMin: 9, intensity: 'Berat' },
  { name: 'Sepeda statis', emoji: '🚲', kcalPerMin: 7, intensity: 'Sedang' },
  { name: 'Treadmill', emoji: '🏃‍♀️', kcalPerMin: 10, intensity: 'Sedang' },
  { name: 'Eliptikal', emoji: '⚙️', kcalPerMin: 8, intensity: 'Sedang' },
  { name: 'Zumba / dansa', emoji: '🕺', kcalPerMin: 8, intensity: 'Sedang' },
  { name: 'Plank / core', emoji: '🧱', kcalPerMin: 5, intensity: 'Sedang' },
  { name: 'Tenis meja', emoji: '🏓', kcalPerMin: 5, intensity: 'Ringan' },
  { name: 'Voli', emoji: '🏐', kcalPerMin: 6, intensity: 'Sedang' },
  { name: 'Golf', emoji: '⛳', kcalPerMin: 4, intensity: 'Ringan' },
  { name: 'Dayung', emoji: '🚣', kcalPerMin: 10, intensity: 'Berat' },
  { name: 'Tinju / Muay Thai', emoji: '🥊', kcalPerMin: 13, intensity: 'Berat' },
  { name: 'Taekwondo / Karate', emoji: '🥋', kcalPerMin: 10, intensity: 'Berat' },
  { name: 'Panjat tebing', emoji: '🧗', kcalPerMin: 11, intensity: 'Berat' },
  { name: 'Peregangan / stretching', emoji: '🤸‍♀️', kcalPerMin: 3, intensity: 'Ringan' },
  { name: 'Berkebun', emoji: '🪴', kcalPerMin: 4, intensity: 'Ringan' },
  { name: 'Squat / lunges', emoji: '🦵', kcalPerMin: 8, intensity: 'Sedang' },
]
