...
export const TARGET_IMAGING_KLINIS: readonly TargetImaging[] = [
  ...
  { id: 'satu-halaman', kemampuan: 'One super page: 3D + three MPR planes together, dark clinical multi-panel', status: 'ada', bukti: ['src/pages/bodyhub/VolumeDicomBagian.tsx', 'src/components/PlaneViewerMpr.tsx', 'src/lib/sinkronMpr3d.ts', 'scripts/uji/sinkron-mpr-3d.mts'] },
