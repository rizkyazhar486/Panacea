...
export const TARGET_IMAGING_KLINIS: readonly TargetImaging[] = [
  ...
  { id: 'potong', kemampuan: 'Movable cross-section / clipping plane', status: 'sebagian', bukti: ['src/components/VolumeDicom3D.tsx'], celah: 'Axis-aligned crop only; no freely oriented plane yet.' },
