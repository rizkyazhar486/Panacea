...
export const PHYSIOLOGY_DEEP_DIVES: PhysiologyDeepDive[] = [
  ...
  },
  {
    ...
    label: 'Vestibular balance: canals + otoliths → gaze + posture',
    domain: 'sensory',
    summary: 'Connects angular and linear head motion to vestibular hair-cell transduction, vestibular nuclei, gaze stabilization and postural control.',
    sequence: [
      'The three semicircular canals encode angular head motion through endolymph-driven deflection of cupular hair cells.',
      'The utricle and saccule encode linear acceleration and head orientation relative to gravity through otolith-organ hair cells.',
      'Primary vestibular afferents travel in cranial nerve VIII to vestibular nuclei and directly to cerebellar circuits.',
      'Vestibular nuclei integrate labyrinthine input with visual and somatosensory information rather than operating as an isolated inner-ear sensor.',
      'Vestibulo-ocular pathways drive compensatory eye movements while vestibulospinal pathways contribute to head, trunk and limb postural responses.',
    ],
    control: 'Visual-vestibular interaction, cerebellar adaptation and bilateral push-pull vestibular signaling continuously recalibrate gaze and balance during motion.',
    formulas: [
      { label: 'VOR gain teaching ratio', expression: 'gain = |eye velocity| / |head velocity|', variables: 'Dimensionless magnitude ratio during head motion', note: 'Ideal gaze stabilization approaches a gain near 1 in the tested plane; this educational ratio is not a vestibular diagnostic test.' },
    ],
    layer3d: 'nervous',
    searchTerms: ['semicircular canal', 'utricle', 'saccule', 'vestibular nerve', 'vestibular nucleus', 'cerebellum'],
    boundary: 'Educational vestibular physiology only; it does not diagnose vertigo, estimate vestibular loss or substitute for VOR/head-impulse testing.',
    references: [{ label: 'NCBI Bookshelf — Neuroanatomy, Vestibulo-ocular Reflex', href: NCBI.vestibular }],
  },
  ...
  {
    id: 'proprioception',
    label: 'Proprioception: muscle spindle + tendon organ → body position',
    domain: 'neuro',
    summary: 'Shows how muscle length, muscle tension and joint-related mechanosensory signals support limb position, movement accuracy and postural control.',
    sequence: [
      'Muscle spindles lie in parallel with skeletal muscle fibres and report muscle length and change in length through group Ia and II afferents.',
      'Gamma motor drive adjusts intrafusal fibre sensitivity so spindle feedback remains informative during active contraction.',
      'Golgi tendon organs lie in series with muscle-tendon force transmission and signal tension through group Ib afferents.',
      'Joint and cutaneous mechanoreceptors add contextual information about limb motion and contact.',
      'Ascending proprioceptive information reaches spinal reflex circuits, cerebellar pathways and conscious somatosensory representations, where it is integrated with vestibular and visual input.',
    ],
    control: 'Sensorimotor loops continuously compare intended movement with afferent feedback; proprioception therefore participates in reflexes, coordination and balance rather than acting as a standalone score.',
    formulas: [],
    layer3d: 'nervous',
    searchTerms: ['muscle spindle', 'Golgi tendon organ', 'dorsal column', 'spinocerebellar tract', 'somatosensory cortex'],
    boundary: 'Educational proprioception pathway only; it does not infer joint position sense, ataxia, neuropathy or fall risk from movement data.',
    references: [{ label: 'NCBI Bookshelf — Mechanoreceptors Specialized for Proprioception', href: NCBI.proprioception }],
  },
  {
    id: 'autonomic-control',
    label: 'Autonomic control: sympathetic + parasympathetic + enteric',
    domain: 'neuro',
    summary: 'Integrates rapid involuntary control of cardiovascular, respiratory, gastrointestinal, thermoregulatory, pupillary and genitourinary function.',
    sequence: [
      'Visceral sensory inputs reach brainstem and hypothalamic integrators through pathways including vagal and glossopharyngeal afferents.',
      'Sympathetic preganglionic neurons arise from thoracolumbar spinal cord, synapse in autonomic ganglia and distribute broadly to organs and vessels.',
      'Parasympathetic outflow arises from brainstem cranial nerves and sacral spinal cord and generally uses ganglia near or within target organs.',
      'Enteric neural circuits coordinate gastrointestinal motility and secretion while remaining modulated by extrinsic autonomic input.',
      'Organ responses emerge from receptor distribution and network context rather than a simple sympathetic-versus-parasympathetic opposition.',
    ],
    control: 'Baroreflex, chemoreflex, hypothalamic homeostatic control and higher-brain context dynamically alter autonomic outflow across seconds to minutes.',
    formulas: [
      { label: 'MAP approximation', expression: 'MAP ≈ DBP + (SBP − DBP)/3', variables: 'Approximation at ordinary heart rates; SBP/DBP in the same pressure units' },
    ],
    layer3d: 'nervous',
    searchTerms: ['hypothalamus', 'brainstem', 'vagus nerve', 'sympathetic trunk', 'autonomic ganglion'],
    boundary: 'Educational autonomic physiology only; it does not estimate autonomic tone, dysautonomia, HRV pathology or treatment need.',
    references: [{ label: 'NCBI Bookshelf — Anatomy, Autonomic Nervous System', href: NCBI.autonomic }],
  },
  {
    id: 'nociception-pain',
    label: 'Nociception & pain: peripheral threat signal → spinal cord → brain',
    domain: 'neuro',
    summary: 'Separates peripheral nociceptive transduction from spinal transmission, ascending pathways, perception and descending modulation.',
    sequence: [
      'Specialized peripheral nociceptors respond to potentially tissue-damaging mechanical, thermal and chemical stimuli.',
      'Thinly myelinated A-delta and unmyelinated C afferents carry nociceptive signals into the dorsal horn of the spinal cord.',
      'Second-order neurons contribute to the anterolateral/spinothalamic system after crossing near the spinal entry level.',
      'Thalamic, cortical, limbic and brainstem networks transform ascending nociceptive input into sensory-discriminative and affective components of pain.',
      'Descending brainstem pathways and local spinal circuits can amplify or suppress transmission, so pain intensity is not a direct meter of tissue damage.',
    ],
    control: 'Peripheral sensitization, central sensitization, attention, expectation, descending modulation and inflammatory mediators can alter pain processing at multiple levels.',
    formulas: [],
    layer3d: 'nervous',
    searchTerms: ['nociceptor', 'dorsal horn', 'spinothalamic tract', 'thalamus', 'somatosensory cortex'],
    boundary: 'Educational nociception physiology only; it does not diagnose a pain generator, grade injury severity or recommend analgesic treatment.',
    references: [{ label: 'NCBI Bookshelf — Pain', href: NCBI.pain }],
  },
  ...
  {
    id: 'gustation',
    label: 'Taste: receptor cell → CN VII/IX/X → brainstem → cortex',
    domain: 'sensory',
    summary: 'Connects oral chemosensation to taste-receptor transduction, cranial sensory pathways and multisensory flavor perception.',
    sequence: [
      'Dissolved tastants reach taste receptor cells within taste buds distributed across tongue and other upper aerodigestive mucosa.',
      'Salty and sour transduction prominently use ion-channel mechanisms, while sweet, bitter and umami use G-protein-coupled receptor signaling pathways.',
      'Taste afferents travel through cranial nerves VII, IX and X according to receptor territory.',
      'Primary afferents converge in the rostral nucleus of the solitary tract before ascending to thalamic and cortical gustatory representations.',
      'Perceived flavor integrates gustation with olfaction, temperature, texture and trigeminal somatosensation.',
    ],
    control: 'Salivary environment, adaptation, satiety signals, olfactory input and central reward/homeostatic circuits all modulate the final percept.',
    formulas: [],
    layer3d: 'visceral',
    searchTerms: ['tongue', 'taste bud', 'facial nerve', 'glossopharyngeal nerve', 'vagus nerve', 'nucleus of solitary tract'],
    boundary: 'Educational gustatory physiology only; it does not test taste thresholds or diagnose dysgeusia, cranial neuropathy or nutritional deficiency.',
    references: [{ label: 'NCBI Bookshelf — Physiology, Taste', href: NCBI.taste }],
  },
