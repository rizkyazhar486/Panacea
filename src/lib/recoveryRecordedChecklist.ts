...
export function buildRecoveryRecordedChecklist(
  ...
  return [
    ...
    },
    {
      ...
      status: 'pass',
      detail: 'This checklist validates recorded-data completeness and provenance only. It does not validate or promote the page’s recovery score, strain target, sleep-need/debt model, behavior-effect estimates, diagnosis, prognosis or treatment/training guidance.',
    },
  ]
}
