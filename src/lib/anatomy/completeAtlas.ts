 ...
 *
 * The base whole-body scaffold, respiratory deep-dive, and higher-end
 * reference-only expansion are composed only here so each source file remains
 * independently reviewable. Hierarchy children are rebuilt after composition,
 * making cross-module parents deterministic and preventing stale authoring
 * hints from changing runtime topology.
 */
