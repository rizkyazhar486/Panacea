...
/**
 * Pure state controller for one educational Eye multiscale viewport.
 * It never loads assets, mutates Object3D instances, creates a renderer,
 * synthesizes anatomy, or promotes review/publication state.
 */
