...
export const EYE_CATARACT_PATHOLOGY_WAVE8: readonly EyeCataractPathologyStep[] = [
  {
    ...
    order: 1,
    evidence: [
      PUBMED('38977082', 'Aging of the eye: Lessons from cataracts and age-related macular degeneration.'),
    ],
    representation: 'educational-pathology-contract',
    reviewStatus: 'academic-review-pending',
    patientSpecific: false,
  ...
  },
  {
    ...
    order: 2,
    evidence: [
      PUBMED('7672510', 'Oxidative stress-induced cataract: mechanism of action.'),
    ],
    representation: 'educational-pathology-contract',
    reviewStatus: 'academic-review-pending',
    patientSpecific: false,
