...
/**
 * Resolve a semantic atlas target against the effective source-node catalogue.
 *
 * IMPORTANT: source-name matches are evidence of catalogue presence only. This
 * function deliberately returns the declared bindingStatus unchanged and never
 * upgrades a candidate binding to source-node-verified or renderer-verified.
 */
