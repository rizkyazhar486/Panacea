...
export const EYE_GLAUCOMA_PATHOLOGY_WAVE7: readonly EyeGlaucomaPathologyStep[] = [
  ...
  },
  {
    ...
    order: 2,
    evidence: [
      PUBMED('PMID:23586020', 'Integrins in trabecular meshwork and optic nerve head: possible association with the pathogenesis of glaucoma.'),
      PUBMED('PMID:27229292', 'Pro-fibrotic pathway activation in trabecular meshwork and lamina cribrosa is the main driving force of glaucoma.'),
    ],
    representation: 'educational-pathology-contract', reviewStatus: 'academic-review-pending',
    patientSpecific: false, clinicalInferenceAllowed: false,
  },
  {
    ...
    order: 1,
    evidence: [
      PUBMED('PMID:7488801', 'Laser therapy and angle-closure glaucoma.'),
      PUBMED('PMID:19298900', 'Angle-closure glaucoma: the role of the lens in the pathogenesis, prevention, and treatment.'),
    ],
    representation: 'educational-pathology-contract', reviewStatus: 'academic-review-pending',
    patientSpecific: false, clinicalInferenceAllowed: false,
  },
