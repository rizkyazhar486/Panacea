...
const SEGMENTS: readonly SegmentDefinition[] = [
  { id: 'r-s1', label: 'Right S1 apical segment', side: 'right', lobeId: 'resp:right-upper-lobe', bronchusHints: ['apical segmental bronchus of right upper lobe', 'apical segmental bronchus'] },
  { id: 'r-s2', label: 'Right S2 posterior segment', side: 'right', lobeId: 'resp:right-upper-lobe', bronchusHints: ['posterior segmental bronchus of right upper lobe'] },
  { id: 'r-s3', label: 'Right S3 anterior segment', side: 'right', lobeId: 'resp:right-upper-lobe', bronchusHints: ['anterior segmental bronchus of right upper lobe'] },
  { id: 'r-s4', label: 'Right S4 lateral segment', side: 'right', lobeId: 'resp:right-middle-lobe', bronchusHints: ['lateral segmental bronchus of right middle lobe'] },
  { id: 'r-s5', label: 'Right S5 medial segment', side: 'right', lobeId: 'resp:right-middle-lobe', bronchusHints: ['medial segmental bronchus of right middle lobe'] },
  { id: 'r-s6', label: 'Right S6 superior segment', side: 'right', lobeId: 'resp:right-lower-lobe', bronchusHints: ['superior segmental bronchus of right lower lobe'] },
  ...
  { id: 'l-s1-2', label: 'Left S1+2 apicoposterior segment', side: 'left', lobeId: 'resp:left-upper-lobe', bronchusHints: ['apicoposterior segmental bronchus of left upper lobe', 'apical segmental bronchus of left upper lobe', 'posterior segmental bronchus of left upper lobe'] },
  { id: 'l-s3', label: 'Left S3 anterior segment', side: 'left', lobeId: 'resp:left-upper-lobe', bronchusHints: ['anterior segmental bronchus of left upper lobe'] },
  ...
  { id: 'l-s6', label: 'Left S6 superior segment', side: 'left', lobeId: 'resp:left-lower-lobe', bronchusHints: ['superior segmental bronchus of left lower lobe'] },
...
export const RESPIRATORY_ATLAS_NODES: readonly AtlasNode[] = [
  ...
  resp({ id: 'resp:larynx', label: 'Larynx', regions: ['neck'], laterality: 'midline', scale: 'organ', parentId: 'resp:upper-airway', children: ['resp:trachea'], source: { mode: 'specific-fallback', files: ['visceral.glb'], nodeHints: ['larynx'] }, geometryStatus: 'shipped', educationalPriority: 0.95, physiologyCapable: true, surgicalLandmark: true }),
  ...
  resp({ id: 'resp:carina', label: 'Carina', regions: ['thorax'], laterality: 'midline', scale: 'suborgan', parentId: 'resp:trachea', children: ['resp:right-main-bronchus', 'resp:left-main-bronchus'], source: { mode: 'specific-fallback', files: ['visceral.glb'], nodeHints: ['carina', 'bifurcation of trachea'] }, geometryStatus: 'partial', educationalPriority: 1, physiologyCapable: true, surgicalLandmark: true }),
  resp({ id: 'resp:right-main-bronchus', label: 'Right main bronchus', regions: ['thorax'], laterality: 'right', scale: 'suborgan', parentId: 'resp:carina', children: ['resp:right-upper-lobe', 'resp:right-middle-lobe', 'resp:right-lower-lobe'], source: { mode: 'specific-fallback', files: ['visceral.glb'], nodeHints: ['right main bronchus', 'right principal bronchus'] }, geometryStatus: 'shipped', educationalPriority: 1, physiologyCapable: true, surgicalLandmark: true }),
  resp({ id: 'resp:left-main-bronchus', label: 'Left main bronchus', regions: ['thorax'], laterality: 'left', scale: 'suborgan', parentId: 'resp:carina', children: ['resp:left-upper-lobe', 'resp:left-lower-lobe'], source: { mode: 'specific-fallback', files: ['visceral.glb'], nodeHints: ['left main bronchus', 'left principal bronchus'] }, geometryStatus: 'shipped', educationalPriority: 1, physiologyCapable: true, surgicalLandmark: true }),
  ...
  resp({ id: 'resp:right-upper-lobe', label: 'Right upper lobe', regions: ['thorax'], laterality: 'right', scale: 'suborgan', parentId: 'resp:right-lung', children: lobeSegmentIds('resp:right-upper-lobe'), source: { mode: 'specific-fallback', files: ['visceral.glb'], nodeHints: ['upper lobe of right lung', 'right upper lobe'] }, geometryStatus: 'partial', physiologyCapable: true, surgicalLandmark: true }),
  ...
  resp({ id: 'resp:right-lower-lobe', label: 'Right lower lobe', regions: ['thorax'], laterality: 'right', scale: 'suborgan', parentId: 'resp:right-lung', children: lobeSegmentIds('resp:right-lower-lobe'), source: { mode: 'specific-fallback', files: ['visceral.glb'], nodeHints: ['lower lobe of right lung', 'right lower lobe'] }, geometryStatus: 'partial', physiologyCapable: true, surgicalLandmark: true }),
  resp({ id: 'resp:left-upper-lobe', label: 'Left upper lobe', regions: ['thorax'], laterality: 'left', scale: 'suborgan', parentId: 'resp:left-lung', children: lobeSegmentIds('resp:left-upper-lobe'), source: { mode: 'specific-fallback', files: ['visceral.glb'], nodeHints: ['upper lobe of left lung', 'left upper lobe'] }, geometryStatus: 'partial', physiologyCapable: true, surgicalLandmark: true }),
  resp({ id: 'resp:left-lower-lobe', label: 'Left lower lobe', regions: ['thorax'], laterality: 'left', scale: 'suborgan', parentId: 'resp:left-lung', children: lobeSegmentIds('resp:left-lower-lobe'), source: { mode: 'specific-fallback', files: ['visceral.glb'], nodeHints: ['lower lobe of left lung', 'left lower lobe'] }, geometryStatus: 'partial', physiologyCapable: true, surgicalLandmark: true }),
