...
export const UNIVERSAL_SPORT_METRICS = Object.freeze([
  ...
  metric('vertical-speed', 'Vertical speed', 'm/s', 'biomechanics', 'sport-equipment', 'Depth or altitude time-series derivative; retain the source sensor rather than treating it as a device-native reported metric unless it truly is one.'),
...
export const SPORT_METRIC_PACKS = Object.freeze([
  ...
  { id: 'diving-core', metricIds: ['heart-rate', 'respiratory-rate', 'water-temperature', 'current-vector', 'barometric-pressure', 'vertical-speed', 'position', 'communication-quality'] },
