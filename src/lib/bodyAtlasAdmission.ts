 ...
 *
 * This intentionally keeps three states separate:
 *
 ...
 *
 * The controller does not invent clinical coverage thresholds, anatomical
 * importance scores, patient-specific measurements, or reviewer status. A
 * technically healthy reference atlas can therefore remain usable for clearly
 * labelled teaching while biomedical publication remains fail-closed.
 */
